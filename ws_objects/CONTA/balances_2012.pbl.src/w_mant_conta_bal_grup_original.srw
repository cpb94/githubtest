$PBExportHeader$w_mant_conta_bal_grup_original.srw
forward
global type w_mant_conta_bal_grup_original from wi_mvent_con_empresa
end type
type pb_calculadora from u_calculadora within w_mant_conta_bal_grup_original
end type
type tab_1 from tab within w_mant_conta_bal_grup_original
end type
...
type uo_balance from u_em_campo_2 within w_mant_conta_bal_grup_original
end type
type gb_22 from groupbox within w_mant_conta_bal_grup_original
end type
end forward
...
global w_mant_conta_bal_grup_original w_mant_conta_bal_grup_original
...
on w_mant_conta_bal_grup_original.create
int iCurrent
call super::create
...
on w_mant_conta_bal_grup_original.destroy
call super::destroy
...
type dw_1 from wi_mvent_con_empresa`dw_1 within w_mant_conta_bal_grup_original
integer x = 14
integer y = 228
integer width = 3113
integer height = 672
...
type st_1 from wi_mvent_con_empresa`st_1 within w_mant_conta_bal_grup_original
integer x = 2560
integer y = 132
integer width = 187
string text = "Grupo:"
...
type cb_insertar from wi_mvent_con_empresa`cb_insertar within w_mant_conta_bal_grup_original
integer x = 3141
integer y = 228
end type
...
type cb_borrar from wi_mvent_con_empresa`cb_borrar within w_mant_conta_bal_grup_original
integer x = 3141
integer y = 336
end type

type sle_valor from wi_mvent_con_empresa`sle_valor within w_mant_conta_bal_grup_original
integer x = 2752
integer y = 128
end type
...
type cb_salir from wi_mvent_con_empresa`cb_salir within w_mant_conta_bal_grup_original
integer x = 3141
integer y = 444
end type

type control_tabulador from wi_mvent_con_empresa`control_tabulador within w_mant_conta_bal_grup_original
end type

type p_logotencer from wi_mvent_con_empresa`p_logotencer within w_mant_conta_bal_grup_original
end type

type st_empresa from wi_mvent_con_empresa`st_empresa within w_mant_conta_bal_grup_original
integer width = 2437
end type
...
CHOOSE CASE bus_campo
	...
	CASE "contaplan_cuenta"
		...
		bus_filtro     = "ejercicio = "+string(dec(tab_1.tabpage_1.uo_ejercicio_ctas_resultados.em_ejercicio.text),"###0")
