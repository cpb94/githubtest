$PBExportHeader$w_con_conta_bal_original_old.srw
forward
global type w_con_conta_bal_original_old from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_conta_bal_original_old
end type
type pb_2 from upb_imprimir within w_con_conta_bal_original_old
end type
type dw_detalle from datawindow within w_con_conta_bal_original_old
end type
type em_fechadesde from u_em_campo within w_con_conta_bal_original_old
end type
type em_fechahasta from u_em_campo within w_con_conta_bal_original_old
end type
type gb_1 from groupbox within w_con_conta_bal_original_old
end type
type cb_calcular from commandbutton within w_con_conta_bal_original_old
end type
type uo_balance from u_em_campo_2 within w_con_conta_bal_original_old
end type
type gb_2 from groupbox within w_con_conta_bal_original_old
end type
type gb_3 from groupbox within w_con_conta_bal_original_old
end type
type uo_manejo from u_manejo_datawindow within w_con_conta_bal_original_old
end type
type pb_excel from picturebutton within w_con_conta_bal_original_old
end type
type cbx_con_cuentas from checkbox within w_con_conta_bal_original_old
end type
type cbx_version_para_chequeo from checkbox within w_con_conta_bal_original_old
end type
type gb_4 from groupbox within w_con_conta_bal_original_old
end type
type istr_saldos_grupo from structure within w_con_conta_bal_original_old
end type
end forward
...
global w_con_conta_bal_original_old w_con_conta_bal_original_old
...
for ll_indice = 1 to ll_total_cuentas
	...
	if ld_porcentaje > 0 or ld_porcentaje_ant > 0 then
		...
		ll_donde_presupuesto = ids_presupuestos.find("contaplan_cuenta = '"+ls_cuenta+"'",1,ids_presupuestos.rowcount())
...
on w_con_conta_bal_original_old.create
int iCurrent
call super::create
...
on w_con_conta_bal_original_old.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_conta_bal_original_old
integer x = 2240
integer y = 28
integer taborder = 110
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_conta_bal_original_old
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_conta_bal_original_old
integer width = 2427
integer height = 112
end type
...
integer width = 4613
integer height = 2176
string dataobject = "dw_con_conta_bal_original"
...
if cbx_version_para_chequeo.checked then
	...
	dw_detalle.dataobject = "dw_con_conta_bal_original"
end if
...
fontfamily fontfamily = swiss!
string facename = "Arial"
string picturename = "C:\BMP\IMAGENES NUEVAS\BMP NUEVOS\excel.bmp"
