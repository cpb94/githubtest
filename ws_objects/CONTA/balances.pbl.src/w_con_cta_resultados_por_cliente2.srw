$PBExportHeader$w_con_cta_resultados_por_cliente2.srw
forward
global type w_con_cta_resultados_por_cliente2 from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_cta_resultados_por_cliente2
end type
type pb_2 from upb_imprimir within w_con_cta_resultados_por_cliente2
end type
type cb_1 from commandbutton within w_con_cta_resultados_por_cliente2
end type
type gb_6 from groupbox within w_con_cta_resultados_por_cliente2
end type
type dw_resumen from datawindow within w_con_cta_resultados_por_cliente2
end type
type uo_cliente from u_em_campo_2 within w_con_cta_resultados_por_cliente2
end type
type em_fechadesde from u_em_campo within w_con_cta_resultados_por_cliente2
end type
type em_fechahasta from u_em_campo within w_con_cta_resultados_por_cliente2
end type
type cbx_mermas from checkbox within w_con_cta_resultados_por_cliente2
end type
type uo_familia from u_em_campo_2 within w_con_cta_resultados_por_cliente2
end type
type cb_paises from commandbutton within w_con_cta_resultados_por_cliente2
end type
type uo_paises from u_marca_lista within w_con_cta_resultados_por_cliente2
end type
type gb_4 from groupbox within w_con_cta_resultados_por_cliente2
end type
type gb_1 from groupbox within w_con_cta_resultados_por_cliente2
end type
type gb_8 from groupbox within w_con_cta_resultados_por_cliente2
end type
type r_1 from rectangle within w_con_cta_resultados_por_cliente2
end type
end forward
...
global w_con_cta_resultados_por_cliente2 w_con_cta_resultados_por_cliente2
...
public subroutine f_control (datawindow data);string v_cliente, sel, v_cod_articulo, ls_tonochar, mensaje_fabricacion, mensaje_mp
...
ldt_fecha_desde = datetime(em_fechadesde.text)
ldt_fecha_hasta = datetime(em_fechahasta.text)
...
for i = 1 to datos.rowcount()
	...
	sel = " SELECT venlifac.articulo, venlifac.tonochar, "+&
			" articulos.promocion, isnull ( sum (CASE WHEN venlifac.tipo_unidad = '0' THEN venlifac.cantidad ELSE (venlifac.cantidad / av.metroscaja ) * av.piezascaja END), 0 )   cantidad, " +&
			...
			" group by venlifac.articulo,  venlifac.tonochar, articulos.promocion "
			...
			for j = 1 to datos2.rowcount()
				...
				ls_tonochar = datos2.object.venlifac_tonochar[j]
				...
				if v_promocion <> 'S' then
					...
					//f_calculo_coste_articulo_mp_fab_packing_compras2 ( codigo_empresa, v_cod_articulo, v_coste_mp_art, v_coste_fab_art, con_mermas, v_coste_packing_art, v_coste_compras_art, ldt_fecha_desde, ldt_fecha_hasta)
				
					select coste_mp_acumulado , coste_fabricacion_teorico_acumulado , coste_compras_acumulado , coste_packing_acumulado
					into :v_coste_mp_art, :v_coste_fab_art, :v_coste_compras_art, :v_coste_packing_art
					from articulos_coste_lote
					where empresa = :codigo_empresa
					and articulo = :v_cod_articulo
					and lote = :ls_tonochar;
...
event open;call super::open;istr_parametros.s_titulo_ventana="Informe de Facturación de Depósito por Clientes y Meses Lotes."
...
on w_con_cta_resultados_por_cliente2.create
int iCurrent
call super::create
...
on w_con_cta_resultados_por_cliente2.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_cta_resultados_por_cliente2
integer x = 951
integer y = 2060
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_cta_resultados_por_cliente2
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_cta_resultados_por_cliente2
integer y = 8
integer width = 5061
integer height = 80
boolean italic = true
...
event clicked;f_control(dw_resumen)
