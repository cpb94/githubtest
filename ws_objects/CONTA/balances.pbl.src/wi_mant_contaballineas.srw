$PBExportHeader$wi_mant_contaballineas.srw
forward
global type wi_mant_contaballineas from w_int_con_empresa
end type
type dw_1 from datawindow within wi_mant_contaballineas
end type
type cb_borrar from commandbutton within wi_mant_contaballineas
end type
type cb_insertar from commandbutton within wi_mant_contaballineas
end type
type cb_actualizar from commandbutton within wi_mant_contaballineas
end type
type cb_cancelar from commandbutton within wi_mant_contaballineas
end type
type dw_list from datawindow within wi_mant_contaballineas
end type
type ddlb_1 from dropdownlistbox within wi_mant_contaballineas
end type
type uo_grupo from u_em_campo_2 within wi_mant_contaballineas
end type
type st_1 from statictext within wi_mant_contaballineas
end type
type st_2 from statictext within wi_mant_contaballineas
end type
type uo_subgrupo from u_em_campo_2 within wi_mant_contaballineas
end type
type uo_balance from u_em_campo_2 within wi_mant_contaballineas
end type
type st_3 from statictext within wi_mant_contaballineas
end type
type cb_consultar from commandbutton within wi_mant_contaballineas
end type
type st_4 from statictext within wi_mant_contaballineas
end type
type cb_1 from picturebutton within wi_mant_contaballineas
end type
end forward
...
global wi_mant_contaballineas wi_mant_contaballineas
...
on wi_mant_contaballineas.create
int iCurrent
call super::create
...
on wi_mant_contaballineas.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within wi_mant_contaballineas
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within wi_mant_contaballineas
end type

type st_empresa from w_int_con_empresa`st_empresa within wi_mant_contaballineas
end type
...
string dataobject = "dw_mant_contaballineas"
...
dw_1.update()
commit;
dw_1.retrieve(codigo_empresa,uo_balance.em_codigo.text,left(ddlb_1.text,1),uo_grupo.em_codigo.text,uo_subgrupo.em_codigo.text)
f_desactiva_botones()
f_activa()
...
integer height = 264
boolean bringtotop = true
string dataobject = "report_contaballineas"
boolean livescroll = true
end type
...
uo_grupo.em_campo.text=f_nombre_contabalgrup(codigo_empresa,bal,left(ddlb_1.text,1),uo_grupo.em_codigo.text)
