$PBExportHeader$w_con_sii_tencer.srw
forward
global type w_con_sii_tencer from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_sii_tencer
end type
type cb_consultar from commandbutton within w_con_sii_tencer
end type
type gb_1 from groupbox within w_con_sii_tencer
end type
type cb_enviar from u_boton within w_con_sii_tencer
end type
type gb_3 from groupbox within w_con_sii_tencer
end type
type pb_2 from upb_imprimir within w_con_sii_tencer
end type
type em_fecha_desde from u_em_campo within w_con_sii_tencer
end type
type em_fecha_hasta from u_em_campo within w_con_sii_tencer
end type
type cb_1 from u_boton within w_con_sii_tencer
end type
type p_calendario from picture within w_con_sii_tencer
end type
type cbx_pruebas from checkbox within w_con_sii_tencer
end type
type cbx_reenviar from checkbox within w_con_sii_tencer
end type
type p_refrescar_dia from picture within w_con_sii_tencer
end type
type dw_calendario from u_datawindow within w_con_sii_tencer
end type
type dw_detalle from datawindow within w_con_sii_tencer
end type
type str_fichero_respuesta from structure within w_con_sii_tencer
end type
end forward
...
global w_con_sii_tencer w_con_sii_tencer
...
if arg_es_un_reenvio = 'S' then
	ls_nombre_fichero = istr_contasii_parametros.directorio_ficheros+"\EMITIDAS"+string(date(em_fecha_hasta.text),'dd-mm-yyyy')+'_REENVIADAS.XML'
else
...
if arg_es_un_reenvio = 'S' then
	ls_nombre_fichero = istr_contasii_parametros.directorio_ficheros+"\RECIBIDAS"+string(date(em_fecha_hasta.text),'dd-mm-yyyy')+'_REENVIADAS.XML'
else
...
if ll_registos_calendario = 0 then
	...
	ll_dias_ejercicio = DaysAfter (date(ldt_inicio_ejercicio),date(ldt_final_ejercicio))
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_sii_tencer
integer x = 992
integer y = 0
integer height = 84
integer taborder = 0
...
type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_sii_tencer
integer x = 110
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_sii_tencer
integer width = 3451
integer height = 108
end type
