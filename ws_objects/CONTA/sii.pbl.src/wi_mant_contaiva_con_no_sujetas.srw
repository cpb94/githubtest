$PBExportHeader$wi_mant_contaiva_con_no_sujetas.srw
forward
global type wi_mant_contaiva_con_no_sujetas from wi_mvent_con_empresa
end type
type pb_calculadora from u_calculadora within wi_mant_contaiva_con_no_sujetas
end type
type uo_ejercicio from u_ejercicio within wi_mant_contaiva_con_no_sujetas
end type
type gb_1 from groupbox within wi_mant_contaiva_con_no_sujetas
end type
end forward
...
global wi_mant_contaiva_con_no_sujetas wi_mant_contaiva_con_no_sujetas
...
on wi_mant_contaiva_con_no_sujetas.create
int iCurrent
call super::create
...
on wi_mant_contaiva_con_no_sujetas.destroy
call super::destroy
...
type dw_1 from wi_mvent_con_empresa`dw_1 within wi_mant_contaiva_con_no_sujetas
integer x = 5
integer y = 244
integer width = 3625
integer height = 1692
...
lstr_param.s_argumentos[1]  = "wi_mant_contaiva_con_no_sujetas"
...
type st_1 from wi_mvent_con_empresa`st_1 within wi_mant_contaiva_con_no_sujetas
integer x = 201
integer y = 140
integer width = 270
...
type cb_insertar from wi_mvent_con_empresa`cb_insertar within wi_mant_contaiva_con_no_sujetas
integer x = 1143
integer y = 144
integer height = 84
end type

type cb_borrar from wi_mvent_con_empresa`cb_borrar within wi_mant_contaiva_con_no_sujetas
integer x = 1550
integer y = 144
integer height = 84
end type

type sle_valor from wi_mvent_con_empresa`sle_valor within wi_mant_contaiva_con_no_sujetas
integer x = 507
integer y = 136
integer width = 370
end type
...
type cb_salir from wi_mvent_con_empresa`cb_salir within wi_mant_contaiva_con_no_sujetas
integer x = 1957
integer y = 144
integer height = 84
end type

type control_tabulador from wi_mvent_con_empresa`control_tabulador within wi_mant_contaiva_con_no_sujetas
end type

type st_empresa from wi_mvent_con_empresa`st_empresa within wi_mant_contaiva_con_no_sujetas
integer width = 2834
end type
