$PBExportHeader$w_con_extracto_cuenta_masivo.srw
$PBExportComments$€
forward
global type w_con_extracto_cuenta_masivo from w_int_con_empresa
end type
type gb_3 from groupbox within w_con_extracto_cuenta_masivo
end type
type pb_2 from upb_salir within w_con_extracto_cuenta_masivo
end type
type em_fechadesde from u_em_campo within w_con_extracto_cuenta_masivo
end type
type gb_1 from groupbox within w_con_extracto_cuenta_masivo
end type
type cb_consulta from u_boton within w_con_extracto_cuenta_masivo
end type
type em_fechahasta from u_em_campo within w_con_extracto_cuenta_masivo
end type
type st_1 from statictext within w_con_extracto_cuenta_masivo
end type
type cb_concepto from u_boton within w_con_extracto_cuenta_masivo
end type
type dw_listado from datawindow within w_con_extracto_cuenta_masivo
end type
type gb_2 from groupbox within w_con_extracto_cuenta_masivo
end type
type pb_imprimir_preli from picturebutton within w_con_extracto_cuenta_masivo
end type
type uo_1 from u_manejo_datawindow within w_con_extracto_cuenta_masivo
end type
type rb_si from radiobutton within w_con_extracto_cuenta_masivo
end type
type rb_no from radiobutton within w_con_extracto_cuenta_masivo
end type
type uo_tipo2 from u_marca_lista within w_con_extracto_cuenta_masivo
end type
type dw_proceso2 from datawindow within w_con_extracto_cuenta_masivo
end type
type dw_1 from datawindow within w_con_extracto_cuenta_masivo
end type
type gb_cuenta from groupbox within w_con_extracto_cuenta_masivo
end type
type em_cuenta1 from u_em_campo within w_con_extracto_cuenta_masivo
end type
type st_2 from statictext within w_con_extracto_cuenta_masivo
end type
type em_cuenta2 from u_em_campo within w_con_extracto_cuenta_masivo
end type
type cb_detalle from u_boton within w_con_extracto_cuenta_masivo
end type
end forward
...
global w_con_extracto_cuenta_masivo w_con_extracto_cuenta_masivo
...
if ini = 1 then
	...
	for i = 1 to dw_data.rowcount()	
		fapunte = dw_data.getitemdatetime(i,"fapunte")
...
on w_con_extracto_cuenta_masivo.create
int iCurrent
call super::create
...
on w_con_extracto_cuenta_masivo.destroy
call super::destroy
...
event activate;call super::activate;w_con_extracto_cuenta_masivo = ventanas_activas[id_ventana_activa].ventana
end event

type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_extracto_cuenta_masivo
integer x = 489
integer y = 636
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_extracto_cuenta_masivo
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_extracto_cuenta_masivo
integer y = 16
integer width = 2642
end type
