$PBExportHeader$w_con_cuentas.srw
$PBExportComments$€
forward
global type w_con_cuentas from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_cuentas
end type
type nivel1 from u_em_campo within w_con_cuentas
end type
type gb_1 from groupbox within w_con_cuentas
end type
type cb_consulta from u_boton within w_con_cuentas
end type
type st_1 from statictext within w_con_cuentas
end type
type dw_listado from datawindow within w_con_cuentas
end type
type pb_imprimir_preli from picturebutton within w_con_cuentas
end type
type uo_tipo2 from u_marca_lista within w_con_cuentas
end type
type dw_proceso2 from datawindow within w_con_cuentas
end type
type dw_1 from datawindow within w_con_cuentas
end type
type gb_cuenta from groupbox within w_con_cuentas
end type
type em_cuenta1 from u_em_campo within w_con_cuentas
end type
type st_2 from statictext within w_con_cuentas
end type
type em_cuenta2 from u_em_campo within w_con_cuentas
end type
type nivel2 from u_em_campo within w_con_cuentas
end type
type ejercicio from u_ejercicio within w_con_cuentas
end type
end forward
...
global w_con_cuentas w_con_cuentas
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_cuentas
integer x = 489
integer y = 636
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_cuentas
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_cuentas
integer y = 16
integer width = 2642
end type
...
integer height = 264
boolean bringtotop = true
string dataobject = "report_con_cuentas"
...
integer width = 2857
integer height = 1492
string dataobject = "dw_con_cuentas"
