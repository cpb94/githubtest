$PBExportHeader$w_con_libros_facturas_emitidas.srw
$PBExportComments$€
forward
global type w_con_libros_facturas_emitidas from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_libros_facturas_emitidas
end type
type cb_detalle from u_boton within w_con_libros_facturas_emitidas
end type
type em_fecha_desde from u_em_campo within w_con_libros_facturas_emitidas
end type
type st_4 from statictext within w_con_libros_facturas_emitidas
end type
type em_fecha_hasta from u_em_campo within w_con_libros_facturas_emitidas
end type
type st_3 from statictext within w_con_libros_facturas_emitidas
end type
type gb_1 from groupbox within w_con_libros_facturas_emitidas
end type
type cb_resumen from u_boton within w_con_libros_facturas_emitidas
end type
type pb_2 from upb_imprimir within w_con_libros_facturas_emitidas
end type
type dw_listado1 from datawindow within w_con_libros_facturas_emitidas
end type
type gb_2 from groupbox within w_con_libros_facturas_emitidas
end type
type dw_resumen from datawindow within w_con_libros_facturas_emitidas
end type
type dw_1 from datawindow within w_con_libros_facturas_emitidas
end type
type uo_ejercicio from u_ejercicio within w_con_libros_facturas_emitidas
end type
type dw_listado2 from datawindow within w_con_libros_facturas_emitidas
end type
type cb_1 from u_boton within w_con_libros_facturas_emitidas
end type
end forward
...
global w_con_libros_facturas_emitidas w_con_libros_facturas_emitidas
...
istr_parametros.s_titulo_ventana  = "Consulta Libros de IVA Oficiales Facturas Emitidas"
...
on w_con_libros_facturas_emitidas.create
int iCurrent
call super::create
...
on w_con_libros_facturas_emitidas.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_libros_facturas_emitidas
integer x = 69
integer y = 1104
integer taborder = 60
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_libros_facturas_emitidas
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_libros_facturas_emitidas
integer y = 24
integer width = 2670
end type
...
integer taborder = 30
boolean bringtotop = true
string dataobject = "report_con_libros_facturas_emitidas"
...
integer width = 2839
integer height = 1820
string dataobject = "dw_con_libros_facturas_emitidas_resumen"
...
integer width = 3136
integer height = 936
string dataobject = "dw_con_libros_facturas_emitidas"
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = styleraised!
end type
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "report_con_libros_facturas_emitidas2"
boolean livescroll = true
end type
