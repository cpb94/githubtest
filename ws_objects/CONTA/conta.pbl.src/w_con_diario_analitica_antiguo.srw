$PBExportHeader$w_con_diario_analitica_antiguo.srw
forward
global type w_con_diario_analitica_antiguo from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_diario_analitica_antiguo
end type
type cb_consulta from u_boton within w_con_diario_analitica_antiguo
end type
type st_1 from statictext within w_con_diario_analitica_antiguo
end type
type dw_listado from datawindow within w_con_diario_analitica_antiguo
end type
type gb_2 from groupbox within w_con_diario_analitica_antiguo
end type
type dw_1 from datawindow within w_con_diario_analitica_antiguo
end type
type uo_perid from u_em_campo_2 within w_con_diario_analitica_antiguo
end type
type uo_perih from u_em_campo_2 within w_con_diario_analitica_antiguo
end type
type gb_1 from groupbox within w_con_diario_analitica_antiguo
end type
type pb_imprimir_preli from picturebutton within w_con_diario_analitica_antiguo
end type
end forward
...
global w_con_diario_analitica_antiguo w_con_diario_analitica_antiguo
...
on w_con_diario_analitica_antiguo.create
int iCurrent
call super::create
...
on w_con_diario_analitica_antiguo.destroy
call super::destroy
destroy(this.pb_2)
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_diario_analitica_antiguo
integer x = 489
integer y = 636
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_diario_analitica_antiguo
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_diario_analitica_antiguo
integer y = 20
integer width = 2642
end type
