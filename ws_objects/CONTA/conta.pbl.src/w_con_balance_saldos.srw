$PBExportHeader$w_con_balance_saldos.srw
forward
global type w_con_balance_saldos from w_int_con_empresa
end type
type gb_3 from groupbox within w_con_balance_saldos
end type
type gb_nivel from groupbox within w_con_balance_saldos
end type
type gb_cuenta from groupbox within w_con_balance_saldos
end type
type pb_2 from upb_salir within w_con_balance_saldos
end type
type em_fechadesde from u_em_campo within w_con_balance_saldos
end type
type gb_1 from groupbox within w_con_balance_saldos
end type
type cb_consulta from u_boton within w_con_balance_saldos
end type
type em_fechahasta from u_em_campo within w_con_balance_saldos
end type
type pb_imprimir_preli from picturebutton within w_con_balance_saldos
end type
type em_cuentadesde from u_em_campo within w_con_balance_saldos
end type
type em_cuentahasta from u_em_campo within w_con_balance_saldos
end type
type em_nivel from u_em_campo within w_con_balance_saldos
end type
type dw_ayuda_nivel from datawindow within w_con_balance_saldos
end type
type dw_1 from datawindow within w_con_balance_saldos
end type
type sle_digitos from singlelineedit within w_con_balance_saldos
end type
type cbx_sal from checkbox within w_con_balance_saldos
end type
type cbx_mov from checkbox within w_con_balance_saldos
end type
type gb_2 from groupbox within w_con_balance_saldos
end type
type st_nom1 from statictext within w_con_balance_saldos
end type
type st_nom2 from statictext within w_con_balance_saldos
end type
type st_1 from statictext within w_con_balance_saldos
end type
type st_2 from statictext within w_con_balance_saldos
end type
type st_3 from statictext within w_con_balance_saldos
end type
end forward
...
global w_con_balance_saldos w_con_balance_saldos
...
resto = 10 - digi
cuenta_inicial_desde = "1000000000"
...
//if ejercicio_activo = 2008 then
//	
//	f_borrar_cuentas_balance_dw(dw_data)
//	
//end if
//
...
//if ejercicio_activo = 2008 then
//	
//	f_borrar_cuentas_balance(datos)
//	
//end if
...
em_cuentadesde.text = "1000000000"
em_cuentahasta.text = "9999999999"
nivel_elegido = 0
cbx_sal.checked = true
cbx_mov.checked = true
f_activar_campo(em_fechadesde)


end event

on w_con_balance_saldos.create
int iCurrent
call super::create
...
this.Control[iCurrent+15]=this.sle_digitos
this.Control[iCurrent+16]=this.cbx_sal
this.Control[iCurrent+17]=this.cbx_mov
this.Control[iCurrent+18]=this.gb_2
this.Control[iCurrent+19]=this.st_nom1
this.Control[iCurrent+20]=this.st_nom2
this.Control[iCurrent+21]=this.st_1
this.Control[iCurrent+22]=this.st_2
this.Control[iCurrent+23]=this.st_3
end on

on w_con_balance_saldos.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_balance_saldos
integer x = 782
integer y = 1156
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_balance_saldos
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_balance_saldos
integer y = 20
integer width = 3424
end type
...
integer width = 3744
integer height = 3028
string dataobject = "dw_con_balance_nuevo7"
