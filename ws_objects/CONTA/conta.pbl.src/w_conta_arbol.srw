$PBExportHeader$w_conta_arbol.srw
forward
global type w_conta_arbol from window
end type
type st_titulo from statictext within w_conta_arbol
end type
type tv_menu from treeview within w_conta_arbol
end type
end forward
...
global w_conta_arbol w_conta_arbol

event open;string titulo

f_cargar_menu_arbol (w_conta, tv_menu, titulo)
st_titulo.text = 'Contabilidad'



end event

on w_conta_arbol.create
