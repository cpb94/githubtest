$PBExportHeader$w_procesos_arreglo1.srw
forward
global type w_procesos_arreglo1 from w_int_con_empresa
end type
type pb_2 from upb_salir within w_procesos_arreglo1
end type
type dw_listado from datawindow within w_procesos_arreglo1
end type
type uo_tipo2 from u_marca_lista within w_procesos_arreglo1
end type
type dw_proceso2 from datawindow within w_procesos_arreglo1
end type
type dw_1 from datawindow within w_procesos_arreglo1
end type
type cb_1 from commandbutton within w_procesos_arreglo1
end type
end forward
...
global w_procesos_arreglo1 w_procesos_arreglo1
...
on w_procesos_arreglo1.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_procesos_arreglo1
integer x = 489
integer y = 636
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_procesos_arreglo1
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_procesos_arreglo1
integer y = 16
integer width = 2642
end type
...
integer width = 2857
integer height = 1076
string dataobject = "dw_procesos_arreglo1"
