$PBExportHeader$w_con_balance_nuevo1.srw
$PBExportComments$Balance para 5 niveles
forward
global type w_con_balance_nuevo1 from w_int_con_empresa
end type
type gb_nivel from groupbox within w_con_balance_nuevo1
end type
type gb_cuenta from groupbox within w_con_balance_nuevo1
end type
type pb_2 from upb_salir within w_con_balance_nuevo1
end type
type em_fechadesde from u_em_campo within w_con_balance_nuevo1
end type
type gb_1 from groupbox within w_con_balance_nuevo1
end type
type cb_consulta from u_boton within w_con_balance_nuevo1
end type
type em_fechahasta from u_em_campo within w_con_balance_nuevo1
end type
type st_1 from statictext within w_con_balance_nuevo1
end type
type dw_listado from datawindow within w_con_balance_nuevo1
end type
type gb_2 from groupbox within w_con_balance_nuevo1
end type
type pb_imprimir_preli from picturebutton within w_con_balance_nuevo1
end type
type uo_1 from u_manejo_datawindow within w_con_balance_nuevo1
end type
type em_cuentadesde from u_em_campo within w_con_balance_nuevo1
end type
type st_2 from statictext within w_con_balance_nuevo1
end type
type em_cuentahasta from u_em_campo within w_con_balance_nuevo1
end type
type em_nivel from u_em_campo within w_con_balance_nuevo1
end type
type dw_ayuda_nivel from datawindow within w_con_balance_nuevo1
end type
type dw_1 from datawindow within w_con_balance_nuevo1
end type
type cb_det from u_boton within w_con_balance_nuevo1
end type
type cb_todos from commandbutton within w_con_balance_nuevo1
end type
type dw_2 from datawindow within w_con_balance_nuevo1
end type
end forward
...
global w_con_balance_nuevo1 w_con_balance_nuevo1
...
on w_con_balance_nuevo1.create
int iCurrent
call super::create
...
on w_con_balance_nuevo1.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_balance_nuevo1
integer x = 800
integer y = 816
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_balance_nuevo1
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_balance_nuevo1
integer y = 20
integer width = 2642
end type
...
integer taborder = 50
boolean bringtotop = true
string dataobject = "report_balance_nuevo2"
boolean hscrollbar = true
boolean vscrollbar = true
boolean livescroll = true
end type
