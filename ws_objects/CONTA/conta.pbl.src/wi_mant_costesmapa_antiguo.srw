$PBExportHeader$wi_mant_costesmapa_antiguo.srw
forward
global type wi_mant_costesmapa_antiguo from wi_mvent_con_empresa
end type
type st_3 from statictext within wi_mant_costesmapa_antiguo
end type
type uo_ejercicio from u_ejercicio within wi_mant_costesmapa_antiguo
end type
type dw_lineas_asiento from datawindow within wi_mant_costesmapa_antiguo
end type
type gb_1 from groupbox within wi_mant_costesmapa_antiguo
end type
type pb_1 from picturebutton within wi_mant_costesmapa_antiguo
end type
type pb_2 from picturebutton within wi_mant_costesmapa_antiguo
end type
type st_cuenta from statictext within wi_mant_costesmapa_antiguo
end type
type st_coste from statictext within wi_mant_costesmapa_antiguo
end type
type uo_asiento from u_em_campo within wi_mant_costesmapa_antiguo
end type
type dw_listado from datawindow within wi_mant_costesmapa_antiguo
end type
type pb_3 from picturebutton within wi_mant_costesmapa_antiguo
end type
end forward
...
global wi_mant_costesmapa_antiguo wi_mant_costesmapa_antiguo
...
on wi_mant_costesmapa_antiguo.create
int iCurrent
call super::create
...
on wi_mant_costesmapa_antiguo.destroy
call super::destroy
...
type dw_1 from wi_mvent_con_empresa`dw_1 within wi_mant_costesmapa_antiguo
integer x = 9
integer y = 384
integer width = 1742
integer height = 136
...
type st_1 from wi_mvent_con_empresa`st_1 within wi_mant_costesmapa_antiguo
integer x = 82
integer y = 280
integer width = 192
integer height = 88
...
type cb_insertar from wi_mvent_con_empresa`cb_insertar within wi_mant_costesmapa_antiguo
integer x = 2167
integer y = 648
end type
...
type cb_borrar from wi_mvent_con_empresa`cb_borrar within wi_mant_costesmapa_antiguo
integer x = 2167
integer y = 748
end type
...
type sle_valor from wi_mvent_con_empresa`sle_valor within wi_mant_costesmapa_antiguo
integer x = 297
integer y = 276
integer width = 498
integer height = 88
...
type cb_salir from wi_mvent_con_empresa`cb_salir within wi_mant_costesmapa_antiguo
integer x = 2167
integer y = 848
end type
...
type control_tabulador from wi_mvent_con_empresa`control_tabulador within wi_mant_costesmapa_antiguo
integer taborder = 80
end type

type p_logotencer from wi_mvent_con_empresa`p_logotencer within wi_mant_costesmapa_antiguo
end type

type st_empresa from wi_mvent_con_empresa`st_empresa within wi_mant_costesmapa_antiguo
integer width = 2816
end type
