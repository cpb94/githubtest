$PBExportHeader$wi_mant_contabalgruponpgc.srw
forward
global type wi_mant_contabalgruponpgc from wi_mvent_con_empresa
end type
type gb_1 from groupbox within wi_mant_contabalgruponpgc
end type
type ddlb_1 from dropdownlistbox within wi_mant_contabalgruponpgc
end type
type mle_1 from multilineedit within wi_mant_contabalgruponpgc
end type
type st_2 from statictext within wi_mant_contabalgruponpgc
end type
type st_3 from statictext within wi_mant_contabalgruponpgc
end type
type st_4 from statictext within wi_mant_contabalgruponpgc
end type
type uo_balance from u_em_campo_2 within wi_mant_contabalgruponpgc
end type
end forward
...
global wi_mant_contabalgruponpgc wi_mant_contabalgruponpgc
...
on wi_mant_contabalgruponpgc.create
int iCurrent
call super::create
...
on wi_mant_contabalgruponpgc.destroy
call super::destroy
...
type dw_1 from wi_mvent_con_empresa`dw_1 within wi_mant_contabalgruponpgc
integer x = 23
integer y = 488
integer width = 2514
integer height = 308
string dataobject = "dw_contabalgrupnpgc"
end type

type st_1 from wi_mvent_con_empresa`st_1 within wi_mant_contabalgruponpgc
integer x = 1952
integer y = 152
integer width = 293
integer textsize = -8
...
type cb_insertar from wi_mvent_con_empresa`cb_insertar within wi_mant_contabalgruponpgc
integer x = 1618
integer y = 368
integer width = 297
integer height = 84
...
type cb_borrar from wi_mvent_con_empresa`cb_borrar within wi_mant_contabalgruponpgc
integer x = 1920
integer y = 368
integer width = 297
integer height = 84
...
type sle_valor from wi_mvent_con_empresa`sle_valor within wi_mant_contabalgruponpgc
integer x = 1957
integer y = 228
integer width = 288
integer height = 96
...
type cb_salir from wi_mvent_con_empresa`cb_salir within wi_mant_contabalgruponpgc
integer x = 2222
integer y = 368
integer width = 297
integer height = 84
...
type control_tabulador from wi_mvent_con_empresa`control_tabulador within wi_mant_contabalgruponpgc
integer taborder = 50
end type

type p_logotencer from wi_mvent_con_empresa`p_logotencer within wi_mant_contabalgruponpgc
end type

type st_empresa from wi_mvent_con_empresa`st_empresa within wi_mant_contabalgruponpgc
integer width = 2834
end type
