$PBExportHeader$w_mant_contacoste.srw
forward
global type w_mant_contacoste from wi_mvent_con_empresa
end type
type gb_1 from groupbox within w_mant_contacoste
end type
type gb_2 from groupbox within w_mant_contacoste
end type
type pb_calculadora from u_calculadora within w_mant_contacoste
end type
type gb_3 from groupbox within w_mant_contacoste
end type
type st_2 from statictext within w_mant_contacoste
end type
type em_seccion from u_em_campo within w_mant_contacoste
end type
type st_seccion from statictext within w_mant_contacoste
end type
type dw_lista from u_datawindow within w_mant_contacoste
end type
end forward
...
global w_mant_contacoste w_mant_contacoste

on w_mant_contacoste.create
int iCurrent
call super::create
...
type dw_1 from wi_mvent_con_empresa`dw_1 within w_mant_contacoste
integer x = 46
integer y = 444
integer width = 1563
integer height = 296
...
type st_1 from wi_mvent_con_empresa`st_1 within w_mant_contacoste
integer x = 18
integer y = 308
integer width = 366
...
type cb_insertar from wi_mvent_con_empresa`cb_insertar within w_mant_contacoste
integer x = 1742
integer y = 452
integer width = 389
integer textsize = -10
...
type cb_borrar from wi_mvent_con_empresa`cb_borrar within w_mant_contacoste
integer x = 1746
integer y = 592
integer width = 389
integer textsize = -10
...
type sle_valor from wi_mvent_con_empresa`sle_valor within w_mant_contacoste
integer x = 402
integer y = 308
integer width = 384
integer taborder = 20
...
type cb_salir from wi_mvent_con_empresa`cb_salir within w_mant_contacoste
integer x = 1746
integer y = 728
integer width = 389
integer textsize = -10
...
type control_tabulador from wi_mvent_con_empresa`control_tabulador within w_mant_contacoste
integer taborder = 30
end type

type p_logotencer from wi_mvent_con_empresa`p_logotencer within w_mant_contacoste
end type

type st_empresa from wi_mvent_con_empresa`st_empresa within w_mant_contacoste
end type
