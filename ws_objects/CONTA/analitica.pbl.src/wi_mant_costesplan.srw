$PBExportHeader$wi_mant_costesplan.srw
forward
global type wi_mant_costesplan from wi_mvent_con_empresa
end type
type gb_1 from groupbox within wi_mant_costesplan
end type
type gb_2 from groupbox within wi_mant_costesplan
end type
type gb_3 from groupbox within wi_mant_costesplan
end type
type dw_listado from datawindow within wi_mant_costesplan
end type
type pb_imprimir from picturebutton within wi_mant_costesplan
end type
type uo_ejercicio from u_ejercicio within wi_mant_costesplan
end type
end forward
...
global wi_mant_costesplan wi_mant_costesplan
...
type dw_1 from wi_mvent_con_empresa`dw_1 within wi_mant_costesplan
integer x = 27
integer y = 388
integer width = 1742
integer height = 356
...
type st_1 from wi_mvent_con_empresa`st_1 within wi_mant_costesplan
integer x = 27
integer y = 208
integer width = 416
...
type cb_insertar from wi_mvent_con_empresa`cb_insertar within wi_mant_costesplan
integer x = 1819
integer y = 388
integer height = 84
integer textsize = -10
...
type cb_borrar from wi_mvent_con_empresa`cb_borrar within wi_mant_costesplan
integer x = 1819
integer y = 520
integer height = 84
integer textsize = -10
...
type sle_valor from wi_mvent_con_empresa`sle_valor within wi_mant_costesplan
integer x = 448
integer y = 196
integer width = 498
end type
...
type cb_salir from wi_mvent_con_empresa`cb_salir within wi_mant_costesplan
integer x = 1819
integer y = 652
integer height = 84
integer textsize = -10
...
type control_tabulador from wi_mvent_con_empresa`control_tabulador within wi_mant_costesplan
integer taborder = 60
end type

type p_logotencer from wi_mvent_con_empresa`p_logotencer within wi_mant_costesplan
end type

type st_empresa from wi_mvent_con_empresa`st_empresa within wi_mant_costesplan
integer width = 2487
end type
