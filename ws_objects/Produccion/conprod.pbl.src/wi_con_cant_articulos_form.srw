$PBExportHeader$wi_con_cant_articulos_form.srw
forward
global type wi_con_cant_articulos_form from w_int_con_empresa
end type
type pb_1 from upb_salir within wi_con_cant_articulos_form
end type
type dw_1 from datawindow within wi_con_cant_articulos_form
end type
type dw_listado from datawindow within wi_con_cant_articulos_form
end type
type pb_imprimir from upb_imprimir within wi_con_cant_articulos_form
end type
type cb_1 from commandbutton within wi_con_cant_articulos_form
end type
type gb_1 from groupbox within wi_con_cant_articulos_form
end type
type em_fechadesde from u_em_campo within wi_con_cant_articulos_form
end type
type em_fechahasta from u_em_campo within wi_con_cant_articulos_form
end type
type cb_detalle from commandbutton within wi_con_cant_articulos_form
end type
end forward
...
global wi_con_cant_articulos_form wi_con_cant_articulos_form
...
on wi_con_cant_articulos_form.create
int iCurrent
call super::create
...
on wi_con_cant_articulos_form.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within wi_con_cant_articulos_form
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within wi_con_cant_articulos_form
integer x = 1586
integer y = 24
integer width = 352
integer height = 312
...
type st_empresa from w_int_con_empresa`st_empresa within wi_con_cant_articulos_form
integer width = 837
end type
...
string dataobject = "dw_con_cant_articulos_form"
