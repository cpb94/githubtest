$PBExportHeader$w_con_produccion_exportar.srw
forward
global type w_con_produccion_exportar from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_produccion_exportar
end type
type pb_2 from upb_imprimir within w_con_produccion_exportar
end type
type cb_1 from commandbutton within w_con_produccion_exportar
end type
type gb_6 from groupbox within w_con_produccion_exportar
end type
type dw_resumen from datawindow within w_con_produccion_exportar
end type
type uo_cliente from u_em_campo_2 within w_con_produccion_exportar
end type
type uo_g1 from u_em_campo_2 within w_con_produccion_exportar
end type
type uo_g2 from u_em_campo_2 within w_con_produccion_exportar
end type
type uo_g3 from u_em_campo_2 within w_con_produccion_exportar
end type
type uo_g4 from u_em_campo_2 within w_con_produccion_exportar
end type
type ddlb_pt from dropdownlistbox within w_con_produccion_exportar
end type
type ddlb_nc from dropdownlistbox within w_con_produccion_exportar
end type
type ddlb_av from dropdownlistbox within w_con_produccion_exportar
end type
type uo_ct from u_em_campo_2 within w_con_produccion_exportar
end type
type uo_rl from u_em_campo_2 within w_con_produccion_exportar
end type
type ddlb_n from dropdownlistbox within w_con_produccion_exportar
end type
type st_3 from statictext within w_con_produccion_exportar
end type
type st_4 from statictext within w_con_produccion_exportar
end type
type gb_4 from groupbox within w_con_produccion_exportar
end type
type gb_125 from groupbox within w_con_produccion_exportar
end type
type gb_20 from groupbox within w_con_produccion_exportar
end type
type gb_18 from groupbox within w_con_produccion_exportar
end type
type gb_16 from groupbox within w_con_produccion_exportar
end type
type gb_13 from groupbox within w_con_produccion_exportar
end type
type gb_11 from groupbox within w_con_produccion_exportar
end type
type gb_10 from groupbox within w_con_produccion_exportar
end type
type gb_9 from groupbox within w_con_produccion_exportar
end type
type gb_7 from groupbox within w_con_produccion_exportar
end type
type gb_1 from groupbox within w_con_produccion_exportar
end type
end forward
...
global w_con_produccion_exportar w_con_produccion_exportar
...
event open;call super::open;istr_parametros.s_titulo_ventana="Informe de Producción para exportar."
...
on w_con_produccion_exportar.create
int iCurrent
call super::create
...
on w_con_produccion_exportar.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_produccion_exportar
integer y = 612
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_produccion_exportar
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_produccion_exportar
integer y = 8
integer width = 4594
integer height = 88
boolean italic = true
