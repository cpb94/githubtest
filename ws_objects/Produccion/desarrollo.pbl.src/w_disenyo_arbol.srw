$PBExportHeader$w_disenyo_arbol.srw
forward
global type w_disenyo_arbol from window
end type
type st_titulo from statictext within w_disenyo_arbol
end type
type tv_menu from treeview within w_disenyo_arbol
end type
end forward
...
global w_disenyo_arbol w_disenyo_arbol

event open;string titulo

f_cargar_menu_arbol (w_disenyo, tv_menu, titulo)
st_titulo.text = 'Desarrollo'

end event

on w_disenyo_arbol.create
