$PBExportHeader$w_laboratorio_arbol.srw
forward
global type w_laboratorio_arbol from window
end type
type st_titulo from statictext within w_laboratorio_arbol
end type
type tv_menu from treeview within w_laboratorio_arbol
end type
end forward
...
global w_laboratorio_arbol w_laboratorio_arbol

event open;string titulo

f_cargar_menu_arbol (w_laboratorio, tv_menu, titulo)
st_titulo.text = 'Laboratorio'



end event

on w_laboratorio_arbol.create
...
on w_laboratorio_arbol.destroy
