$PBExportHeader$wtc_consulta_productividad_comercial.srw
forward
global type wtc_consulta_productividad_comercial from w_int_con_empresa
end type
type pb_2 from upb_salir within wtc_consulta_productividad_comercial
end type
type cb_consulta from commandbutton within wtc_consulta_productividad_comercial
end type
type pb_imprimir_preli from upb_imprimir within wtc_consulta_productividad_comercial
end type
type st_titulo from statictext within wtc_consulta_productividad_comercial
end type
type p_logo from picture within wtc_consulta_productividad_comercial
end type
type dw_1 from datawindow within wtc_consulta_productividad_comercial
end type
type ddlb_grafica from dropdownlistbox within wtc_consulta_productividad_comercial
end type
type em_fhasta from u_em_campo within wtc_consulta_productividad_comercial
end type
type em_fdesde from u_em_campo within wtc_consulta_productividad_comercial
end type
type uo_comercial from u_em_campo_2 within wtc_consulta_productividad_comercial
end type
type gb_1 from groupbox within wtc_consulta_productividad_comercial
end type
type gb_3 from groupbox within wtc_consulta_productividad_comercial
end type
type gb_2 from groupbox within wtc_consulta_productividad_comercial
end type
end forward
...
integer width = 4910
integer height = 3756
string title = "Informe de Productividad Comercial"
...
global wtc_consulta_productividad_comercial wtc_consulta_productividad_comercial
...
on wtc_consulta_productividad_comercial.create
int iCurrent
call super::create
...
this.Control[iCurrent+7]=this.ddlb_grafica
...
on wtc_consulta_productividad_comercial.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within wtc_consulta_productividad_comercial
integer x = 558
integer y = 24
integer width = 2107
integer taborder = 0
...
type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within wtc_consulta_productividad_comercial
boolean visible = false
end type

type st_empresa from w_int_con_empresa`st_empresa within wtc_consulta_productividad_comercial
boolean visible = false
integer width = 2670
integer height = 84
end type
...
String consulta, comercial, comercial_nombre
...
if uo_comercial.em_codigo.text = "" or isnull(uo_comercial.em_codigo.text) then
	comercial = '%'
else
	comercial = uo_comercial.em_codigo.text
end if
...
consulta =  " select codigo, descripcion "+&
				...
				" and activo = '1' "+&
				" and codigo like '"+comercial+"' "+&
				" order by descripcion "

f_cargar_cursor_nuevo (consulta, comerciales)

for i = 1 to comerciales.rowcount()
	
	comercial = comerciales.object.codigo[i]
	comercial_nombre = comerciales.object.descripcion[i]
	...
	and descoleccionsol.comercial = :comercial
	...
	where modelo_pieza.empresa = :codigo_empresa
	and modelo_trabajo.comercial = :comercial 
	...
	*/
	...
	dw_1.object.comercial[fila_actual] = comercial_nombre
...
integer height = 3252
string title = "none"
string dataobject = "dwtc_productividad_comercial"
...
IF Trim(uo_comercial.em_campo.text)="" THEN 
 IF Trim(uo_comercial.em_codigo.text)<>"" Then uo_comercial.em_campo.SetFocus()
...
event getfocus;call super::getfocus;ue_titulo     = "Ayuda de Comerciales"
