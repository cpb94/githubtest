$PBExportHeader$wtc_mant_maquina.srw
forward
global type wtc_mant_maquina from wt_ventana_padre
end type
type dw_con_piezas_coleccion from u_dw_padre within wtc_mant_maquina
end type
type pb_anyade_trabajo from picturebutton within wtc_mant_maquina
end type
type pb_1 from picturebutton within wtc_mant_maquina
end type
type pb_borrar_trabajo from picturebutton within wtc_mant_maquina
end type
type dw_2 from u_dw within wtc_mant_maquina
end type
end forward
...
global wtc_mant_maquina wtc_mant_maquina
...
event activate;call super::activate;wtc_mant_maquina = ventanas_activas[id_ventana_activa].ventana
end event

type pb_imprimir from wt_ventana_padre`pb_imprimir within wtc_mant_maquina
boolean visible = false
end type

type p_logo from wt_ventana_padre`p_logo within wtc_mant_maquina
end type

type dw_1 from wt_ventana_padre`dw_1 within wtc_mant_maquina
integer height = 348
string dataobject = "dwtc_maquina"
boolean border = false
end type

type pb_borrar from wt_ventana_padre`pb_borrar within wtc_mant_maquina
end type

type pb_salir from wt_ventana_padre`pb_salir within wtc_mant_maquina
end type

type pb_grabar from wt_ventana_padre`pb_grabar within wtc_mant_maquina
end type

type st_titulo from wt_ventana_padre`st_titulo within wtc_mant_maquina
end type

type pb_nuevo from wt_ventana_padre`pb_nuevo within wtc_mant_maquina
end type
...
type pb_cancelar from wt_ventana_padre`pb_cancelar within wtc_mant_maquina
end type
...
type pb_buscar from wt_ventana_padre`pb_buscar within wtc_mant_maquina
end type
