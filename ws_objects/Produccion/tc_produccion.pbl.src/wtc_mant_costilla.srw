$PBExportHeader$wtc_mant_costilla.srw
forward
global type wtc_mant_costilla from wt_ventana_padre
end type
end forward

global type wtc_mant_costilla from wt_ventana_padre
integer height = 744
string title = "Mantenimiento de Placas"
end type
global wtc_mant_costilla wtc_mant_costilla
...
param_colisiones.tabla = "costilla"
...
on wtc_mant_costilla.create
call super::create
end on

on wtc_mant_costilla.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type pb_imprimir from wt_ventana_padre`pb_imprimir within wtc_mant_costilla
end type

type p_logo from wt_ventana_padre`p_logo within wtc_mant_costilla
end type

type dw_1 from wt_ventana_padre`dw_1 within wtc_mant_costilla
integer height = 288
string title = "Mantenimeinto de Colecciones"
string dataobject = "dwtc_costilla"
boolean border = false
end type

type pb_borrar from wt_ventana_padre`pb_borrar within wtc_mant_costilla
end type

type pb_salir from wt_ventana_padre`pb_salir within wtc_mant_costilla
end type

type pb_grabar from wt_ventana_padre`pb_grabar within wtc_mant_costilla
end type

type st_titulo from wt_ventana_padre`st_titulo within wtc_mant_costilla
end type

type pb_nuevo from wt_ventana_padre`pb_nuevo within wtc_mant_costilla
end type

type pb_cancelar from wt_ventana_padre`pb_cancelar within wtc_mant_costilla
end type

type pb_buscar from wt_ventana_padre`pb_buscar within wtc_mant_costilla
end type
