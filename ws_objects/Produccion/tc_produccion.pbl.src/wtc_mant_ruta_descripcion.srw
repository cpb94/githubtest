$PBExportHeader$wtc_mant_ruta_descripcion.srw
forward
global type wtc_mant_ruta_descripcion from wt_ventana_padre
end type
type dw_con_piezas_coleccion from u_dw_padre within wtc_mant_ruta_descripcion
end type
type pb_anyade_trabajo from picturebutton within wtc_mant_ruta_descripcion
end type
end forward

global type wtc_mant_ruta_descripcion from wt_ventana_padre
integer height = 800
string title = "Mantenimiento de Descripciones de Rutas"
dw_con_piezas_coleccion dw_con_piezas_coleccion
pb_anyade_trabajo pb_anyade_trabajo
end type
global wtc_mant_ruta_descripcion wtc_mant_ruta_descripcion
...
DELETE FROM tipooperacion_ruta_descripcion WHERE ruta_descripcion = :padre_codigo USING trans_ts;
...
on wtc_mant_ruta_descripcion.create
int iCurrent
call super::create
...
on wtc_mant_ruta_descripcion.destroy
call super::destroy
...
event activate;call super::activate;wtc_mant_ruta_descripcion = ventanas_activas[id_ventana_activa].ventana
end event

type pb_imprimir from wt_ventana_padre`pb_imprimir within wtc_mant_ruta_descripcion
end type

type p_logo from wt_ventana_padre`p_logo within wtc_mant_ruta_descripcion
end type

type dw_1 from wt_ventana_padre`dw_1 within wtc_mant_ruta_descripcion
integer y = 304
integer height = 280
string dataobject = "dwtc_ruta_descripcion"
boolean border = false
end type

type pb_borrar from wt_ventana_padre`pb_borrar within wtc_mant_ruta_descripcion
end type

type pb_salir from wt_ventana_padre`pb_salir within wtc_mant_ruta_descripcion
end type

type pb_grabar from wt_ventana_padre`pb_grabar within wtc_mant_ruta_descripcion
end type

type st_titulo from wt_ventana_padre`st_titulo within wtc_mant_ruta_descripcion
end type

type pb_nuevo from wt_ventana_padre`pb_nuevo within wtc_mant_ruta_descripcion
end type
...
type pb_cancelar from wt_ventana_padre`pb_cancelar within wtc_mant_ruta_descripcion
end type

type pb_buscar from wt_ventana_padre`pb_buscar within wtc_mant_ruta_descripcion
end type
