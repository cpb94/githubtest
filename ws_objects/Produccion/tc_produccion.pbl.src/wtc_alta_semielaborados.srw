$PBExportHeader$wtc_alta_semielaborados.srw
forward
global type wtc_alta_semielaborados from wt_ventana_padre
end type
type gb_1 from groupbox within wtc_alta_semielaborados
end type
type pb_borrar_trabajo from picturebutton within wtc_alta_semielaborados
end type
type pb_duplica_trabajo from picturebutton within wtc_alta_semielaborados
end type
type pb_anyade_trabajo from picturebutton within wtc_alta_semielaborados
end type
type pb_1 from picturebutton within wtc_alta_semielaborados
end type
type pb_2 from picturebutton within wtc_alta_semielaborados
end type
type tv_escandallo from treeview within wtc_alta_semielaborados
end type
type cb_2 from commandbutton within wtc_alta_semielaborados
end type
type cb_4 from commandbutton within wtc_alta_semielaborados
end type
type pb_bloquear_estructura from picturebutton within wtc_alta_semielaborados
end type
type pb_bloquear_1 from picturebutton within wtc_alta_semielaborados
end type
type st_mensaje from statictext within wtc_alta_semielaborados
end type
type cb_1 from commandbutton within wtc_alta_semielaborados
end type
type pb_3 from picturebutton within wtc_alta_semielaborados
end type
type pb_4 from picturebutton within wtc_alta_semielaborados
end type
type dw_listado_ficha from datawindow within wtc_alta_semielaborados
end type
type gb_2 from groupbox within wtc_alta_semielaborados
end type
type p_1 from picture within wtc_alta_semielaborados
end type
type p_2 from picture within wtc_alta_semielaborados
end type
type p_3 from picture within wtc_alta_semielaborados
end type
type st_1 from statictext within wtc_alta_semielaborados
end type
type st_2 from statictext within wtc_alta_semielaborados
end type
type st_3 from statictext within wtc_alta_semielaborados
end type
type p_imagen from picture within wtc_alta_semielaborados
end type
type r_1 from rectangle within wtc_alta_semielaborados
end type
type gb_3 from groupbox within wtc_alta_semielaborados
end type
type dw_3 from u_dw within wtc_alta_semielaborados
end type
type dw_2 from u_dw within wtc_alta_semielaborados
end type
type dw_4 from u_dw within wtc_alta_semielaborados
end type
type pb_5 from picturebutton within wtc_alta_semielaborados
end type
type pb_6 from picturebutton within wtc_alta_semielaborados
end type
end forward
...
global wtc_alta_semielaborados wtc_alta_semielaborados
...
on wtc_alta_semielaborados.create
int iCurrent
call super::create
...
this.Control[iCurrent+30]=this.pb_5
this.Control[iCurrent+31]=this.pb_6
end on

on wtc_alta_semielaborados.destroy
call super::destroy
...
type pb_imprimir from wt_ventana_padre`pb_imprimir within wtc_alta_semielaborados
integer x = 521
integer y = 128
end type
...
type p_logo from wt_ventana_padre`p_logo within wtc_alta_semielaborados
integer x = 5074
end type

type dw_1 from wt_ventana_padre`dw_1 within wtc_alta_semielaborados
integer x = 41
integer y = 284
integer width = 2213
integer height = 512
...
type pb_borrar from wt_ventana_padre`pb_borrar within wtc_alta_semielaborados
integer x = 5111
integer y = 132
string disabledname = "C:\Tencer_PB12\Delete_24x24_D.png"
end type

type pb_salir from wt_ventana_padre`pb_salir within wtc_alta_semielaborados
integer x = 5431
integer y = 132
string picturename = "C:\Tencer_PB12\Log Out_24x24Gris.png"
end type

type pb_grabar from wt_ventana_padre`pb_grabar within wtc_alta_semielaborados
integer x = 357
integer y = 128
end type

type st_titulo from wt_ventana_padre`st_titulo within wtc_alta_semielaborados
integer x = 37
integer width = 3913
integer height = 72
...
type pb_nuevo from wt_ventana_padre`pb_nuevo within wtc_alta_semielaborados
integer x = 37
integer y = 128
...
type pb_cancelar from wt_ventana_padre`pb_cancelar within wtc_alta_semielaborados
integer x = 5271
integer y = 132
...
type pb_buscar from wt_ventana_padre`pb_buscar within wtc_alta_semielaborados
integer x = 197
integer y = 128
end type
...
event clicked;long fila_actual, maximo_valor_dw
string codigo_actual, ruta

codigo_actual = f_codigo_principal()
fila_actual = dw_2.InsertRow(0)

//maximo_valor_dw = long(dw_2.Describe("Evaluate('Max(integer(ruta_fabricacion_codigo))', 0)"))
//if isnull(maximo_valor_dw) then maximo_valor_dw = 0
//ruta = String(maximo_valor_dw +1)
...
//dw_2.object.ruta_fabricacion_codigo[fila_actual] = ruta
if dw_2.rowcount() > 1 then
...
CHOOSE CASE dwo.name
	...
	CASE "ruta_fabricacion_ruta_descripcion"
		SELECT descripcion
		INTO :resultado1 
...
if key =  keyEnter! then
	...
	CHOOSE CASE campo
		...
		CASE "ruta_fabricacion_ruta_descripcion"
			...
			resultado = Message.PowerObjectParm
			if resultado.resultado > 0 then
				this.object.ruta_fabricacion_ruta_descripcion[this.GetRow()] 			= resultado.valores[1]
...
event rowfocuschanged;call super::rowfocuschanged;String operacion, articulo_anterior
if currentrow > 0 then 
	operacion = String(this.object.ruta_fabricacion_tipooperacion[currentrow])
	articulo_anterior = String(this.object.ruta_fabricacion_articulo_anterior[currentrow])
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "dwtc_alta_semielaborados_rutas_articulos"
end type
