$PBExportHeader$w_produccion_arbol.srw
forward
global type w_produccion_arbol from window
end type
type st_titulo from statictext within w_produccion_arbol
end type
type tv_menu from treeview within w_produccion_arbol
end type
end forward
...
global w_produccion_arbol w_produccion_arbol

event open;string titulo

f_cargar_menu_arbol (w_produccion, tv_menu, titulo)
st_titulo.text = 'Producción'



end event

on w_produccion_arbol.create
