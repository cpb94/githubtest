$PBExportHeader$w_general_arbol.srw
forward
global type w_general_arbol from window
end type
type st_titulo from statictext within w_general_arbol
end type
type tv_menu from treeview within w_general_arbol
end type
end forward
...
global w_general_arbol w_general_arbol

event open;string titulo

f_cargar_menu_arbol (w_general, tv_menu, titulo)
st_titulo.text = 'General'



end event

on w_general_arbol.create
