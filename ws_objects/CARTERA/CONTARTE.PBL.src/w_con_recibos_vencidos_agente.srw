$PBExportHeader$w_con_recibos_vencidos_agente.srw
$PBExportComments$€
forward
global type w_con_recibos_vencidos_agente from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_recibos_vencidos_agente
end type
type uo_tipo from u_marca_lista within w_con_recibos_vencidos_agente
end type
type cb_consulta from u_boton within w_con_recibos_vencidos_agente
end type
type pb_imprimir_preli from picturebutton within w_con_recibos_vencidos_agente
end type
type dw_listado from datawindow within w_con_recibos_vencidos_agente
end type
type uo_tipo2 from u_marca_lista within w_con_recibos_vencidos_agente
end type
type uo_agente from u_em_campo_2 within w_con_recibos_vencidos_agente
end type
type dw_1 from datawindow within w_con_recibos_vencidos_agente
end type
type em_fecha from u_em_campo within w_con_recibos_vencidos_agente
end type
type detalle from radiobutton within w_con_recibos_vencidos_agente
end type
type resumen from radiobutton within w_con_recibos_vencidos_agente
end type
type gb_3 from groupbox within w_con_recibos_vencidos_agente
end type
type gb_2 from groupbox within w_con_recibos_vencidos_agente
end type
type gb_1 from groupbox within w_con_recibos_vencidos_agente
end type
type gb_cuenta from groupbox within w_con_recibos_vencidos_agente
end type
type gb_fecha from groupbox within w_con_recibos_vencidos_agente
end type
type rb_v from radiobutton within w_con_recibos_vencidos_agente
end type
type rb_n from radiobutton within w_con_recibos_vencidos_agente
end type
type rb_t from radiobutton within w_con_recibos_vencidos_agente
end type
type uo_1 from u_manejo_datawindow within w_con_recibos_vencidos_agente
end type
end forward
...
global w_con_recibos_vencidos_agente w_con_recibos_vencidos_agente
...
iF Trim(uo_agente.em_codigo.text) = "" Then
   ...
   cli2 = "Z"
ELSE
	cli1 = uo_agente.em_codigo.text
	cli2 = uo_agente.em_codigo.text
END IF
...
public subroutine f_detalle (boolean bol);IF bol Then
		...
		dw_listado.DataObject= "report_carefectos_agente_vencidos"
ELSE
		dw_1.Modify("DataWindow.Detail.Height=0")
		dw_listado.DataObject= "report_carefectos_agent_vencidos_resumen"
END IF
end subroutine
...
This.title = " Consulta recibos  vencidos por agente"
...
on w_con_recibos_vencidos_agente.create
int iCurrent
call super::create
...
this.Control[iCurrent+16]=this.gb_fecha
...
on w_con_recibos_vencidos_agente.destroy
call super::destroy
destroy(this.pb_2)
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_recibos_vencidos_agente
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_recibos_vencidos_agente
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_recibos_vencidos_agente
integer x = 14
integer y = 20
integer width = 2642
integer height = 92
...
integer width = 46
integer height = 36
string dataobject = "report_carefectos_agente_vencidos"
...
integer height = 1676
boolean bringtotop = true
string dataobject = "dw_con_carefectos_vencidos_agente"
