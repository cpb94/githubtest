$PBExportHeader$w_con_recibos_fecha.srw
$PBExportComments$€
forward
global type w_con_recibos_fecha from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_recibos_fecha
end type
type cb_1 from u_boton within w_con_recibos_fecha
end type
type uo_tipo from u_marca_lista within w_con_recibos_fecha
end type
type dw_proceso from datawindow within w_con_recibos_fecha
end type
type cb_consulta from u_boton within w_con_recibos_fecha
end type
type pb_imprimir_preli from picturebutton within w_con_recibos_fecha
end type
type st_8 from statictext within w_con_recibos_fecha
end type
type em_fechadesde from u_em_campo within w_con_recibos_fecha
end type
type st_9 from statictext within w_con_recibos_fecha
end type
type gb_1 from groupbox within w_con_recibos_fecha
end type
type em_fechahasta from u_em_campo within w_con_recibos_fecha
end type
type dw_listado from datawindow within w_con_recibos_fecha
end type
type cb_2 from u_boton within w_con_recibos_fecha
end type
type uo_tipo2 from u_marca_lista within w_con_recibos_fecha
end type
type dw_1 from datawindow within w_con_recibos_fecha
end type
type dw_proceso2 from datawindow within w_con_recibos_fecha
end type
type gb_2 from groupbox within w_con_recibos_fecha
end type
end forward
...
global w_con_recibos_fecha w_con_recibos_fecha
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_recibos_fecha
integer taborder = 20
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_recibos_fecha
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_recibos_fecha
integer x = 27
integer y = 24
integer width = 2642
end type
...
integer width = 41
integer height = 40
string dataobject = "report_carefectos_situacion_fechas"
boolean livescroll = true
end type
...
string dataobject = "dw_con_carefectos_situacion_fechas"
