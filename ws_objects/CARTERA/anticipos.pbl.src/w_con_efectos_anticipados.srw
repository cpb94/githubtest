$PBExportHeader$w_con_efectos_anticipados.srw
forward
global type w_con_efectos_anticipados from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_efectos_anticipados
end type
type cb_consulta from u_boton within w_con_efectos_anticipados
end type
type pb_imprimir_preli from picturebutton within w_con_efectos_anticipados
end type
type st_8 from statictext within w_con_efectos_anticipados
end type
type em_fechadesde from u_em_campo within w_con_efectos_anticipados
end type
type st_9 from statictext within w_con_efectos_anticipados
end type
type gb_1 from groupbox within w_con_efectos_anticipados
end type
type em_fechahasta from u_em_campo within w_con_efectos_anticipados
end type
type dw_listado from datawindow within w_con_efectos_anticipados
end type
type ddlb_1 from dropdownlistbox within w_con_efectos_anticipados
end type
type cb_1 from u_boton within w_con_efectos_anticipados
end type
type uo_tipo from u_marca_lista within w_con_efectos_anticipados
end type
type dw_proceso from datawindow within w_con_efectos_anticipados
end type
type dw_1 from datawindow within w_con_efectos_anticipados
end type
type cb_2 from u_boton within w_con_efectos_anticipados
end type
type uo_situacion from u_marca_lista within w_con_efectos_anticipados
end type
end forward
...
global w_con_efectos_anticipados w_con_efectos_anticipados
...
on w_con_efectos_anticipados.create
int iCurrent
call super::create
...
on w_con_efectos_anticipados.destroy
call super::destroy
destroy(this.pb_2)
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_efectos_anticipados
integer taborder = 40
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_efectos_anticipados
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_efectos_anticipados
integer x = 5
integer y = 8
integer width = 2642
end type
...
event clicked;if ddlb_1.text = "Anticipadas" then
	dw_1.dataobject = "dw_con_efectos_anticipados"
else
	dw_1.dataobject = "dw_con_efectos_no_anticipados"
end if
...
event clicked;if ddlb_1.text = "Anticipadas" then
	dw_listado.dataobject = "report_con_efectos_anticipados4"
else
	dw_listado.dataobject = "report_con_efectos_no_anticipados"
end if
...
choose case orden
	...
	case 3	
		...
		if ddlb_1.text = "Anticipadas" then
			dw_listado.SetSort("importe_efec")
		else	
			dw_listado.SetSort("importe")
		end if	
		dw_listado.Sort()
...
event clicked;choose case f_objeto_datawindow(This) 
	...
	case "t_importe"
		if ddlb_1.text = "Anticipadas" then
			dw_1.SetSort("importe_efec")
		else	
			dw_1.SetSort("importe")
		end if	
		dw_1.Sort()
		orden = 3
