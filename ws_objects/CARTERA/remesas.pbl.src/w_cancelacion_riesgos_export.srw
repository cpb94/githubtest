$PBExportHeader$w_cancelacion_riesgos_export.srw
$PBExportComments$€ Cancelacion efectos sit = 5 de Nacional
forward
global type w_cancelacion_riesgos_export from w_int_con_empresa
end type
type pb_1 from upb_salir within w_cancelacion_riesgos_export
end type
type cb_procesar from commandbutton within w_cancelacion_riesgos_export
end type
type st_2 from statictext within w_cancelacion_riesgos_export
end type
type em_hasta from editmask within w_cancelacion_riesgos_export
end type
type cb_continuar from commandbutton within w_cancelacion_riesgos_export
end type
type gb_2 from groupbox within w_cancelacion_riesgos_export
end type
type st_1 from statictext within w_cancelacion_riesgos_export
end type
type dw_cursor_agrupados from datawindow within w_cancelacion_riesgos_export
end type
type uo_banco from u_em_campo_2 within w_cancelacion_riesgos_export
end type
type st_22 from statictext within w_cancelacion_riesgos_export
end type
type gb_3 from groupbox within w_cancelacion_riesgos_export
end type
type uo_ejercicio from u_ejercicio within w_cancelacion_riesgos_export
end type
type dw_listado from datawindow within w_cancelacion_riesgos_export
end type
type pb_2 from upb_imprimir within w_cancelacion_riesgos_export
end type
type dw_detalle from datawindow within w_cancelacion_riesgos_export
end type
end forward
...
global w_cancelacion_riesgos_export w_cancelacion_riesgos_export
...
event open;call super::open;istr_parametros.s_titulo_ventana="Cancelación de Riesgos Exportación"
...
on w_cancelacion_riesgos_export.create
int iCurrent
call super::create
...
on w_cancelacion_riesgos_export.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_cancelacion_riesgos_export
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_cancelacion_riesgos_export
end type

type st_empresa from w_int_con_empresa`st_empresa within w_cancelacion_riesgos_export
integer x = 5
integer width = 4233
end type
