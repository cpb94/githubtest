$PBExportHeader$w_int_simul_remesas_expor.srw
$PBExportComments$€
forward
global type w_int_simul_remesas_expor from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_simul_remesas_expor
end type
type dw_listado from datawindow within w_int_simul_remesas_expor
end type
type st_remesa from statictext within w_int_simul_remesas_expor
end type
type em_remesa from u_em_campo within w_int_simul_remesas_expor
end type
type em_total from editmask within w_int_simul_remesas_expor
end type
type em_fecharemesa from u_em_campo within w_int_simul_remesas_expor
end type
type cb_continuar from commandbutton within w_int_simul_remesas_expor
end type
type st_1 from statictext within w_int_simul_remesas_expor
end type
type em_maximo from editmask within w_int_simul_remesas_expor
end type
type st_dif from statictext within w_int_simul_remesas_expor
end type
type em_diferencia from editmask within w_int_simul_remesas_expor
end type
type gb_2 from groupbox within w_int_simul_remesas_expor
end type
type gb_1 from groupbox within w_int_simul_remesas_expor
end type
type em_vto_desde from editmask within w_int_simul_remesas_expor
end type
type uo_tiporem from u_em_campo_2 within w_int_simul_remesas_expor
end type
type dw_recibos from datawindow within w_int_simul_remesas_expor
end type
type st_2 from statictext within w_int_simul_remesas_expor
end type
type st_6 from statictext within w_int_simul_remesas_expor
end type
type st_7 from statictext within w_int_simul_remesas_expor
end type
type st_8 from statictext within w_int_simul_remesas_expor
end type
type st_9 from statictext within w_int_simul_remesas_expor
end type
type st_11 from statictext within w_int_simul_remesas_expor
end type
type cb_retrocede from commandbutton within w_int_simul_remesas_expor
end type
type cb_salir from commandbutton within w_int_simul_remesas_expor
end type
type cb_ejecuta from commandbutton within w_int_simul_remesas_expor
end type
type cb_bancos from commandbutton within w_int_simul_remesas_expor
end type
type dw_lgasban from datawindow within w_int_simul_remesas_expor
end type
type uo_bancorem from u_em_campo_2 within w_int_simul_remesas_expor
end type
type st_3 from statictext within w_int_simul_remesas_expor
end type
type st_anyoret from statictext within w_int_simul_remesas_expor
end type
type em_anyoret from u_em_campo within w_int_simul_remesas_expor
end type
type st_12 from statictext within w_int_simul_remesas_expor
end type
type cb_1 from commandbutton within w_int_simul_remesas_expor
end type
type st_banco from statictext within w_int_simul_remesas_expor
end type
type uo_banco from u_em_campo_2 within w_int_simul_remesas_expor
end type
type dw_efectos_marcados from datawindow within w_int_simul_remesas_expor
end type
type dw_bancos from datawindow within w_int_simul_remesas_expor
end type
type st_4 from statictext within w_int_simul_remesas_expor
end type
type rb_preimp from radiobutton within w_int_simul_remesas_expor
end type
type st_5 from statictext within w_int_simul_remesas_expor
end type
type pb_imp_recibos from upb_imprimir within w_int_simul_remesas_expor
end type
type st_imp_recibos from statictext within w_int_simul_remesas_expor
end type
type st_efe from statictext within w_int_simul_remesas_expor
end type
type em_efectos from editmask within w_int_simul_remesas_expor
end type
type cb_marcar from u_cancelar within w_int_simul_remesas_expor
end type
type dw_gastos from datawindow within w_int_simul_remesas_expor
end type
type cb_desmarca from u_cancelar within w_int_simul_remesas_expor
end type
type dw_remesas from datawindow within w_int_simul_remesas_expor
end type
type em_vto_hasta from editmask within w_int_simul_remesas_expor
end type
type dw_detalle from datawindow within w_int_simul_remesas_expor
end type
type cb_crear from commandbutton within w_int_simul_remesas_expor
end type
type uo_tipodoc from u_marca_lista within w_int_simul_remesas_expor
end type
type uo_tipo2 from u_marca_lista within w_int_simul_remesas_expor
end type
end forward
...
global w_int_simul_remesas_expor w_int_simul_remesas_expor
...
on w_int_simul_remesas_expor.create
int iCurrent
call super::create
...
on w_int_simul_remesas_expor.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_simul_remesas_expor
integer x = 37
integer y = 1456
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_simul_remesas_expor
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_simul_remesas_expor
integer x = 9
integer y = 4
integer width = 2427
end type
