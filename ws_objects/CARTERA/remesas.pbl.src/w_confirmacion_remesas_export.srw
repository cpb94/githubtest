$PBExportHeader$w_confirmacion_remesas_export.srw
$PBExportComments$€
forward
global type w_confirmacion_remesas_export from w_int_con_empresa
end type
type gb_5 from groupbox within w_confirmacion_remesas_export
end type
type pb_1 from upb_salir within w_confirmacion_remesas_export
end type
type em_banco from u_em_campo within w_confirmacion_remesas_export
end type
type st_1 from statictext within w_confirmacion_remesas_export
end type
type st_nombre_banco from statictext within w_confirmacion_remesas_export
end type
type dw_1 from datawindow within w_confirmacion_remesas_export
end type
type st_2 from statictext within w_confirmacion_remesas_export
end type
type em_remesa from u_em_campo within w_confirmacion_remesas_export
end type
type cb_1 from commandbutton within w_confirmacion_remesas_export
end type
type em_tipo_remesa from u_em_campo within w_confirmacion_remesas_export
end type
type st_3 from statictext within w_confirmacion_remesas_export
end type
type st_4 from statictext within w_confirmacion_remesas_export
end type
type rb_1 from radiobutton within w_confirmacion_remesas_export
end type
type rb_2 from radiobutton within w_confirmacion_remesas_export
end type
type cb_2 from commandbutton within w_confirmacion_remesas_export
end type
type gb_3 from groupbox within w_confirmacion_remesas_export
end type
type gb_2 from groupbox within w_confirmacion_remesas_export
end type
type gb_1 from groupbox within w_confirmacion_remesas_export
end type
type st_5 from statictext within w_confirmacion_remesas_export
end type
type st_fecha from statictext within w_confirmacion_remesas_export
end type
type dw_2 from datawindow within w_confirmacion_remesas_export
end type
type st_6 from statictext within w_confirmacion_remesas_export
end type
type em_anyo from editmask within w_confirmacion_remesas_export
end type
type gb_4 from groupbox within w_confirmacion_remesas_export
end type
type st_7 from statictext within w_confirmacion_remesas_export
end type
type st_8 from statictext within w_confirmacion_remesas_export
end type
type st_9 from statictext within w_confirmacion_remesas_export
end type
type em_fcontable from editmask within w_confirmacion_remesas_export
end type
type st_10 from statictext within w_confirmacion_remesas_export
end type
type st_11 from statictext within w_confirmacion_remesas_export
end type
type st_12 from statictext within w_confirmacion_remesas_export
end type
end forward
...
global w_confirmacion_remesas_export w_confirmacion_remesas_export
...
event open;call super::open;istr_parametros.s_titulo_ventana="Confirmación de Remesas Exportación"
...
on w_confirmacion_remesas_export.create
int iCurrent
call super::create
...
on w_confirmacion_remesas_export.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_confirmacion_remesas_export
integer x = 2610
integer y = 16
integer width = 219
integer taborder = 0
...
type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_confirmacion_remesas_export
end type

type st_empresa from w_int_con_empresa`st_empresa within w_confirmacion_remesas_export
integer x = 9
integer y = 4
integer width = 2427
integer height = 88
