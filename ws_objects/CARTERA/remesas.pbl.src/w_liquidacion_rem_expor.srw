$PBExportHeader$w_liquidacion_rem_expor.srw
$PBExportComments$€
forward
global type w_liquidacion_rem_expor from w_int_con_empresa
end type
type pb_1 from upb_salir within w_liquidacion_rem_expor
end type
type em_banco from u_em_campo within w_liquidacion_rem_expor
end type
type st_nombre_banco from statictext within w_liquidacion_rem_expor
end type
type st_2 from statictext within w_liquidacion_rem_expor
end type
type em_remesa from u_em_campo within w_liquidacion_rem_expor
end type
type cb_1 from commandbutton within w_liquidacion_rem_expor
end type
type cb_2 from commandbutton within w_liquidacion_rem_expor
end type
type st_5 from statictext within w_liquidacion_rem_expor
end type
type st_fecha from statictext within w_liquidacion_rem_expor
end type
type st_6 from statictext within w_liquidacion_rem_expor
end type
type em_anyo from editmask within w_liquidacion_rem_expor
end type
type st_9 from statictext within w_liquidacion_rem_expor
end type
type em_fcontable from editmask within w_liquidacion_rem_expor
end type
type gb_2 from groupbox within w_liquidacion_rem_expor
end type
type gb_1 from groupbox within w_liquidacion_rem_expor
end type
type dw_2 from datawindow within w_liquidacion_rem_expor
end type
type cb_3 from commandbutton within w_liquidacion_rem_expor
end type
type cb_4 from commandbutton within w_liquidacion_rem_expor
end type
type dw_1 from datawindow within w_liquidacion_rem_expor
end type
type st_7 from statictext within w_liquidacion_rem_expor
end type
end forward
...
global w_liquidacion_rem_expor w_liquidacion_rem_expor
...
event open;call super::open;istr_parametros.s_titulo_ventana="Liquidación de Remesas Exportación"
...
on w_liquidacion_rem_expor.create
int iCurrent
call super::create
...
on w_liquidacion_rem_expor.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_liquidacion_rem_expor
integer x = 2112
integer y = 20
integer width = 485
integer taborder = 0
...
type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_liquidacion_rem_expor
end type

type st_empresa from w_int_con_empresa`st_empresa within w_liquidacion_rem_expor
integer x = 9
integer y = 4
integer width = 2427
integer height = 108
