$PBExportHeader$w_modifica_remesas.srw
$PBExportComments$€
forward
global type w_modifica_remesas from w_int_con_empresa
end type
type pb_1 from upb_salir within w_modifica_remesas
end type
type em_banco from u_em_campo within w_modifica_remesas
end type
type st_1 from statictext within w_modifica_remesas
end type
type st_nombre_banco from statictext within w_modifica_remesas
end type
type em_remesa from u_em_campo within w_modifica_remesas
end type
type st_fecha from statictext within w_modifica_remesas
end type
type st_4 from statictext within w_modifica_remesas
end type
type st_2 from statictext within w_modifica_remesas
end type
type st_3 from statictext within w_modifica_remesas
end type
type dw_1 from datawindow within w_modifica_remesas
end type
type p_bandera from picture within w_modifica_remesas
end type
type st_16 from statictext within w_modifica_remesas
end type
type st_7 from statictext within w_modifica_remesas
end type
type em_vto_desde from editmask within w_modifica_remesas
end type
type em_vto_hasta from editmask within w_modifica_remesas
end type
type st_9 from statictext within w_modifica_remesas
end type
type cb_1 from commandbutton within w_modifica_remesas
end type
type uo_tipodoc from u_marca_lista within w_modifica_remesas
end type
type gb_1 from groupbox within w_modifica_remesas
end type
type st_12 from statictext within w_modifica_remesas
end type
type cb_continuar from commandbutton within w_modifica_remesas
end type
type dw_detalle from datawindow within w_modifica_remesas
end type
type dw_efectos_marcados from datawindow within w_modifica_remesas
end type
type uo_tiporem from u_em_campo_2 within w_modifica_remesas
end type
type st_13 from statictext within w_modifica_remesas
end type
type em_anyorem from u_em_campo within w_modifica_remesas
end type
type dw_remesas from datawindow within w_modifica_remesas
end type
end forward
...
global w_modifica_remesas w_modifica_remesas
...
event open;call super::open;istr_parametros.s_titulo_ventana="Modificación de Remesas"
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_modifica_remesas
integer x = 2377
integer y = 1352
integer width = 485
integer taborder = 0
...
type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_modifica_remesas
end type

type st_empresa from w_int_con_empresa`st_empresa within w_modifica_remesas
integer x = 9
integer y = 4
integer width = 2427
integer height = 108
