$PBExportHeader$w_cartera_arbol.srw
forward
global type w_cartera_arbol from window
end type
type st_titulo from statictext within w_cartera_arbol
end type
type tv_menu from treeview within w_cartera_arbol
end type
end forward
...
global w_cartera_arbol w_cartera_arbol

event open;string titulo

f_cargar_menu_arbol (w_cartera, tv_menu, titulo)
st_titulo.text = 'Cartera'



end event

on w_cartera_arbol.create
