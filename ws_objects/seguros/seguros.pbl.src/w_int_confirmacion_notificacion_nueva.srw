$PBExportHeader$w_int_confirmacion_notificacion_nueva.srw
forward
global type w_int_confirmacion_notificacion_nueva from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_confirmacion_notificacion_nueva
end type
type dw_listado_detalle from datawindow within w_int_confirmacion_notificacion_nueva
end type
type pb_2 from upb_imprimir within w_int_confirmacion_notificacion_nueva
end type
type dw_detalle from datawindow within w_int_confirmacion_notificacion_nueva
end type
type uo_companyia from u_em_campo_2 within w_int_confirmacion_notificacion_nueva
end type
type cb_borrar from u_boton within w_int_confirmacion_notificacion_nueva
end type
type em_anyo from u_em_campo within w_int_confirmacion_notificacion_nueva
end type
type uo_mes from u_em_campo_2 within w_int_confirmacion_notificacion_nueva
end type
type st_1 from statictext within w_int_confirmacion_notificacion_nueva
end type
type st_2 from statictext within w_int_confirmacion_notificacion_nueva
end type
type gb_4 from groupbox within w_int_confirmacion_notificacion_nueva
end type
type em_fecha_notificacion from u_em_campo within w_int_confirmacion_notificacion_nueva
end type
type gb_5 from groupbox within w_int_confirmacion_notificacion_nueva
end type
type gb_3 from groupbox within w_int_confirmacion_notificacion_nueva
end type
type dw_listado_fras_declaradas from datawindow within w_int_confirmacion_notificacion_nueva
end type
type pb_3 from upb_imprimir within w_int_confirmacion_notificacion_nueva
end type
type st_3 from statictext within w_int_confirmacion_notificacion_nueva
end type
type gb_6 from groupbox within w_int_confirmacion_notificacion_nueva
end type
type pb_4 from upb_imprimir within w_int_confirmacion_notificacion_nueva
end type
type st_4 from statictext within w_int_confirmacion_notificacion_nueva
end type
type gb_7 from groupbox within w_int_confirmacion_notificacion_nueva
end type
type dw_listado_notificacion_nacional from datawindow within w_int_confirmacion_notificacion_nueva
end type
type cb_marcar_notificadas from u_boton within w_int_confirmacion_notificacion_nueva
end type
type gb_8 from groupbox within w_int_confirmacion_notificacion_nueva
end type
type pb_5 from upb_imprimir within w_int_confirmacion_notificacion_nueva
end type
type st_5 from statictext within w_int_confirmacion_notificacion_nueva
end type
type gb_9 from groupbox within w_int_confirmacion_notificacion_nueva
end type
type dw_listado_notificacion_export from datawindow within w_int_confirmacion_notificacion_nueva
end type
end forward
...
global w_int_confirmacion_notificacion_nueva w_int_confirmacion_notificacion_nueva
...
on w_int_confirmacion_notificacion_nueva.create
int iCurrent
call super::create
...
on w_int_confirmacion_notificacion_nueva.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_confirmacion_notificacion_nueva
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_confirmacion_notificacion_nueva
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_confirmacion_notificacion_nueva
integer x = 27
integer y = 8
integer width = 2427
end type
