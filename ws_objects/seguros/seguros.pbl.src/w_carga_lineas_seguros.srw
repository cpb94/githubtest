$PBExportHeader$w_carga_lineas_seguros.srw
forward
global type w_carga_lineas_seguros from w_int_con_empresa
end type
type pb_1 from upb_salir within w_carga_lineas_seguros
end type
type dw_listado_detalle from datawindow within w_carga_lineas_seguros
end type
type pb_2 from upb_imprimir within w_carga_lineas_seguros
end type
type uo_companyia from u_em_campo_2 within w_carga_lineas_seguros
end type
type st_6 from statictext within w_carga_lineas_seguros
end type
type cb_borrar from u_boton within w_carga_lineas_seguros
end type
type st_1 from statictext within w_carga_lineas_seguros
end type
type em_anyo from u_em_campo within w_carga_lineas_seguros
end type
type st_2 from statictext within w_carga_lineas_seguros
end type
type uo_mes from u_em_campo_2 within w_carga_lineas_seguros
end type
type uo_tipo_documento from u_marca_lista within w_carga_lineas_seguros
end type
type dw_detalle from datawindow within w_carga_lineas_seguros
end type
type st_3 from statictext within w_carga_lineas_seguros
end type
type gb_1 from groupbox within w_carga_lineas_seguros
end type
type uo_1 from u_manejo_datawindow within w_carga_lineas_seguros
end type
type clientes_primera_venta from structure within w_carga_lineas_seguros
end type
end forward
...
global w_carga_lineas_seguros w_carga_lineas_seguros
...
on w_carga_lineas_seguros.create
int iCurrent
call super::create
...
on w_carga_lineas_seguros.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_carga_lineas_seguros
integer taborder = 60
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_carga_lineas_seguros
end type

type st_empresa from w_int_con_empresa`st_empresa within w_carga_lineas_seguros
integer x = 27
integer y = 4
integer width = 2427
end type
