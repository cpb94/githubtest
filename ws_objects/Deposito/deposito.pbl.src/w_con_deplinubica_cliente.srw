$PBExportHeader$w_con_deplinubica_cliente.srw
forward
global type w_con_deplinubica_cliente from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_deplinubica_cliente
end type
type dw_proceso from datawindow within w_con_deplinubica_cliente
end type
type dw_listado from datawindow within w_con_deplinubica_cliente
end type
type pb_imprimir_preli from picturebutton within w_con_deplinubica_cliente
end type
type dw_1 from datawindow within w_con_deplinubica_cliente
end type
type uo_1 from u_manejo_datawindow within w_con_deplinubica_cliente
end type
type uo_cliente from u_em_campo_2 within w_con_deplinubica_cliente
end type
type cb_continuar from u_boton within w_con_deplinubica_cliente
end type
type st_1 from statictext within w_con_deplinubica_cliente
end type
type st_2 from statictext within w_con_deplinubica_cliente
end type
type uo_articulo from u_em_campo_2 within w_con_deplinubica_cliente
end type
type gb_4 from groupbox within w_con_deplinubica_cliente
end type
end forward
...
global w_con_deplinubica_cliente w_con_deplinubica_cliente
...
on w_con_deplinubica_cliente.create
int iCurrent
call super::create
...
on w_con_deplinubica_cliente.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_deplinubica_cliente
integer taborder = 40
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_deplinubica_cliente
end type

event sle_opcion_orden::getfocus;call super::getfocus;f_activar_campo(uo_cliente.em_campo)
end event

type st_empresa from w_int_con_empresa`st_empresa within w_con_deplinubica_cliente
integer x = 27
integer y = 20
integer width = 2574
end type
...
integer height = 144
boolean bringtotop = true
string dataobject = "report_con_deplinubica_cliente"
boolean livescroll = true
end type
...
event clicked;dw_listado.retrieve(codigo_empresa,uo_cliente.em_codigo.text)
...
integer width = 2811
integer height = 1032
string dataobject = "dw_con_deplinubica_cliente3"
