$PBExportHeader$w_con_rotacion_deposito_importe.srw
forward
global type w_con_rotacion_deposito_importe from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_rotacion_deposito_importe
end type
type pb_2 from upb_imprimir within w_con_rotacion_deposito_importe
end type
type cb_1 from commandbutton within w_con_rotacion_deposito_importe
end type
type gb_6 from groupbox within w_con_rotacion_deposito_importe
end type
type dw_resumen from datawindow within w_con_rotacion_deposito_importe
end type
type uo_cliente from u_em_campo_2 within w_con_rotacion_deposito_importe
end type
type st_2 from statictext within w_con_rotacion_deposito_importe
end type
type em_anyo from editmask within w_con_rotacion_deposito_importe
end type
type gb_4 from groupbox within w_con_rotacion_deposito_importe
end type
end forward
...
global w_con_rotacion_deposito_importe w_con_rotacion_deposito_importe
...
select sum( ( depmovhis.cantidade - depmovhis.cantidads) * venlintarifas.precio)
into :v_cantidad
...
and depmovhis.empresa = venlintarifas.empresa
and venlintarifas.precio = ( select max ( precio ) 
										from venlintarifas 
										where empresa = depmovhis.empresa
										and articulo = depmovhis.articulo ) 
and depmovhis.articulo = venlintarifas.articulo
...
on w_con_rotacion_deposito_importe.create
int iCurrent
call super::create
...
on w_con_rotacion_deposito_importe.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_rotacion_deposito_importe
integer y = 612
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_rotacion_deposito_importe
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_rotacion_deposito_importe
integer x = 9
integer y = 8
integer width = 4201
integer height = 88
...
integer width = 4389
integer height = 2124
string dataobject = "dw_con_rotacion_deposito_clientes"
