$PBExportHeader$w_depositos_arbol.srw
forward
global type w_depositos_arbol from window
end type
type st_titulo from statictext within w_depositos_arbol
end type
type tv_menu from treeview within w_depositos_arbol
end type
end forward
...
global w_depositos_arbol w_depositos_arbol

event open;string titulo

f_cargar_menu_arbol (w_depositos, tv_menu, titulo)
st_titulo.text = 'Depositos'



end event

on w_depositos_arbol.create
