$PBExportHeader$w_con_proformas_pais.srw
forward
global type w_con_proformas_pais from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_proformas_pais
end type
type pb_2 from upb_imprimir within w_con_proformas_pais
end type
type st_2 from statictext within w_con_proformas_pais
end type
type em_pais from u_em_campo within w_con_proformas_pais
end type
type st_nombre_pais from statictext within w_con_proformas_pais
end type
type dw_detalle from datawindow within w_con_proformas_pais
end type
type dw_listado from datawindow within w_con_proformas_pais
end type
type uo_manejo from u_manejo_datawindow within w_con_proformas_pais
end type
end forward
...
global w_con_proformas_pais w_con_proformas_pais
...
event open;call super::open;istr_parametros.s_titulo_ventana="Consulta lineas de proforma por País"
...
on w_con_proformas_pais.create
int iCurrent
call super::create
...
on w_con_proformas_pais.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_proformas_pais
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_proformas_pais
...
type st_empresa from w_int_con_empresa`st_empresa within w_con_proformas_pais
integer x = 14
integer y = 8
integer width = 2427
end type
...
integer width = 2853
integer height = 1168
string dataobject = "dw_con_proformas_pais"
...
boolean bringtotop = true
string dataobject = "report_con_proformas_pais"
boolean livescroll = true
end type
