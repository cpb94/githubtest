$PBExportHeader$w_int_traspaso_ventarifas_familia_marca_submarca_old.srw
$PBExportComments$Transpaso de una tarifa a otra aplicanco un cambio.
forward
global type w_int_traspaso_ventarifas_familia_marca_submarca_old from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type st_2 from statictext within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type em_tarifa from u_em_campo within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type st_nombre_tarifa from statictext within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type dw_fechas from datawindow within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type st_3 from statictext within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type sle_moneda from singlelineedit within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_10 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type em_tarifa_destino from u_em_campo within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type dw_fechas_destino from datawindow within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type st_5 from statictext within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type sle_moneda_destino from singlelineedit within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type st_4 from statictext within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type rb_descendente from radiobutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type rb_ascendente from radiobutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type rb_lineal from radiobutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type rb_porcentual from radiobutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type st_texto from statictext within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type em_cantidad from u_em_campo within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type cb_1 from u_boton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type dw_proceso from datawindow within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type rb_cambio from radiobutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type pb_2 from upb_carpeta within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type st_nombre_tarifa_destino from statictext within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type dw_proceso2 from datawindow within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type rb_incremento from radiobutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type em_cambio from u_em_campo within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type st_1 from statictext within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type uo_pavrev from u_marca_lista within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type uo_familias from u_marca_lista within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type uo_marcas from u_marca_lista within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type uo_submarcas from u_marca_lista within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type uo_formatos from u_marca_lista within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type cb_formatos from commandbutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type cb_submarcas from commandbutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type cb_marcas from commandbutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type cb_familias from commandbutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type cb_pavrev from commandbutton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type cb_2 from u_boton within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type dw_articulos_origen from datawindow within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type dw_articulos_destino from datawindow within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_1 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_2 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_5 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_6 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_7 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_3 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_9 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_8 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
type gb_4 from groupbox within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type
end forward
...
global w_int_traspaso_ventarifas_familia_marca_submarca_old w_int_traspaso_ventarifas_familia_marca_submarca_old
...
on w_int_traspaso_ventarifas_familia_marca_submarca_old.create
int iCurrent
call super::create
...
this.Control[iCurrent+46]=this.gb_7
this.Control[iCurrent+47]=this.gb_3
this.Control[iCurrent+48]=this.gb_9
this.Control[iCurrent+49]=this.gb_8
this.Control[iCurrent+50]=this.gb_4
end on

on w_int_traspaso_ventarifas_familia_marca_submarca_old.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_traspaso_ventarifas_familia_marca_submarca_old
integer x = 1285
integer y = 24
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_traspaso_ventarifas_familia_marca_submarca_old
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_traspaso_ventarifas_familia_marca_submarca_old
integer x = 27
integer y = 8
integer width = 2427
end type
...
string dataobject = "dw_int_traspaso_ventarifas_familia_marca_submarca1_old"
boolean livescroll = true
...
string dataobject = "dw_int_traspaso_ventarifas_familia_marca_submarca2_old"
boolean livescroll = true
borderstyle borderstyle = stylelowered!
end type
