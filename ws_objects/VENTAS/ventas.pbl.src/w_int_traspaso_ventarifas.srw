$PBExportHeader$w_int_traspaso_ventarifas.srw
$PBExportComments$Transpaso de una tarifa a otra aplicanco un cambio.
forward
global type w_int_traspaso_ventarifas from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_traspaso_ventarifas
end type
type st_2 from statictext within w_int_traspaso_ventarifas
end type
type em_tarifa from u_em_campo within w_int_traspaso_ventarifas
end type
type st_nombre_tarifa from statictext within w_int_traspaso_ventarifas
end type
type dw_fechas from datawindow within w_int_traspaso_ventarifas
end type
type st_3 from statictext within w_int_traspaso_ventarifas
end type
type sle_moneda from singlelineedit within w_int_traspaso_ventarifas
end type
type gb_10 from groupbox within w_int_traspaso_ventarifas
end type
type em_tarifa_destino from u_em_campo within w_int_traspaso_ventarifas
end type
type dw_fechas_destino from datawindow within w_int_traspaso_ventarifas
end type
type st_5 from statictext within w_int_traspaso_ventarifas
end type
type sle_moneda_destino from singlelineedit within w_int_traspaso_ventarifas
end type
type st_4 from statictext within w_int_traspaso_ventarifas
end type
type rb_descendente from radiobutton within w_int_traspaso_ventarifas
end type
type rb_ascendente from radiobutton within w_int_traspaso_ventarifas
end type
type rb_lineal from radiobutton within w_int_traspaso_ventarifas
end type
type rb_porcentual from radiobutton within w_int_traspaso_ventarifas
end type
type st_texto from statictext within w_int_traspaso_ventarifas
end type
type em_cantidad from u_em_campo within w_int_traspaso_ventarifas
end type
type cb_procesar from u_boton within w_int_traspaso_ventarifas
end type
type rb_cambio from radiobutton within w_int_traspaso_ventarifas
end type
type pb_2 from upb_carpeta within w_int_traspaso_ventarifas
end type
type st_nombre_tarifa_destino from statictext within w_int_traspaso_ventarifas
end type
type rb_incremento from radiobutton within w_int_traspaso_ventarifas
end type
type em_cambio from u_em_campo within w_int_traspaso_ventarifas
end type
type st_1 from statictext within w_int_traspaso_ventarifas
end type
type uo_pavrev from u_marca_lista within w_int_traspaso_ventarifas
end type
type uo_familias from u_marca_lista within w_int_traspaso_ventarifas
end type
type uo_marcas from u_marca_lista within w_int_traspaso_ventarifas
end type
type uo_submarcas from u_marca_lista within w_int_traspaso_ventarifas
end type
type uo_formatos from u_marca_lista within w_int_traspaso_ventarifas
end type
type cb_formatos from commandbutton within w_int_traspaso_ventarifas
end type
type cb_submarcas from commandbutton within w_int_traspaso_ventarifas
end type
type cb_marcas from commandbutton within w_int_traspaso_ventarifas
end type
type cb_familias from commandbutton within w_int_traspaso_ventarifas
end type
type cb_pavrev from commandbutton within w_int_traspaso_ventarifas
end type
type cb_filtrar from u_boton within w_int_traspaso_ventarifas
end type
type dw_articulos_origen from datawindow within w_int_traspaso_ventarifas
end type
type dw_articulos_destino from datawindow within w_int_traspaso_ventarifas
end type
type rb_sobrescribir_en_destino from radiobutton within w_int_traspaso_ventarifas
end type
type rb_solo_no_existentes from radiobutton within w_int_traspaso_ventarifas
end type
type ddlb_que_traspasamos from dropdownlistbox within w_int_traspaso_ventarifas
end type
type cbx_promocion from checkbox within w_int_traspaso_ventarifas
end type
type cbx_no_promocion from checkbox within w_int_traspaso_ventarifas
end type
type gb_1 from groupbox within w_int_traspaso_ventarifas
end type
type gb_2 from groupbox within w_int_traspaso_ventarifas
end type
type gb_5 from groupbox within w_int_traspaso_ventarifas
end type
type gb_6 from groupbox within w_int_traspaso_ventarifas
end type
type gb_7 from groupbox within w_int_traspaso_ventarifas
end type
type gb_3 from groupbox within w_int_traspaso_ventarifas
end type
type gb_9 from groupbox within w_int_traspaso_ventarifas
end type
type gb_8 from groupbox within w_int_traspaso_ventarifas
end type
type gb_4 from groupbox within w_int_traspaso_ventarifas
end type
end forward
...
ddlb_que_traspasamos ddlb_que_traspasamos
cbx_promocion cbx_promocion
cbx_no_promocion cbx_no_promocion
gb_1 gb_1
gb_2 gb_2
gb_5 gb_5
gb_6 gb_6
...
global w_int_traspaso_ventarifas w_int_traspaso_ventarifas
...
on w_int_traspaso_ventarifas.create
int iCurrent
call super::create
...
this.ddlb_que_traspasamos=create ddlb_que_traspasamos
this.cbx_promocion=create cbx_promocion
this.cbx_no_promocion=create cbx_no_promocion
...
this.Control[iCurrent+37]=this.cb_filtrar
this.Control[iCurrent+38]=this.dw_articulos_origen
this.Control[iCurrent+39]=this.dw_articulos_destino
this.Control[iCurrent+40]=this.rb_sobrescribir_en_destino
this.Control[iCurrent+41]=this.rb_solo_no_existentes
this.Control[iCurrent+42]=this.ddlb_que_traspasamos
this.Control[iCurrent+43]=this.cbx_promocion
this.Control[iCurrent+44]=this.cbx_no_promocion
this.Control[iCurrent+45]=this.gb_1
this.Control[iCurrent+46]=this.gb_2
this.Control[iCurrent+47]=this.gb_5
this.Control[iCurrent+48]=this.gb_6
this.Control[iCurrent+49]=this.gb_7
this.Control[iCurrent+50]=this.gb_3
this.Control[iCurrent+51]=this.gb_9
this.Control[iCurrent+52]=this.gb_8
this.Control[iCurrent+53]=this.gb_4
end on

on w_int_traspaso_ventarifas.destroy
call super::destroy
...
destroy(this.ddlb_que_traspasamos)
destroy(this.cbx_promocion)
destroy(this.cbx_no_promocion)
destroy(this.gb_1)
destroy(this.gb_2)
destroy(this.gb_5)
destroy(this.gb_6)
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_traspaso_ventarifas
integer x = 1285
integer y = 24
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_traspaso_ventarifas
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_traspaso_ventarifas
integer x = 27
integer y = 8
integer width = 2427
end type
...
event modificado;call super::modificado;int    li_decimales_precio
...
li_decimales_precio       = f_ventarifas_decimales_precios(codigo_empresa,this.text)
ls_mascara_moneda_tarifa  = f_mascara_decimales(li_decimales_precio)

f_mascara_columna(dw_articulos_origen,"precio",ls_mascara_moneda_tarifa)
...
st_nombre_tarifa_destino.text=f_nombre_ventarifa(codigo_empresa,em_tarifa_destino.text)
...
f_mascara_columna(dw_articulos_destino,"precio",ls_mascara_moneda_tarifa)

dec ld_cambio

if rb_cambio.checked then
	ld_cambio = f_cambio_moneda(f_moneda_ventarifas(codigo_empresa,em_tarifa_destino.text))
	if ld_cambio <> 0 then
		em_cambio.text = string((1 / ld_cambio),em_cambio.mask) 
	else
		em_cambio.text = string(0,em_cambio.mask)
	end if
else
...
String   vendescripcion,venexcepcion,ventipo_linea,var_moneda,vensub_familia,ls_mascara_moneda_tarifa
Dec      venprecio,incremento,venprecio_euros
Integer bien,li_decimales_precio

integer li_existe_registro
long   ll_indice,ll_total
string ls_articulo,ls_sel,ls_calidad
...
li_decimales_precio       = f_ventarifas_decimales_precios(codigo_empresa,em_tarifa_destino.text)
ls_mascara_moneda_tarifa  = f_mascara_decimales(li_decimales_precio)
...
for ll_indice = 1 to ll_total
	...
	ls_articulo = dw_articulos_origen.object.articulos_codigo[ll_indice]
	ls_calidad  = dw_articulos_origen.object.calidades_codigo[ll_indice]
	
	//w_int_traspaso_ventarifas.enabled = FALSE
	if ddlb_que_traspasamos.text = "Traspasar Precios" then
		ls_sel = "select ventarifas_precios.articulos_codigo,"+&
					...
					"and    ventarifas_precios.calidades_codigo  = '"+ls_calidad+"' "
		...
		For registro = 1 To registros		
			...
			IF var_incremento = "C" Then
				lstr_ventarifas_precios.precio = lstr_ventarifas_precios.precio * Dec(em_cambio.text)
			ELSE
			...
			lstr_ventarifas_precios.precio = Dec(String(lstr_ventarifas_precios.precio,ls_mascara_moneda_tarifa)) 
	...
	if ddlb_que_traspasamos.text = "Traspasar Descuentos" then
		ls_sel = "select ventarifas_descuentos.articulos_codigo,"+&
					...
					"and    ventarifas_descuentos.calidades_codigo  = '"+ls_calidad+"' "
		...
		For registro = 1 To registros
			...
			lstr_ventarifas_descuentos.articulos_codigo  = ds_descuentos_articulos.object.articulos_codigo[registro]
			lstr_ventarifas_descuentos.calidades_codigo  = ds_descuentos_articulos.object.calidades_codigo[registro]
			
			lstr_ventarifas_descuentos.cantidad               = ds_descuentos_articulos.object.cantidad[registro]
			lstr_ventarifas_descuentos.tipo_cantidad          = ds_descuentos_articulos.object.tipo_cantidad[registro]
			lstr_ventarifas_descuentos.descuento              = ds_descuentos_articulos.object.descuento[registro]
			lstr_ventarifas_descuentos.fecha_inicio_descuento = ds_descuentos_articulos.object.fecha_inicio_descuento[registro]
			lstr_ventarifas_descuentos.fecha_fin_descuento    = ds_descuentos_articulos.object.fecha_fin_descuento[registro]
					
			//
			delete ventarifas_descuentos
...
string ls_tarifa,ls_pavrev[],ls_familias[],ls_marcas[],ls_submarcas[],ls_formatos[],ls_promocion[]
...
//Filtro promocion
if cbx_promocion.checked and cbx_no_promocion.checked then
	ls_promocion[1] = 'S'
	ls_promocion[2] = 'N'
else
	if cbx_promocion.checked then
		...
		if cbx_no_promocion.checked then
			ls_promocion[1] = 'N'
		else
			ls_promocion[1] = ''
		end if			
...
dw_articulos_origen.retrieve(codigo_empresa,ls_tarifa,ldt_fecha_tarifa,ls_pavrev,ls_familias,ls_marcas,ls_submarcas,ls_formatos,ls_promocion)
...
dw_articulos_destino.retrieve(codigo_empresa,ls_tarifa,ldt_fecha_tarifa,ls_pavrev,ls_familias,ls_marcas,ls_submarcas,ls_formatos,ls_promocion)
...
if rb_solo_no_existentes.checked and dw_articulos_destino.rowcount() > 0 and dw_articulos_origen.rowcount() > 0 then
	...
	for ll_indice = 1 to ll_total
		ls_articulo = dw_articulos_destino.object.articulos_codigo[ll_indice]
		ls_calidad = dw_articulos_destino.object.calidades_codigo[ll_indice]
		
		ls_busqueda = "articulos_codigo = '"+ls_articulo+"' and calidades_codigo = '"+ls_calidad+"'"
...
string facename = "Arial"
long textcolor = 33554432
string text = "Traspasar Precios"
string item[] = {"Traspasar Precios","Traspasar Descuentos"}
borderstyle borderstyle = stylelowered!
end type

event selectionchanged;
if this.text = 'Traspasar Precios' then
	dw_articulos_origen.dataobject  = "dw_int_traspaso_ventarifas_familia_marca_submarca1"
	dw_articulos_destino.dataobject = "dw_int_traspaso_ventarifas_familia_marca_submarca2"
	...
	rb_lineal.enabled = true
	rb_porcentual.enabled = true
	em_cantidad.enabled = true
	em_cambio.enabled = true
else
	dw_articulos_origen.dataobject  = "dw_int_traspaso_ventarifas_familia_marca_submarca3"
	dw_articulos_destino.dataobject = "dw_int_traspaso_ventarifas_familia_marca_submarca4"
	...
	rb_lineal.enabled = false
	rb_porcentual.enabled = false
