$PBExportHeader$wtc_mant_modelo_archivo_bd.srw
forward
global type wtc_mant_modelo_archivo_bd from wt_ventana_padre_grid
end type
type p_imagen from picture within wtc_mant_modelo_archivo_bd
end type
type pb_descargar_archivo from picturebutton within wtc_mant_modelo_archivo_bd
end type
end forward
...
global wtc_mant_modelo_archivo_bd wtc_mant_modelo_archivo_bd

type variables
string modelo
end variables

on wtc_mant_modelo_archivo_bd.create
int iCurrent
call super::create
...
on wtc_mant_modelo_archivo_bd.destroy
call super::destroy
...
type st_codigo from wt_ventana_padre_grid`st_codigo within wtc_mant_modelo_archivo_bd
...
type pb_duplicar1 from wt_ventana_padre_grid`pb_duplicar1 within wtc_mant_modelo_archivo_bd
boolean visible = false
integer x = 361
integer y = 976
end type

type pb_borrar1 from wt_ventana_padre_grid`pb_borrar1 within wtc_mant_modelo_archivo_bd
integer x = 183
integer y = 2656
end type
...
parametros.titulo = "Atención Borrado de Archivo del Modelo"
...
type pb_anyadir1 from wt_ventana_padre_grid`pb_anyadir1 within wtc_mant_modelo_archivo_bd
integer x = 32
integer y = 2656
integer weight = 700
end type
...
dw_1.object.modelo[fila] = modelo
...
GetFileOpenName ( "Añadir Archivo a Modelo", pathname, filename, "jpg")
...
IF fh <> -1 THEN
	...
	UPDATEBLOB modelo_archivo_expo
	SET imagen = :imagen        
	WHERE empresa = :codigo_empresa       
...
type pb_imprimir from wt_ventana_padre_grid`pb_imprimir within wtc_mant_modelo_archivo_bd
boolean visible = false
end type

type p_logo from wt_ventana_padre_grid`p_logo within wtc_mant_modelo_archivo_bd
integer x = 4064
integer y = 4
end type

type dw_1 from wt_ventana_padre_grid`dw_1 within wtc_mant_modelo_archivo_bd
integer y = 300
integer width = 553
integer height = 2500
...
type pb_salir from wt_ventana_padre_grid`pb_salir within wtc_mant_modelo_archivo_bd
integer x = 4434
integer y = 120
end type

type pb_grabar from wt_ventana_padre_grid`pb_grabar within wtc_mant_modelo_archivo_bd
boolean visible = false
end type

type st_titulo from wt_ventana_padre_grid`st_titulo within wtc_mant_modelo_archivo_bd
end type

type pb_cancelar from wt_ventana_padre_grid`pb_cancelar within wtc_mant_modelo_archivo_bd
boolean visible = false
end type
