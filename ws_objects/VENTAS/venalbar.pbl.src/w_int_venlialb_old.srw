$PBExportHeader$w_int_venlialb_old.srw
forward
global type w_int_venlialb_old from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_venlialb_old
end type
type st_3 from statictext within w_int_venlialb_old
end type
type st_texto_cantidad from statictext within w_int_venlialb_old
end type
type st_pallets from statictext within w_int_venlialb_old
end type
type st_total_cajas from statictext within w_int_venlialb_old
end type
type st_cajas from statictext within w_int_venlialb_old
end type
type st_tipopallet from statictext within w_int_venlialb_old
end type
type st_calidad from statictext within w_int_venlialb_old
end type
type st_articulo from statictext within w_int_venlialb_old
end type
type em_t_pallets from u_em_campo within w_int_venlialb_old
end type
type em_cajas from u_em_campo within w_int_venlialb_old
end type
type em_t_cajas from u_em_campo within w_int_venlialb_old
end type
type em_cantidad from u_em_campo within w_int_venlialb_old
end type
type uo_articulo from u_em_campo_2 within w_int_venlialb_old
end type
type uo_tipo_pallet from u_em_campo_2 within w_int_venlialb_old
end type
type st_texto_mtrslinieales from statictext within w_int_venlialb_old
end type
type em_mtrs_lineales from u_em_campo within w_int_venlialb_old
end type
type em_cliente from u_em_campo within w_int_venlialb_old
end type
type st_nombre_cliente from statictext within w_int_venlialb_old
end type
type st_texto_precio from statictext within w_int_venlialb_old
end type
type em_precio from u_em_campo within w_int_venlialb_old
end type
type em_descripcion from u_em_campo within w_int_venlialb_old
end type
type st_33 from statictext within w_int_venlialb_old
end type
type uo_tipolinea from u_em_campo_2 within w_int_venlialb_old
end type
type st_tplinea from statictext within w_int_venlialb_old
end type
type st_dto from statictext within w_int_venlialb_old
end type
type em_descuento from u_em_campo within w_int_venlialb_old
end type
type dw_pie from datawindow within w_int_venlialb_old
end type
type em_anyo from u_em_campo within w_int_venlialb_old
end type
type gb_6 from groupbox within w_int_venlialb_old
end type
type gb_3 from groupbox within w_int_venlialb_old
end type
type em_situacion from u_em_campo within w_int_venlialb_old
end type
type em_albaran from u_em_campo within w_int_venlialb_old
end type
type st_4 from statictext within w_int_venlialb_old
end type
type st_5 from statictext within w_int_venlialb_old
end type
type st_peso_linea from statictext within w_int_venlialb_old
end type
type gb_1 from groupbox within w_int_venlialb_old
end type
type st_2 from statictext within w_int_venlialb_old
end type
type em_porcentaje from u_em_campo within w_int_venlialb_old
end type
type st_proforma from dropdownlistbox within w_int_venlialb_old
end type
type st_6 from statictext within w_int_venlialb_old
end type
type st_peso_total from statictext within w_int_venlialb_old
end type
type st_7 from statictext within w_int_venlialb_old
end type
type st_tono from statictext within w_int_venlialb_old
end type
type em_tono from u_em_campo within w_int_venlialb_old
end type
type st_calibre from statictext within w_int_venlialb_old
end type
type em_calibre from u_em_campo within w_int_venlialb_old
end type
type gb_2 from groupbox within w_int_venlialb_old
end type
type cb_stock from u_boton within w_int_venlialb_old
end type
type cb_grabar from u_boton within w_int_venlialb_old
end type
type cb_borrar from u_boton within w_int_venlialb_old
end type
type cb_valorar from u_boton within w_int_venlialb_old
end type
type cb_reservas from u_boton within w_int_venlialb_old
end type
type cb_palmenos from u_boton within w_int_venlialb_old
end type
type cb_cajmenos from u_boton within w_int_venlialb_old
end type
type cb_insertar from u_boton within w_int_venlialb_old
end type
type st_caja from statictext within w_int_venlialb_old
end type
type uo_caja from u_em_campo_2 within w_int_venlialb_old
end type
type st_dto2 from statictext within w_int_venlialb_old
end type
type em_descuento2 from u_em_campo within w_int_venlialb_old
end type
type st_texto_npalet from statictext within w_int_venlialb_old
end type
type em_npal from u_em_campo within w_int_venlialb_old
end type
type p_1 from picture within w_int_venlialb_old
end type
type st_moneda from statictext within w_int_venlialb_old
end type
type st_idioma from statictext within w_int_venlialb_old
end type
type uo_idioma from u_em_campo_2 within w_int_venlialb_old
end type
type uo_calidad from u_em_campo_2 within w_int_venlialb_old
end type
type dw_detalle from datawindow within w_int_venlialb_old
end type
type cb_palmas from u_boton within w_int_venlialb_old
end type
type cb_cajmas from u_boton within w_int_venlialb_old
end type
type em_tono_imprimir from u_em_campo within w_int_venlialb_old
end type
type em_calibre_imprimir from u_em_campo within w_int_venlialb_old
end type
type st_1 from statictext within w_int_venlialb_old
end type
type st_8 from statictext within w_int_venlialb_old
end type
type em_precio_pzs from u_em_campo within w_int_venlialb_old
end type
type gb_4 from groupbox within w_int_venlialb_old
end type
type em_cantidad_en_pzs from u_em_campo within w_int_venlialb_old
end type
end forward
...
global w_int_venlialb_old w_int_venlialb_old
...
if ib_gestionar_en_piezas then
	...
	em_cantidad_en_pzs.TabOrder = 150
	...
	em_cantidad.TabOrder        = 150
	em_precio.TabOrder          = 160
	em_cantidad_en_pzs.TabOrder = 0
	em_precio_pzs.TabOrder      = 0	
end if	  
	  
IF( tipo= "M"  and  (var_situacion	 = "P" or var_situacion	 = "C")) or tipo_precio = 2 Then
...
var_sector  = f_sector_articulo(codigo_empresa,uo_articulo.em_codigo.text)
var_control_alm ="N"
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_venlialb_old
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_venlialb_old
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_venlialb_old
integer x = 9
integer y = 4
integer width = 2629
integer height = 112
