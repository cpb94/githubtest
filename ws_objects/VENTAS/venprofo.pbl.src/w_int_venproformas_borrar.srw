$PBExportHeader$w_int_venproformas_borrar.srw
forward
global type w_int_venproformas_borrar from wc_mantenimientos_tab
end type
...
type em_anyo from u_em_campo within w_int_venproformas_borrar
end type
type pb_calculadora from u_calculadora within w_int_venproformas_borrar
end type
type cb_copiar from u_boton within w_int_venproformas_borrar
end type
type cb_lineas from u_boton within w_int_venproformas_borrar
end type
type gb_1 from groupbox within w_int_venproformas_borrar
end type
type dw_proceso from datawindow within w_int_venproformas_borrar
end type
type dw_detalle from datawindow within w_int_venproformas_borrar
end type
type pb_imprimir from upb_imprimir within w_int_venproformas_borrar
end type
end forward
...
global w_int_venproformas_borrar w_int_venproformas_borrar
...
linproformas.proforma  = proforma
  ...
  SELECT venproformas.dtoesp1,     venproformas.dtoesp2,   
   ...
   WHERE (venproformas.empresa  = :codigo_empresa ) AND  
         (venproformas.anyo     = :periodo) AND  
         (venproformas.proforma = :proforma );
			
			
For reg = 1 To reg1 
 linproformas.linea              = Dec(f_valor_columna(dw_detalle,reg,"linea"))
 linproformas.cantidad           = Dec(f_valor_columna(dw_detalle,reg,"cantidad"))
 linproformas.precio             = Dec(f_valor_columna(dw_detalle,reg,"precio"))
 linproformas.precio_neto        = Dec(f_valor_columna(dw_detalle,reg,"precio"))
 linproformas.dtoesp             = Dec(f_valor_columna(dw_detalle,reg,"dtoesp"))
 linproformas.control_descuentos = f_valor_columna(dw_detalle,reg,"control_descuentos")
 linproformas.divisa             = f_valor_columna(dw_detalle,reg,"divisa")
...
linproformas.bruto = Dec(String(linproformas.cantidad * linproformas.precio_neto,f_mascara_moneda(linproformas.divisa)))
IF var_calculo_dtoesp = "N" Then
	importedtoesp      = Dec(String((linproformas.bruto * var_dtoesp /100),f_mascara_moneda(linproformas.divisa)))
	acumulado          = linproformas.bruto - importedtoesp
ELSE
	linproformas.precio_neto = linproformas.precio_neto - Dec(String(linproformas.precio_neto * var_dtoesp /100,f_mascara_moneda(linproformas.divisa)))
	linproformas.bruto = Dec(String(linproformas.cantidad * linproformas.precio_neto,f_mascara_moneda(linproformas.divisa)))
...
ELSE
 IF var_tipodto1  = "L" Then 
	IF var_calculo_dto = "N" Then
		importedto1 = Dec(String((acumulado * var_dto1 /100),f_mascara_moneda(linproformas.divisa)))
		acumulado = acumulado - importedto1
	ELSE
		linproformas.precio_neto = linproformas.precio_neto - Dec(String(linproformas.precio_neto * var_dto1 /100,f_mascara_moneda(linproformas.divisa)))
		linproformas.bruto = Dec(String(linproformas.cantidad * linproformas.precio_neto,f_mascara_moneda(linproformas.divisa)))
		IF var_calculo_dtoesp = "N" Then
			importedtoesp = Dec(String((linproformas.bruto * var_dtoesp /100),f_mascara_moneda(linproformas.divisa)))
		ELSE
 ...
 IF var_tipodto2  = "L" Then 
	IF var_calculo_dto = "N" Then
		importedto2 = Dec(String((acumulado * var_dto2 /100),f_mascara_moneda(linproformas.divisa)))
		acumulado = acumulado - importedto2
	ELSE
		linproformas.precio_neto = linproformas.precio_neto - Dec(String(linproformas.precio_neto * var_dto2 /100,f_mascara_moneda(linproformas.divisa)))
		linproformas.bruto = Dec(String(linproformas.cantidad * linproformas.precio_neto,f_mascara_moneda(linproformas.divisa)))
		IF var_calculo_dtoesp = "N" Then
			importedtoesp = Dec(String((linproformas.bruto * var_dtoesp /100),f_mascara_moneda(linproformas.divisa)))
		ELSE
 ...
 IF var_tipodto3  = "L" Then 	
	IF var_calculo_dto = "N" Then
	   importedto3 = Dec(String((acumulado * var_dto3 /100),f_mascara_moneda(linproformas.divisa)))
		acumulado = acumulado - importedto3
	ELSE
		linproformas.precio_neto = linproformas.precio_neto - Dec(String(linproformas.precio_neto * var_dto3 /100,f_mascara_moneda(linproformas.divisa)))
		linproformas.bruto = Dec(String(linproformas.cantidad * linproformas.precio_neto,f_mascara_moneda(linproformas.divisa)))
		IF var_calculo_dtoesp = "N" Then
			importedtoesp = Dec(String((linproformas.bruto * var_dtoesp /100),f_mascara_moneda(linproformas.divisa)))
		ELSE
...
IF var_tipodto4  = "L" Then 	
	IF var_calculo_dto = "N" Then
		importedto4  = Dec(String((acumulado * var_dto4 /100),f_mascara_moneda(linproformas.divisa)))
		acumulado = acumulado - importedto4
	ELSE
		linproformas.precio_neto = linproformas.precio_neto - Dec(String(linproformas.precio_neto * var_dto4 /100,f_mascara_moneda(linproformas.divisa)))
		linproformas.bruto = Dec(String(linproformas.cantidad * linproformas.precio_neto,f_mascara_moneda(linproformas.divisa)))
		IF var_calculo_dtoesp = "N" Then
			importedtoesp = Dec(String((linproformas.bruto * var_dtoesp /100),f_mascara_moneda(linproformas.divisa)))
		ELSE
...
END IF
 ...
 importedtopp  = Dec(String((acumulado * var_dtopp /100),f_mascara_moneda(linproformas.divisa))) 
...
linproformas.descuento     = (linproformas.importedto/linproformas.bruto)* 100
  ...
  UPDATE venliproformas  
     SET importe            = :linproformas.importe,   
         descuento          = :linproformas.descuento,   
         importedto         = :linproformas.importedto,   
         precio_neto        = :linproformas.precio_neto,   
         precio_aduana_neto = :linproformas.precio_aduana_neto,   
         descuento_aduana   = :linproformas.descuento_aduana,   
         importe_aduana     = :linproformas.importe_aduana,   
         bruto = :linproformas.bruto  
   WHERE ( venliproformas.empresa = :codigo_empresa ) AND  
         ( venliproformas.anyo = :periodo ) AND  
         ( venliproformas.proforma = :proforma ) AND
			( venliproformas.linea= :linproformas.linea)   ;
COMMIT;
NEXT
...
on w_int_venproformas_borrar.create
int iCurrent
call super::create
...
on w_int_venproformas_borrar.destroy
call super::destroy
...
type cb_salir from wc_mantenimientos_tab`cb_salir within w_int_venproformas_borrar
integer x = 2450
integer y = 160
integer width = 306
integer height = 76
...
type cb_borrar from wc_mantenimientos_tab`cb_borrar within w_int_venproformas_borrar
integer x = 2144
integer y = 160
integer width = 306
integer height = 76
...
type cb_insertar from wc_mantenimientos_tab`cb_insertar within w_int_venproformas_borrar
integer x = 1838
integer y = 160
integer width = 306
integer height = 76
...
type wc_control_tabulador from wc_mantenimientos_tab`wc_control_tabulador within w_int_venproformas_borrar
end type

type st_empresa from wc_mantenimientos_tab`st_empresa within w_int_venproformas_borrar
integer height = 92
end type
...
type sle_valor from wc_mantenimientos_tab`sle_valor within w_int_venproformas_borrar
integer x = 571
integer y = 172
integer width = 302
integer taborder = 30
...
type st_1 from wc_mantenimientos_tab`st_1 within w_int_venproformas_borrar
integer x = 37
integer y = 176
integer width = 302
...
type apartados from wc_mantenimientos_tab`apartados within w_int_venproformas_borrar
integer x = 46
integer y = 272
integer width = 2811
integer height = 1268
...
IF NOT f_bloquear(tabla[1],seleccion[1],titulo) THEN
 ...
 lstr_param.s_argumentos[3]=sle_valor.text
 f_activar_campo(sle_valor)
 OpenWithParm(w_int_venliproformas,lstr_param,Parent)
 Return
END IF
 f_activar_campo(sle_valor)
end event
