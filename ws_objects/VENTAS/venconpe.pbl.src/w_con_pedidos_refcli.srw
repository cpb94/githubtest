$PBExportHeader$w_con_pedidos_refcli.srw
forward
global type w_con_pedidos_refcli from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_pedidos_refcli
end type
type pb_2 from upb_imprimir within w_con_pedidos_refcli
end type
type st_2 from statictext within w_con_pedidos_refcli
end type
type em_refcli from u_em_campo within w_con_pedidos_refcli
end type
type dw_detalle from datawindow within w_con_pedidos_refcli
end type
type dw_listado from datawindow within w_con_pedidos_refcli
end type
type uo_manejo from u_manejo_datawindow within w_con_pedidos_refcli
end type
end forward
...
global w_con_pedidos_refcli w_con_pedidos_refcli
...
on w_con_pedidos_refcli.create
int iCurrent
call super::create
...
on w_con_pedidos_refcli.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_pedidos_refcli
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_pedidos_refcli
...
type st_empresa from w_int_con_empresa`st_empresa within w_con_pedidos_refcli
integer x = 14
integer y = 8
integer width = 2427
integer height = 88
...
integer width = 2821
integer height = 1184
string dataobject = "dw_con_pedidos_refcli"
