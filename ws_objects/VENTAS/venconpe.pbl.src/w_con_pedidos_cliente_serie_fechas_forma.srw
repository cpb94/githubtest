$PBExportHeader$w_con_pedidos_cliente_serie_fechas_forma.srw
$PBExportComments$Pedidos pendientes por formato
forward
global type w_con_pedidos_cliente_serie_fechas_forma from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_pedidos_cliente_serie_fechas_forma
end type
type pb_2 from upb_imprimir within w_con_pedidos_cliente_serie_fechas_forma
end type
type dw_detalle from datawindow within w_con_pedidos_cliente_serie_fechas_forma
end type
type dw_listado from datawindow within w_con_pedidos_cliente_serie_fechas_forma
end type
type em_fechadesde from u_em_campo within w_con_pedidos_cliente_serie_fechas_forma
end type
type em_fechahasta from u_em_campo within w_con_pedidos_cliente_serie_fechas_forma
end type
type cb_1 from commandbutton within w_con_pedidos_cliente_serie_fechas_forma
end type
type gb_5 from groupbox within w_con_pedidos_cliente_serie_fechas_forma
end type
type gb_4 from groupbox within w_con_pedidos_cliente_serie_fechas_forma
end type
type gb_1 from groupbox within w_con_pedidos_cliente_serie_fechas_forma
end type
type uo_cliente from u_em_campo_2 within w_con_pedidos_cliente_serie_fechas_forma
end type
type gb_3 from groupbox within w_con_pedidos_cliente_serie_fechas_forma
end type
type st_1 from statictext within w_con_pedidos_cliente_serie_fechas_forma
end type
type uo_series from u_marca_lista within w_con_pedidos_cliente_serie_fechas_forma
end type
type cb_2 from commandbutton within w_con_pedidos_cliente_serie_fechas_forma
end type
type rb_detalle from radiobutton within w_con_pedidos_cliente_serie_fechas_forma
end type
type rb_resumen from radiobutton within w_con_pedidos_cliente_serie_fechas_forma
end type
type cbx_valorado from checkbox within w_con_pedidos_cliente_serie_fechas_forma
end type
type cbx_muestras from checkbox within w_con_pedidos_cliente_serie_fechas_forma
end type
type gb_6 from groupbox within w_con_pedidos_cliente_serie_fechas_forma
end type
end forward
...
global w_con_pedidos_cliente_serie_fechas_forma w_con_pedidos_cliente_serie_fechas_forma
...
event open;call super::open;istr_parametros.s_titulo_ventana="Listado de Pedidos Pendientes por Formato"
...
on w_con_pedidos_cliente_serie_fechas_forma.create
int iCurrent
call super::create
...
this.Control[iCurrent+16]=this.rb_detalle
this.Control[iCurrent+17]=this.rb_resumen
this.Control[iCurrent+18]=this.cbx_valorado
this.Control[iCurrent+19]=this.cbx_muestras
this.Control[iCurrent+20]=this.gb_6
end on

on w_con_pedidos_cliente_serie_fechas_forma.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_pedidos_cliente_serie_fechas_forma
integer y = 612
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_pedidos_cliente_serie_fechas_forma
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_pedidos_cliente_serie_fechas_forma
integer x = 9
integer y = 8
integer width = 2427
integer height = 112
...
integer width = 3374
integer height = 1484
string dataobject = "dw_con_pedidos_cliente_serie_fechas_form"
...
string dataobject = "report_con_ped_cliente_serie_fechas_form"
