$PBExportHeader$w_con_pedidos_direnvio.srw
forward
global type w_con_pedidos_direnvio from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_pedidos_direnvio
end type
type pb_2 from upb_imprimir within w_con_pedidos_direnvio
end type
type dw_detalle from datawindow within w_con_pedidos_direnvio
end type
type dw_listado from datawindow within w_con_pedidos_direnvio
end type
type uo_manejo from u_manejo_datawindow within w_con_pedidos_direnvio
end type
type em_pallets from u_em_campo within w_con_pedidos_direnvio
end type
type em_cajas from u_em_campo within w_con_pedidos_direnvio
end type
type em_metros from u_em_campo within w_con_pedidos_direnvio
end type
type em_unidades from u_em_campo within w_con_pedidos_direnvio
end type
type ss from statictext within w_con_pedidos_direnvio
end type
type st-10 from statictext within w_con_pedidos_direnvio
end type
type st-11 from statictext within w_con_pedidos_direnvio
end type
type st-12 from statictext within w_con_pedidos_direnvio
end type
type st-13 from statictext within w_con_pedidos_direnvio
end type
type em_kilos from u_em_campo within w_con_pedidos_direnvio
end type
type em_totalkilos from u_em_campo within w_con_pedidos_direnvio
end type
type st-15 from statictext within w_con_pedidos_direnvio
end type
type st-16 from statictext within w_con_pedidos_direnvio
end type
type st-17 from statictext within w_con_pedidos_direnvio
end type
type st-18 from statictext within w_con_pedidos_direnvio
end type
type st-19 from statictext within w_con_pedidos_direnvio
end type
type em_totalbruto from u_em_campo within w_con_pedidos_direnvio
end type
type em_totaldto from u_em_campo within w_con_pedidos_direnvio
end type
type em_totalbase from u_em_campo within w_con_pedidos_direnvio
end type
type em_totaliva from u_em_campo within w_con_pedidos_direnvio
end type
type em_totalgeneral from u_em_campo within w_con_pedidos_direnvio
end type
type em_totalgeneral_bruto from u_em_campo within w_con_pedidos_direnvio
end type
type st_1 from statictext within w_con_pedidos_direnvio
end type
type em_totalgeneral_dto from u_em_campo within w_con_pedidos_direnvio
end type
type em_totalgeneral_base from u_em_campo within w_con_pedidos_direnvio
end type
type em_totalgeneral_iva from u_em_campo within w_con_pedidos_direnvio
end type
type em_totalgeneral_neto from u_em_campo within w_con_pedidos_direnvio
end type
type st_3 from statictext within w_con_pedidos_direnvio
end type
type em_unidades_general from u_em_campo within w_con_pedidos_direnvio
end type
type em_metros_general from u_em_campo within w_con_pedidos_direnvio
end type
type em_cajas_general from u_em_campo within w_con_pedidos_direnvio
end type
type em_pallets_general from u_em_campo within w_con_pedidos_direnvio
end type
type uo_cliente from u_em_campo_2 within w_con_pedidos_direnvio
end type
type st_4 from statictext within w_con_pedidos_direnvio
end type
type uo_envio from u_em_campo_2 within w_con_pedidos_direnvio
end type
type st_5 from statictext within w_con_pedidos_direnvio
end type
type cb_1 from commandbutton within w_con_pedidos_direnvio
end type
end forward
...
global w_con_pedidos_direnvio w_con_pedidos_direnvio
...
public subroutine f_control ();string filtr=""
dw_detalle.Reset()
dw_detalle.SetFilter(filtr)

if trim(uo_envio.em_codigo.text)<> "" then
   filtr = " envio ='"+uo_envio.em_codigo.text+"'"
	dw_detalle.SetFilter(filtr)
End if
...
event open;call super::open;istr_parametros.s_titulo_ventana="Consulta lineas de pedido por Dirección de envio"
...
IF TRIM(filtr)<>"" THEN
 dw_report.SetFilter(filtr)
 dw_report.Filter()
END IF
CALL Super::ue_listar
end event

on w_con_pedidos_direnvio.create
int iCurrent
call super::create
...
this.Control[iCurrent+6]=this.em_pallets
this.Control[iCurrent+7]=this.em_cajas
this.Control[iCurrent+8]=this.em_metros
this.Control[iCurrent+9]=this.em_unidades
this.Control[iCurrent+10]=this.ss
this.Control[iCurrent+11]=this.st-10
this.Control[iCurrent+12]=this.st-11
this.Control[iCurrent+13]=this.st-12
this.Control[iCurrent+14]=this.st-13
this.Control[iCurrent+15]=this.em_kilos
this.Control[iCurrent+16]=this.em_totalkilos
this.Control[iCurrent+17]=this.st-15
this.Control[iCurrent+18]=this.st-16
this.Control[iCurrent+19]=this.st-17
this.Control[iCurrent+20]=this.st-18
this.Control[iCurrent+21]=this.st-19
this.Control[iCurrent+22]=this.em_totalbruto
this.Control[iCurrent+23]=this.em_totaldto
this.Control[iCurrent+24]=this.em_totalbase
this.Control[iCurrent+25]=this.em_totaliva
this.Control[iCurrent+26]=this.em_totalgeneral
this.Control[iCurrent+27]=this.em_totalgeneral_bruto
this.Control[iCurrent+28]=this.st_1
this.Control[iCurrent+29]=this.em_totalgeneral_dto
this.Control[iCurrent+30]=this.em_totalgeneral_base
this.Control[iCurrent+31]=this.em_totalgeneral_iva
this.Control[iCurrent+32]=this.em_totalgeneral_neto
this.Control[iCurrent+33]=this.st_3
this.Control[iCurrent+34]=this.em_unidades_general
this.Control[iCurrent+35]=this.em_metros_general
this.Control[iCurrent+36]=this.em_cajas_general
this.Control[iCurrent+37]=this.em_pallets_general
this.Control[iCurrent+38]=this.uo_cliente
this.Control[iCurrent+39]=this.st_4
this.Control[iCurrent+40]=this.uo_envio
this.Control[iCurrent+41]=this.st_5
this.Control[iCurrent+42]=this.cb_1
end on

on w_con_pedidos_direnvio.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_pedidos_direnvio
integer taborder = 50
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_pedidos_direnvio
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_pedidos_direnvio
integer x = 9
integer width = 2427
integer height = 96
end type
...
integer width = 2853
integer height = 940
string dataobject = "dw_con_pedidos_direnvio"
...
string dataobject = "report_con_pedidos_direnvio"
boolean livescroll = true
end type
...
long backcolor = 12632256
boolean enabled = false
string text = "D i r e c.   E n v i o"
alignment alignment = center!
boolean focusrectangle = false
end type
