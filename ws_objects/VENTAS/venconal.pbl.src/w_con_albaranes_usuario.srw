$PBExportHeader$w_con_albaranes_usuario.srw
forward
global type w_con_albaranes_usuario from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_albaranes_usuario
end type
type pb_2 from upb_imprimir within w_con_albaranes_usuario
end type
type st_2 from statictext within w_con_albaranes_usuario
end type
type em_refcli from u_em_campo within w_con_albaranes_usuario
end type
type dw_detalle from datawindow within w_con_albaranes_usuario
end type
type dw_listado from datawindow within w_con_albaranes_usuario
end type
type uo_manejo from u_manejo_datawindow within w_con_albaranes_usuario
end type
type st_9 from statictext within w_con_albaranes_usuario
end type
type em_fechadesde from u_em_campo within w_con_albaranes_usuario
end type
type st_8 from statictext within w_con_albaranes_usuario
end type
type em_fechahasta from u_em_campo within w_con_albaranes_usuario
end type
type gb_1 from groupbox within w_con_albaranes_usuario
end type
type cb_1 from commandbutton within w_con_albaranes_usuario
end type
end forward
...
global w_con_albaranes_usuario w_con_albaranes_usuario
...
event open;call super::open;istr_parametros.s_titulo_ventana="Consulta lineas de albarán por Usuario"
...
on w_con_albaranes_usuario.create
int iCurrent
call super::create
...
on w_con_albaranes_usuario.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_albaranes_usuario
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_albaranes_usuario
end type

event sle_opcion_orden::getfocus;call super::getfocus;f_activar_campo(em_refcli)
end event

type st_empresa from w_int_con_empresa`st_empresa within w_con_albaranes_usuario
integer x = 14
integer y = 8
integer width = 2427
integer height = 88
...
integer width = 2834
integer height = 1656
string dataobject = "dw_con_albaranes_usuario"
...
boolean bringtotop = true
string dataobject = "report_con_albaranes_usuario"
