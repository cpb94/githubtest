$PBExportHeader$w_con_albaranes_transpor.srw
forward
global type w_con_albaranes_transpor from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_albaranes_transpor
end type
type pb_2 from upb_imprimir within w_con_albaranes_transpor
end type
type st_2 from statictext within w_con_albaranes_transpor
end type
type dw_detalle from datawindow within w_con_albaranes_transpor
end type
type dw_listado from datawindow within w_con_albaranes_transpor
end type
type uo_manejo from u_manejo_datawindow within w_con_albaranes_transpor
end type
type uo_transpor from u_em_campo_2 within w_con_albaranes_transpor
end type
type em_desde from u_em_campo within w_con_albaranes_transpor
end type
type em_hasta from u_em_campo within w_con_albaranes_transpor
end type
type st_3 from statictext within w_con_albaranes_transpor
end type
type st_4 from statictext within w_con_albaranes_transpor
end type
type gb_1 from groupbox within w_con_albaranes_transpor
end type
type cb_1 from commandbutton within w_con_albaranes_transpor
end type
end forward
...
global w_con_albaranes_transpor w_con_albaranes_transpor
...
dw_detalle.Retrieve(codigo_empresa,uo_transpor.em_codigo.text,fecha1,fecha2)
...
event open;call super::open;istr_parametros.s_titulo_ventana="Consulta lineas de albarán por transportista"
...
dw_report.retrieve(codigo_empresa,uo_transpor.em_codigo.text,fecha1,fecha2)
IF TRIM(filtro)<>"" THEN
...
on w_con_albaranes_transpor.create
int iCurrent
call super::create
...
on w_con_albaranes_transpor.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_albaranes_transpor
integer taborder = 30
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_albaranes_transpor
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_albaranes_transpor
integer x = 9
integer width = 2427
end type
...
integer width = 2830
integer height = 1644
string dataobject = "dw_con_albaranes_transpor"
...
integer taborder = 50
boolean bringtotop = true
string dataobject = "report_con_albaranes_transpor"
boolean livescroll = true
end type
