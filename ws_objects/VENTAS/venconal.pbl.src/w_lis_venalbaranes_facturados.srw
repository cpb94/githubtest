$PBExportHeader$w_lis_venalbaranes_facturados.srw
forward
global type w_lis_venalbaranes_facturados from w_int_con_empresa
end type
type pb_1 from upb_salir within w_lis_venalbaranes_facturados
end type
type st_2 from statictext within w_lis_venalbaranes_facturados
end type
type em_anyo from u_em_campo within w_lis_venalbaranes_facturados
end type
type em_albaran from u_em_campo within w_lis_venalbaranes_facturados
end type
type st_3 from statictext within w_lis_venalbaranes_facturados
end type
type st_6 from statictext within w_lis_venalbaranes_facturados
end type
type em_copias1 from editmask within w_lis_venalbaranes_facturados
end type
type cb_2 from u_boton within w_lis_venalbaranes_facturados
end type
type cb_1 from u_boton within w_lis_venalbaranes_facturados
end type
type pb_imprimir_preli from picturebutton within w_lis_venalbaranes_facturados
end type
type st_13 from statictext within w_lis_venalbaranes_facturados
end type
type cabecera from dropdownlistbox within w_lis_venalbaranes_facturados
end type
type uo_manejo from u_manejo_datawindow within w_lis_venalbaranes_facturados
end type
type st_7 from statictext within w_lis_venalbaranes_facturados
end type
type st_cliente from statictext within w_lis_venalbaranes_facturados
end type
type st_codcli from statictext within w_lis_venalbaranes_facturados
end type
type st_pagina from statictext within w_lis_venalbaranes_facturados
end type
type gb_3 from groupbox within w_lis_venalbaranes_facturados
end type
type st_14 from statictext within w_lis_venalbaranes_facturados
end type
type valorado from dropdownlistbox within w_lis_venalbaranes_facturados
end type
type aduana from dropdownlistbox within w_lis_venalbaranes_facturados
end type
type st_22 from statictext within w_lis_venalbaranes_facturados
end type
type cbx_matric from checkbox within w_lis_venalbaranes_facturados
end type
type dw_preliminar from datawindow within w_lis_venalbaranes_facturados
end type
type uo_1 from u_selec_impresoras within w_lis_venalbaranes_facturados
end type
type cb_3 from u_boton within w_lis_venalbaranes_facturados
end type
type gb_2 from groupbox within w_lis_venalbaranes_facturados
end type
type gb_1 from groupbox within w_lis_venalbaranes_facturados
end type
end forward
...
global w_lis_venalbaranes_facturados w_lis_venalbaranes_facturados
...
SELECT venlifac.falbaran,
		 venlifac.cliente,
		 venlifac.serie,
		 venlifac.envio,
		 venlifac.deposito,
		 isnull(sum(venlifac.peso),0)
INTO   :var_falbaran,
		 :var_cliente, 
		 :var_serie,
		 :var_envio,
...
And    venlifac.anyo_albaran = :var_anyo
And    venlifac.albaran      = :var_albaran
group by venfac.textcomercial1,
		 venfac.textaduanaesp1,
		 venfac.textaduanaext1 ;
...
select  tarifa
into    :ls_tarifa
from	(select distinct factura from venlifac where anyo = :var_anyo and albaran = :var_albaran) as lin
		inner join (select tarifa, factura from venfac where anyo = :var_anyo) as fac
			on lin.factura = fac.factura;
...
Sel = " SELECT venlifac.tipolinea, " +&
		"        venlifac.clase, " +&
		"        venlifac.dtoesp, " +&
		"        sum(venlifac.cantidad) as cantidad, " +&
		"        min(venlifac.linea) as linea, " +&
		"        venlifac.tonochar, " +&
		"        venlifac.calibre, " +&
		...
		"        venlifac.caja, " +&
		"        min(isnull(venlifac.bulto_desde_orden_carga,venlifac.numpalet)) as numpalet, " +&
		"        venlifac.numpedcli, " +&
		"        sum(venlifac.peso_neto) as peso_neto, " +&
		"        sum(venlifac.peso) as peso_bruto, " +&
		"        venlifac.precio_neto, " +&
		"        sum(venlifac.importe) as importe, " +&
		"        sum(venlifac.impdtopp) as impdtopp, " +&
		"        sum(venlifac.impdtoesp1) as impdtoesp1, " +&
		"        sum(venlifac.impdtoesp2) as impdtoesp2, " +&
		"        sum(venlifac.impdtoesp3) as impdtoesp3, " +&
		"        sum(venlifac.impdtoesp4) as impdtoesp4, " +&
		"        venlifac.articulo, " +&
		"        venlifac.caja, " +&
		"        sum(venlifac.pallets) as pallets, " +&
		"        sum(venlifac.total_cajas) as total_cajas, " +&
		"        venlifac.descripcion, " +&
		"        venlifac.tipo_pallet, " +&
		"        min(venlifac.descuento) as descuento, " +&
		"        venlifac.dtoesp, " +&
		"        venlifac.dtoesp2, " +&
		"        venlifac.formato, " +&
		"        venlifac.familia, " +&
	   ...
	   " AND    venlifac.control_descuentos = 'S'   "+&
		...
		"        venlifac.cantidad_pzs, "+&
		"        venlifac.precio_pzs "+&
  	   " ORDER BY min(venlifac.numpalet) ASC"				
...
Sel = " SELECT venlifac.tipolinea, " +&
		...
		"        venlifac.tipo_pallet, " +&
		"        venlifac.caja, " +&
		"        min(venlifac.numpalet) as numpalet, " +&
		"        venlifac.numpedcli, " +&
		"        sum(venlifac.peso_neto) as peso_neto, " +&
		"        sum(venlifac.peso) as peso_bruto, " +&
		"        venlifac.precio, " +&
...
on w_lis_venalbaranes_facturados.create
int iCurrent
call super::create
...
on w_lis_venalbaranes_facturados.destroy
call super::destroy
destroy(this.pb_1)
destroy(this.st_2)
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_lis_venalbaranes_facturados
integer x = 978
integer y = 2508
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_lis_venalbaranes_facturados
integer taborder = 20
end type
...
type st_empresa from w_int_con_empresa`st_empresa within w_lis_venalbaranes_facturados
integer x = 14
integer y = 4
integer width = 3790
integer height = 80
...
IF valorado.text = "Si" Then
	...
	lineas=22
Else
	dw_preliminar.DataObject = "report_list_venalbaranes1_sinval_matric_facturado"
	dw_preliminar.Settransobject(SQLCA)
	lineas=23
...
integer width = 3831
integer height = 2788
string dataobject = "report_list_venalbaranes1_facturado"
...
var_tipo = 1
string v_cliente, v_valorar_alb, albaran, anyo, v_serie
string ls_file, ls_path, ls_folderfile, tipo
long v_albaran
