$PBExportHeader$w_con_albaranes_refcli.srw
forward
global type w_con_albaranes_refcli from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_albaranes_refcli
end type
type pb_2 from upb_imprimir within w_con_albaranes_refcli
end type
type st_2 from statictext within w_con_albaranes_refcli
end type
type em_refcli from u_em_campo within w_con_albaranes_refcli
end type
type dw_detalle from datawindow within w_con_albaranes_refcli
end type
type dw_listado from datawindow within w_con_albaranes_refcli
end type
type uo_manejo from u_manejo_datawindow within w_con_albaranes_refcli
end type
end forward
...
global w_con_albaranes_refcli w_con_albaranes_refcli
...
event open;call super::open;istr_parametros.s_titulo_ventana="Consulta lineas de albarán por Referencia"
...
on w_con_albaranes_refcli.create
int iCurrent
call super::create
...
on w_con_albaranes_refcli.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_albaranes_refcli
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_albaranes_refcli
...
type st_empresa from w_int_con_empresa`st_empresa within w_con_albaranes_refcli
integer x = 14
integer y = 8
integer width = 2427
integer height = 96
...
integer width = 2821
integer height = 1664
string dataobject = "dw_con_albaranes_refcli"
...
boolean bringtotop = true
string dataobject = "report_con_albaranes_refcli"
