$PBExportHeader$w_con_resumen_vtas_meses_cli_form.srw
forward
global type w_con_resumen_vtas_meses_cli_form from w_int_con_empresa
end type
type gb_7 from groupbox within w_con_resumen_vtas_meses_cli_form
end type
type gb_5 from groupbox within w_con_resumen_vtas_meses_cli_form
end type
type gb_3 from groupbox within w_con_resumen_vtas_meses_cli_form
end type
type gb_2 from groupbox within w_con_resumen_vtas_meses_cli_form
end type
type gb_1 from groupbox within w_con_resumen_vtas_meses_cli_form
end type
type em_anyo from u_em_campo within w_con_resumen_vtas_meses_cli_form
end type
type uo_mes1 from u_em_campo_2 within w_con_resumen_vtas_meses_cli_form
end type
type uo_mes2 from u_em_campo_2 within w_con_resumen_vtas_meses_cli_form
end type
type lbx_comparacion from dropdownlistbox within w_con_resumen_vtas_meses_cli_form
end type
type em_cantidad from u_em_campo within w_con_resumen_vtas_meses_cli_form
end type
type uo_serie from u_em_campo_2 within w_con_resumen_vtas_meses_cli_form
end type
type gb_4 from groupbox within w_con_resumen_vtas_meses_cli_form
end type
type uo_cliente from u_em_campo_2 within w_con_resumen_vtas_meses_cli_form
end type
type rb_um from radiobutton within w_con_resumen_vtas_meses_cli_form
end type
type rb_piezas from radiobutton within w_con_resumen_vtas_meses_cli_form
end type
type rb_m2 from radiobutton within w_con_resumen_vtas_meses_cli_form
end type
type rb_ml from radiobutton within w_con_resumen_vtas_meses_cli_form
end type
type pb_1 from upb_salir within w_con_resumen_vtas_meses_cli_form
end type
type pb_2 from upb_imprimir within w_con_resumen_vtas_meses_cli_form
end type
type cb_1 from u_boton within w_con_resumen_vtas_meses_cli_form
end type
type dw_detalle_cliente from u_datawindow_consultas within w_con_resumen_vtas_meses_cli_form
end type
type dw_listado_clientes from u_datawindow within w_con_resumen_vtas_meses_cli_form
end type
type gb_6 from groupbox within w_con_resumen_vtas_meses_cli_form
end type
type uo_formato from u_em_campo_2 within w_con_resumen_vtas_meses_cli_form
end type
type cbx_otra from checkbox within w_con_resumen_vtas_meses_cli_form
end type
type cb_2 from commandbutton within w_con_resumen_vtas_meses_cli_form
end type
type cbx_conjunta from checkbox within w_con_resumen_vtas_meses_cli_form
end type
type dw_cursor_venlifac from datawindow within w_con_resumen_vtas_meses_cli_form
end type
type dw_cursor_venlifac_mes from datawindow within w_con_resumen_vtas_meses_cli_form
end type
end forward
...
global w_con_resumen_vtas_meses_cli_form w_con_resumen_vtas_meses_cli_form
...
on w_con_resumen_vtas_meses_cli_form.create
int iCurrent
call super::create
...
on w_con_resumen_vtas_meses_cli_form.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_resumen_vtas_meses_cli_form
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_resumen_vtas_meses_cli_form
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_resumen_vtas_meses_cli_form
end type
