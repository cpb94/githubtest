$PBExportHeader$w_con_ventas_familia_marca_submarca.srw
forward
global type w_con_ventas_familia_marca_submarca from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_ventas_familia_marca_submarca
end type
type pb_2 from upb_imprimir within w_con_ventas_familia_marca_submarca
end type
type em_fechadesde from u_em_campo within w_con_ventas_familia_marca_submarca
end type
type em_fechahasta from u_em_campo within w_con_ventas_familia_marca_submarca
end type
type gb_5 from groupbox within w_con_ventas_familia_marca_submarca
end type
type uo_cliente from u_em_campo_2 within w_con_ventas_familia_marca_submarca
end type
type cb_familias from commandbutton within w_con_ventas_familia_marca_submarca
end type
type cb_formatos from commandbutton within w_con_ventas_familia_marca_submarca
end type
type uo_familias from u_marca_lista within w_con_ventas_familia_marca_submarca
end type
type uo_formatos from u_marca_lista within w_con_ventas_familia_marca_submarca
end type
type gb_2 from groupbox within w_con_ventas_familia_marca_submarca
end type
type gb_1 from groupbox within w_con_ventas_familia_marca_submarca
end type
type cb_1 from u_boton within w_con_ventas_familia_marca_submarca
end type
type cb_paises from commandbutton within w_con_ventas_familia_marca_submarca
end type
type cb_2 from commandbutton within w_con_ventas_familia_marca_submarca
end type
type cb_pavrev from commandbutton within w_con_ventas_familia_marca_submarca
end type
type cb_marcas from commandbutton within w_con_ventas_familia_marca_submarca
end type
type cb_submarcas from commandbutton within w_con_ventas_familia_marca_submarca
end type
type uo_marcas from u_marca_lista within w_con_ventas_familia_marca_submarca
end type
type uo_submarcas from u_marca_lista within w_con_ventas_familia_marca_submarca
end type
type gb_3 from groupbox within w_con_ventas_familia_marca_submarca
end type
type dw_detalle from u_datawindow_consultas within w_con_ventas_familia_marca_submarca
end type
type uo_pavrev from u_marca_lista within w_con_ventas_familia_marca_submarca
end type
type uo_agentes from u_marca_lista within w_con_ventas_familia_marca_submarca
end type
type uo_paises from u_marca_lista within w_con_ventas_familia_marca_submarca
end type
type rb_pais from radiobutton within w_con_ventas_familia_marca_submarca
end type
type rb_agente from radiobutton within w_con_ventas_familia_marca_submarca
end type
type rb_cliente from radiobutton within w_con_ventas_familia_marca_submarca
end type
type ddlb_promocion from dropdownlistbox within w_con_ventas_familia_marca_submarca
end type
type pb_excel from picturebutton within w_con_ventas_familia_marca_submarca
end type
type cb_excel from u_boton within w_con_ventas_familia_marca_submarca
end type
type gb_4 from groupbox within w_con_ventas_familia_marca_submarca
end type
type gb_6 from groupbox within w_con_ventas_familia_marca_submarca
end type
type gb_7 from groupbox within w_con_ventas_familia_marca_submarca
end type
end forward
...
global w_con_ventas_familia_marca_submarca w_con_ventas_familia_marca_submarca

type variables
string grafico = "N",is_sort_inicial,is_texto_t_descripcion,is_texto_t_pzs,is_texto_t_m2,is_texto_t_importe
int ii_grupo_desplegado,ii_max_grupos = 4
end variables

forward prototypes
public subroutine f_control_m2 (datawindow arg_datawindow)
public subroutine f_control_excel (datawindow arg_datawindow)
public subroutine f_control_m2_old (datawindow arg_datawindow)
public subroutine f_control_excel_old (datawindow arg_datawindow)
end prototypes
...
public subroutine f_control_excel (datawindow arg_datawindow);string ls_codigo,ls_filtro,ls_filtro_paises,ls_filtro_agentes,ls_filtro_pavrev,ls_filtro_familias,ls_filtro_formatos,ls_filtro_marcas,ls_filtro_submarcas,ls_filtro_cliente
string ls_sel,ls_campos_select,ls_campos_group_by,ls_filtro_articulos,ls_sort_actual,ls_texto_seleccion,ls_texto_filtro
integer li_indice,li_opciones,li_opciones_marcadas
long    ll_total
datetime ldt_fecha_desde,ldt_fecha_hasta
...
"		  sum(case when venlifac.tipo_unidad <> '1' then case when venfac.ffactura between '"+string(ldt_fecha_desde,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta,gs_formato_fecha_cursores)+"' then isnull(venlifac.cantidad,0) else 0 end else 0 end) as pzs, ~n"+&
"		  sum(case when venlifac.tipo_unidad  = '1' then case when venfac.ffactura between '"+string(ldt_fecha_desde,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta,gs_formato_fecha_cursores)+"' then isnull(venlifac.cantidad,0) else 0 end else 0 end) as m2, ~n"+&
"		  convert(dec(16,2),sum(case when venfac.ffactura between '"+string(ldt_fecha_desde,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta,gs_formato_fecha_cursores)+"' then (venlifac.neto) / venfac.cambio else 0 end )) as importe, ~n"+&
"		  sum(case when venlifac.tipo_unidad  <> '1' then case when venfac.ffactura between '"+string(ldt_fecha_desde,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta,gs_formato_fecha_cursores)+"' then ((venlifac.neto) / venfac.cambio) else 0 end else 0 end) as importe_pzs, ~n"+&
"		  sum(case when venlifac.tipo_unidad  = '1' then case when venfac.ffactura between '"+string(ldt_fecha_desde,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta,gs_formato_fecha_cursores)+"' then ((venlifac.neto) / venfac.cambio) else 0 end else 0 end) as importe_m2, ~n"+&
"		  sum(case when venlifac.tipo_unidad <> '1' then case when venfac.ffactura between '"+string(ldt_fecha_desde_ant,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta_ant,gs_formato_fecha_cursores)+"' then isnull(venlifac.cantidad,0) else 0 end else 0 end) as pzs_ant, ~n"+&
"		  sum(case when venlifac.tipo_unidad  = '1' then case when venfac.ffactura between '"+string(ldt_fecha_desde_ant,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta_ant,gs_formato_fecha_cursores)+"' then isnull(venlifac.cantidad,0) else 0 end else 0 end) as m2_ant, ~n"+&
"		  convert(dec(16,2),sum(case when venfac.ffactura between '"+string(ldt_fecha_desde_ant,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta_ant,gs_formato_fecha_cursores)+"' then (venlifac.neto) / venfac.cambio else 0 end )) as importe_ant, ~n"+&
"		  sum(case when venlifac.tipo_unidad  <> '1' then case when venfac.ffactura between '"+string(ldt_fecha_desde_ant,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta_ant,gs_formato_fecha_cursores)+"' then ((venlifac.neto) / venfac.cambio) else 0 end else 0 end) as importe_pzs_ant, ~n"+&
"		  sum(case when venlifac.tipo_unidad  = '1' then case when venfac.ffactura between '"+string(ldt_fecha_desde_ant,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta_ant,gs_formato_fecha_cursores)+"' then ((venlifac.neto) / venfac.cambio) else 0 end else 0 end) as importe_m2_ant, ~n"+&
"		  '€' as moneda, ~n"+&
"		  '###,###,##0' as mascara_moneda, ~n"+&
"		  '###,###,##0.00' as mascara_precios_moneda ~n"+&
" FROM venfac ~n"+&
...
if ll_total > 0 then
	if GetFileSaveName("Seleccione Archivo", ls_ruta_fichero, ls_nombre_fichero, "xls", "Archivos Excel (*.xls), *.xls") = 1 then
		if ds_datos.SaveAs(ls_ruta_fichero, Excel!, true) = 1 then
			messagebox("Atención!","Datos guardados correctamente.")
		else
			messagebox("Atención!","Los datos no se han podido guardar.")
		end if
...
public subroutine f_control_excel_old (datawindow arg_datawindow);string ls_codigo,ls_filtro,ls_filtro_paises,ls_filtro_agentes,ls_filtro_pavrev,ls_filtro_familias,ls_filtro_formatos,ls_filtro_marcas,ls_filtro_submarcas,ls_filtro_cliente
string ls_sel,ls_campos_select,ls_campos_group_by,ls_filtro_articulos,ls_sort_actual,ls_texto_seleccion,ls_texto_filtro
integer li_indice,li_opciones,li_opciones_marcadas
long    ll_total
datetime ldt_fecha_desde,ldt_fecha_hasta
...
ls_campos_select = "		  isnull(paises.nombre,'') as pais, ~n"+&
						 "		  isnull(venagentes.nombre,'') as agente, ~n"+&							
						 "		  isnull(genter.razon,'') as cliente, ~n"+&			
						 "      datepart(yyyy,venfac.ffactura) as ejercicio, ~n"+&
						 "      datepart(mm,venfac.ffactura) as mes, ~n"+&
						 "		  isnull(familias.descripcion,'') as familia, ~n"+&
						 "		  isnull(marcas.descripcion,'') as marca, ~n"+&
						 "		  isnull(submarcas.descripcion,'') as submarca, ~n"
...
ls_campos_group_by = "		    genter.pais, ~n"+&
							...
							"		    genter.codigo, ~n"+&
							"		    genter.razon, ~n"+&
						   "         datepart(yyyy,venfac.ffactura), ~n"+&
						   "         datepart(mm,venfac.ffactura), ~n"+&							
							"		    articulos.familia, ~n"+&
							"		    familias.descripcion, ~n"+&
							"		    articulos.marcas_codigo, ~n"+&
							"		    marcas.descripcion, ~n"+&
...
ls_sel = "SELECT ~n"+&
ls_campos_select+&
"		  isnull(articulos.descripcion,'') as articulo, ~n"+&
"		  sum(case when venlifac.tipo_unidad <> '1' then isnull(venlifac.cantidad,0) else 0 end) as pzs, ~n"+&
"		  sum(case when venlifac.tipo_unidad = '1' then venlifac.cantidad else 0 end) as m2, ~n"+&
"		  convert(dec(16,2),sum((venlifac.neto - venlifac.impdtopp) / venfac.cambio)) as importe_pzs_y_m2, ~n"+&
"		  sum(case when venlifac.tipo_unidad <> '1' then ((venlifac.neto - venlifac.impdtopp) / venfac.cambio) else 0 end) as importe_pzs, ~n"+&
"		  sum(case when venlifac.tipo_unidad = '1' then ((venlifac.neto - venlifac.impdtopp) / venfac.cambio) else 0 end) as importe_m2 ~n"+&
" FROM venfac, ~n"+&
"		 venlifac, ~n"+&
"		 genter, ~n"+&
"		 paises, ~n"+&
...
ls_filtro_submarcas+" ~n"+&
"and   ( ( venfac.empresa = '"+codigo_empresa+"' ) ~n"+&
"AND     ( venfac.ffactura between '"+string(ldt_fecha_desde,gs_formato_fecha_cursores)+"' and '"+string(ldt_fecha_hasta,gs_formato_fecha_cursores)+"' ) ~n"+&
ls_filtro_articulos+&
" ) ~n"+&
"GROUP BY venfac.empresa, ~n"+&
ls_campos_group_by+&
...
event open;call super::open;istr_parametros.s_titulo_ventana = "Ventas por Familia,Marca y Submarca 4 Grupos"
...
dw_detalle.setsort("importe_g1_2 D,importe_g2_2 D,importe_g3_2 D,importe_g4_2 D, importe D,"+is_sort_inicial)
...
on w_con_ventas_familia_marca_submarca.create
int iCurrent
call super::create
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_ventas_familia_marca_submarca
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_ventas_familia_marca_submarca
integer x = 110
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_ventas_familia_marca_submarca
integer x = 9
integer y = 8
integer width = 2336
integer height = 108
...
integer height = 3368
integer taborder = 90
string dataobject = "dw_con_ventas_familia_marca_submarca"
...
//				dw_detalle.groupcalc()
			case "t_m2"
				...
				dw_detalle.sort()
				dw_detalle.groupcalc()				
				dw_detalle.setsort("m2_g1 D,m2_g2 D,m2_g3 D,,m2_g4 D m2 D,"+is_sort_inicial)
				dw_detalle.modify("t_descripcion.text='"+is_texto_t_descripcion+"'")				
				dw_detalle.modify("t_pzs.text='"+is_texto_t_pzs+"'")	
				dw_detalle.modify("t_m2.text='"+is_texto_t_m2+" \/'")	
				dw_detalle.modify("t_importe.text='"+is_texto_t_importe+"'")					
...
event clicked;f_control_excel(dw_detalle)
end event
...
event clicked;call super::clicked;pb_excel.event clicked()
end event
