$PBExportHeader$w_con_vtas_comparativo_familias.srw
forward
global type w_con_vtas_comparativo_familias from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_vtas_comparativo_familias
end type
type uo_1 from u_manejo_datawindow within w_con_vtas_comparativo_familias
end type
type em_periodo1 from u_em_campo within w_con_vtas_comparativo_familias
end type
type cb_consulta from u_boton within w_con_vtas_comparativo_familias
end type
type pb_imprimir_preli from picturebutton within w_con_vtas_comparativo_familias
end type
type st_7 from statictext within w_con_vtas_comparativo_familias
end type
type dw_listado from datawindow within w_con_vtas_comparativo_familias
end type
type em_periodo2 from u_em_campo within w_con_vtas_comparativo_familias
end type
type st_4 from statictext within w_con_vtas_comparativo_familias
end type
type uo_mes1 from u_em_campo_2 within w_con_vtas_comparativo_familias
end type
type uo_mes2 from u_em_campo_2 within w_con_vtas_comparativo_familias
end type
type dw_1 from datawindow within w_con_vtas_comparativo_familias
end type
type uo_serie from u_em_campo_2 within w_con_vtas_comparativo_familias
end type
type gb_4 from groupbox within w_con_vtas_comparativo_familias
end type
end forward
...
global w_con_vtas_comparativo_familias w_con_vtas_comparativo_familias
...
String sel,nombre_familia,familia,formato,nombre_formato
...
sel = " Select anyo,familia,Sum((neto - impdtopp) * cambio) total_fac_pts from venlifac" + &
...
For j = 1 To dat.RowCount()
	importe1 = 0
	importe2 = 0
	familia = dat.getItemSTring(j,"familia")
	...
	data.SetItem(ln,"familia",familia)
	data.SetItem(ln,"nombre_familia",nombre_familia)
...
This.title = " CONSULTA VENTAS POR FAMILIAS"
dw_1.Setfocus()
...
on w_con_vtas_comparativo_familias.create
int iCurrent
call super::create
...
on w_con_vtas_comparativo_familias.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_vtas_comparativo_familias
integer taborder = 70
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_vtas_comparativo_familias
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_vtas_comparativo_familias
integer y = 20
integer width = 2642
end type
...
integer height = 88
boolean bringtotop = true
string dataobject = "report_ventas_comparativo_familias"
...
integer height = 1116
boolean bringtotop = true
string dataobject = "dw_ventas_comparativo_familias"
boolean livescroll = true
borderstyle borderstyle = styleraised!
end type
