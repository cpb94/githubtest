$PBExportHeader$w_con_pedidos_entre_fechas_clientes_old.srw
forward
global type w_con_pedidos_entre_fechas_clientes_old from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_pedidos_entre_fechas_clientes_old
end type
type pb_2 from upb_imprimir within w_con_pedidos_entre_fechas_clientes_old
end type
type dw_listado from datawindow within w_con_pedidos_entre_fechas_clientes_old
end type
type em_fechadesde from u_em_campo within w_con_pedidos_entre_fechas_clientes_old
end type
type em_fechahasta from u_em_campo within w_con_pedidos_entre_fechas_clientes_old
end type
type cb_1 from commandbutton within w_con_pedidos_entre_fechas_clientes_old
end type
type gb_1 from groupbox within w_con_pedidos_entre_fechas_clientes_old
end type
type uo_cliente from u_em_campo_2 within w_con_pedidos_entre_fechas_clientes_old
end type
type gb_3 from groupbox within w_con_pedidos_entre_fechas_clientes_old
end type
type st_1 from statictext within w_con_pedidos_entre_fechas_clientes_old
end type
type uo_series from u_marca_lista within w_con_pedidos_entre_fechas_clientes_old
end type
type gb_6 from groupbox within w_con_pedidos_entre_fechas_clientes_old
end type
type dw_listado_resumen from datawindow within w_con_pedidos_entre_fechas_clientes_old
end type
type dw_listado_resumen_pm from datawindow within w_con_pedidos_entre_fechas_clientes_old
end type
type dw_detalle from datawindow within w_con_pedidos_entre_fechas_clientes_old
end type
type uo_agente from u_em_campo_2 within w_con_pedidos_entre_fechas_clientes_old
end type
type uo_familia from u_em_campo_2 within w_con_pedidos_entre_fechas_clientes_old
end type
type gb_4 from groupbox within w_con_pedidos_entre_fechas_clientes_old
end type
type gb_8 from groupbox within w_con_pedidos_entre_fechas_clientes_old
end type
end forward
...
global w_con_pedidos_entre_fechas_clientes_old w_con_pedidos_entre_fechas_clientes_old
...
long i, fila_Actual
string sel1, cliente, v_empresa, agente, familia, familia_sql
...
sel1 = 	" select genter.codigo, genter.razon "+& 
			...
			" and venclientes.agente1 like '"+agente+"' "+familia_sql
...
on w_con_pedidos_entre_fechas_clientes_old.create
int iCurrent
call super::create
...
on w_con_pedidos_entre_fechas_clientes_old.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_pedidos_entre_fechas_clientes_old
integer y = 612
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_pedidos_entre_fechas_clientes_old
boolean visible = false
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_pedidos_entre_fechas_clientes_old
integer x = 32
integer y = 8
integer width = 2875
integer height = 84
