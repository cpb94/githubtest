$PBExportHeader$dw_cuadro_mando1.srw
$PBExportComments$Informe de Objetivos de Facturación
forward
global type dw_cuadro_mando1 from w_int_con_empresa
end type
type pb_1 from upb_salir within dw_cuadro_mando1
end type
type pb_2 from upb_imprimir within dw_cuadro_mando1
end type
type cb_1 from commandbutton within dw_cuadro_mando1
end type
type gb_6 from groupbox within dw_cuadro_mando1
end type
type dw_informe from datawindow within dw_cuadro_mando1
end type
type ddlb_mes from dropdownlistbox within dw_cuadro_mando1
end type
type ddlb_anyo from dropdownlistbox within dw_cuadro_mando1
end type
type st_1 from statictext within dw_cuadro_mando1
end type
type st_2 from statictext within dw_cuadro_mando1
end type
type st_3 from statictext within dw_cuadro_mando1
end type
type st_4 from statictext within dw_cuadro_mando1
end type
end forward
...
global dw_cuadro_mando1 dw_cuadro_mando1
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within dw_cuadro_mando1
integer y = 612
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within dw_cuadro_mando1
end type

type st_empresa from w_int_con_empresa`st_empresa within dw_cuadro_mando1
integer y = 8
integer width = 3570
integer height = 76
end type
