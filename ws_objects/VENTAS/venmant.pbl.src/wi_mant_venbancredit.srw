$PBExportHeader$wi_mant_venbancredit.srw
$PBExportComments$Mant. bancos avisadores cartas de credito.
forward
global type wi_mant_venbancredit from wi_mvent_con_empresa
end type
type pb_calculadora from u_calculadora within wi_mant_venbancredit
end type
type gb_1 from groupbox within wi_mant_venbancredit
end type
end forward
...
global wi_mant_venbancredit wi_mant_venbancredit
...
event open;call super::open;   istr_parametros.s_titulo_ventana = "Mantenimiento de bancos avisadores"
	istr_parametros.s_listado        = "report_venbancredit"
...
on wi_mant_venbancredit.create
int iCurrent
call super::create
...
on wi_mant_venbancredit.destroy
call super::destroy
...
type dw_1 from wi_mvent_con_empresa`dw_1 within wi_mant_venbancredit
integer x = 46
integer y = 280
integer width = 2693
integer height = 684
string dataobject = "dw_venbancredit"
end type
...
type st_1 from wi_mvent_con_empresa`st_1 within wi_mant_venbancredit
integer x = 82
integer y = 176
integer width = 366
string text = "Banco"
...
type cb_insertar from wi_mvent_con_empresa`cb_insertar within wi_mant_venbancredit
integer x = 1481
integer y = 168
integer height = 84
end type

type cb_borrar from wi_mvent_con_empresa`cb_borrar within wi_mant_venbancredit
integer x = 1897
integer y = 168
integer height = 84
end type

type sle_valor from wi_mvent_con_empresa`sle_valor within wi_mant_venbancredit
integer x = 466
integer y = 176
end type
...
type cb_salir from wi_mvent_con_empresa`cb_salir within wi_mant_venbancredit
integer x = 2313
integer y = 168
integer height = 84
end type

type control_tabulador from wi_mvent_con_empresa`control_tabulador within wi_mant_venbancredit
end type

type p_logotencer from wi_mvent_con_empresa`p_logotencer within wi_mant_venbancredit
end type

type st_empresa from wi_mvent_con_empresa`st_empresa within wi_mant_venbancredit
integer width = 2299
end type
...
event clicked;call super::clicked;IF cb_insertar.enabled=TRUE THEN Return
 Integer registros
 Select count(*) Into :registros From venbancredit
 Where  venbancredit.empresa = :codigo_empresa;
 IF registros=0  Then
  sle_valor.text="1"
 ELSE
  Select max(convert(int,venbancredit.banco)+1)
  Into   :sle_valor.text
  From   venbancredit
  Where  venbancredit.empresa = :codigo_empresa;
 END IF
