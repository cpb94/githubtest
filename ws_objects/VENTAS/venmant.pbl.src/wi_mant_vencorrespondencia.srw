$PBExportHeader$wi_mant_vencorrespondencia.srw
$PBExportComments$mant. direcciones de correspondencia.
forward
global type wi_mant_vencorrespondencia from wi_mvent_con_empresa
end type
type pb_calculadora from u_calculadora within wi_mant_vencorrespondencia
end type
type st_ntelefonos from statictext within wi_mant_vencorrespondencia
end type
type st_nomcliente from statictext within wi_mant_vencorrespondencia
end type
type em_cliente from u_em_campo within wi_mant_vencorrespondencia
end type
end forward
...
global wi_mant_vencorrespondencia wi_mant_vencorrespondencia
...
istr_parametros.s_titulo_ventana = "Mantenimiento de envio de correspondencia"
istr_parametros.s_listado        = "report_vencorrespondencia"
...
on wi_mant_vencorrespondencia.create
int iCurrent
call super::create
...
on wi_mant_vencorrespondencia.destroy
call super::destroy
...
type dw_1 from wi_mvent_con_empresa`dw_1 within wi_mant_vencorrespondencia
integer x = 23
integer y = 332
integer width = 2153
integer height = 792
string dataobject = "dw_vencorrespondencia"
end type
...
type st_1 from wi_mvent_con_empresa`st_1 within wi_mant_vencorrespondencia
integer x = 187
integer y = 228
integer width = 279
integer height = 68
...
type cb_insertar from wi_mvent_con_empresa`cb_insertar within wi_mant_vencorrespondencia
integer x = 2231
integer y = 332
integer height = 84
end type
...
type cb_borrar from wi_mvent_con_empresa`cb_borrar within wi_mant_vencorrespondencia
integer x = 2231
integer y = 448
integer height = 84
boolean cancel = true
...
type sle_valor from wi_mvent_con_empresa`sle_valor within wi_mant_vencorrespondencia
integer x = 850
integer width = 311
integer taborder = 20
end type
...
ue_titulo     = "AYUDA SELECCION DIRECCION DE CORRESPONDENCIA"
ue_datawindow = "dw_ayuda_vencorrespondencia"
ue_filtro     = " cliente = '" + em_cliente.text + "'"
isle_campo    = this

end on

type cb_salir from wi_mvent_con_empresa`cb_salir within wi_mant_vencorrespondencia
integer x = 2231
integer y = 564
integer height = 84
end type

type control_tabulador from wi_mvent_con_empresa`control_tabulador within wi_mant_vencorrespondencia
integer taborder = 30
end type

type p_logotencer from wi_mvent_con_empresa`p_logotencer within wi_mant_vencorrespondencia
end type

type st_empresa from wi_mvent_con_empresa`st_empresa within wi_mant_vencorrespondencia
integer width = 2578
end type
...
Select count(*) Into :registros From vencorrespondencia
Where  vencorrespondencia.empresa       = :codigo_empresa
and    vencorrespondencia.cliente       = :em_cliente.text;

IF registros=0 THEN
 sle_valor.text="1" 
ELSE
 Select max(convert(int,vencorrespondencia.codigo)+1)
 Into   :sle_valor.text
