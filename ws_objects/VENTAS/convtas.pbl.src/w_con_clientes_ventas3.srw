$PBExportHeader$w_con_clientes_ventas3.srw
forward
global type w_con_clientes_ventas3 from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_clientes_ventas3
end type
type st_1 from statictext within w_con_clientes_ventas3
end type
type uo_pais from u_em_campo_2 within w_con_clientes_ventas3
end type
type st_2 from statictext within w_con_clientes_ventas3
end type
type uo_provincia from u_em_campo_2 within w_con_clientes_ventas3
end type
type uo_manejo from u_manejo_datawindow within w_con_clientes_ventas3
end type
type dw_listado4 from datawindow within w_con_clientes_ventas3
end type
type pb_imprimir from upb_imprimir within w_con_clientes_ventas3
end type
type dw_distribuidores from datawindow within w_con_clientes_ventas3
end type
type cb_1 from commandbutton within w_con_clientes_ventas3
end type
type em_dia_pago from editmask within w_con_clientes_ventas3
end type
type st_3 from statictext within w_con_clientes_ventas3
end type
end forward
...
cb_1 cb_1
em_dia_pago em_dia_pago
st_3 st_3
end type
global w_con_clientes_ventas3 w_con_clientes_ventas3

type variables
string filtro,tipocon
end variables

event open;call super::open;istr_parametros.s_titulo_ventana="Listado de clientes con días de pago"
...
event ue_listar;string provinc,dia1,dia2,dia3
...
if em_dia_pago.text = "" then
	dia1 = "%"
else
	dia1 = em_dia_pago.text
end if



dw_listado4.Retrieve(codigo_empresa,uo_pais.em_codigo.text,provinc,dia1)
dw_report=dw_listado4
CALL Super::ue_listar
end event

on w_con_clientes_ventas3.create
int iCurrent
call super::create
...
this.em_dia_pago=create em_dia_pago
...
this.Control[iCurrent+11]=this.em_dia_pago
this.Control[iCurrent+12]=this.st_3
end on

on w_con_clientes_ventas3.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_clientes_ventas3
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_clientes_ventas3
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_clientes_ventas3
integer y = 8
integer width = 1893
end type
...
integer height = 140
boolean bringtotop = true
string dataobject = "report_con_clientes_ventas3"
...
integer width = 2825
integer height = 1636
string dataobject = "dw_con_clientes_ventas3"
...
event clicked;String provinc,dia1,dia2,dia3
...
dw_distribuidores.Retrieve(codigo_empresa,uo_pais.em_codigo.text,provinc,dia1)
