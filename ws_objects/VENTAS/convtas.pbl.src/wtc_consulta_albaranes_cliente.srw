$PBExportHeader$wtc_consulta_albaranes_cliente.srw
forward
global type wtc_consulta_albaranes_cliente from wt_consultas_padre
end type
type st_1 from statictext within wtc_consulta_albaranes_cliente
end type
end forward
...
global wtc_consulta_albaranes_cliente wtc_consulta_albaranes_cliente
...
on wtc_consulta_albaranes_cliente.create
int iCurrent
call super::create
...
on wtc_consulta_albaranes_cliente.destroy
call super::destroy
...
type pb_imprimir from wt_consultas_padre`pb_imprimir within wtc_consulta_albaranes_cliente
integer x = 3401
integer y = 136
end type

type pb_borrar from wt_consultas_padre`pb_borrar within wtc_consulta_albaranes_cliente
integer x = 3557
integer y = 136
end type

type dw_montaje_filtro from wt_consultas_padre`dw_montaje_filtro within wtc_consulta_albaranes_cliente
integer width = 3973
integer height = 224
end type

type pb_1 from wt_consultas_padre`pb_1 within wtc_consulta_albaranes_cliente
integer x = 3214
integer y = 136
integer taborder = 0
end type
...
type pb_reset from wt_consultas_padre`pb_reset within wtc_consulta_albaranes_cliente
integer x = 3712
integer y = 136
integer taborder = 0
end type

type pb_anyadir1 from wt_consultas_padre`pb_anyadir1 within wtc_consulta_albaranes_cliente
integer x = 3063
integer y = 136
integer taborder = 0
end type
...
type ddlb_operador from wt_consultas_padre`ddlb_operador within wtc_consulta_albaranes_cliente
integer x = 951
integer taborder = 20
integer weight = 700
...
type ddlb_campo from wt_consultas_padre`ddlb_campo within wtc_consulta_albaranes_cliente
integer width = 878
integer height = 904
integer taborder = 10
integer weight = 700
...
type dw_datos from wt_consultas_padre`dw_datos within wtc_consulta_albaranes_cliente
integer y = 512
integer width = 3973
integer height = 2260
integer taborder = 60
string dataobject = "dwtc_consulta_albaranes_cliente"
end type
...
type pb_salir from wt_consultas_padre`pb_salir within wtc_consulta_albaranes_cliente
integer x = 3867
integer y = 136
integer taborder = 0
end type

type st_titulo from wt_consultas_padre`st_titulo within wtc_consulta_albaranes_cliente
end type

type p_logo from wt_consultas_padre`p_logo within wtc_consulta_albaranes_cliente
integer x = 3493
integer y = 20
end type

type dw_filtro from wt_consultas_padre`dw_filtro within wtc_consulta_albaranes_cliente
integer x = 1298
integer y = 232
integer width = 1673
integer height = 132
...
type pb_buscar from wt_consultas_padre`pb_buscar within wtc_consulta_albaranes_cliente
integer x = 2871
integer y = 132
integer taborder = 80
end type

type sle_valor1 from wt_consultas_padre`sle_valor1 within wtc_consulta_albaranes_cliente
integer x = 1312
integer width = 398
integer height = 96
integer taborder = 30
...
type em_fecha1 from wt_consultas_padre`em_fecha1 within wtc_consulta_albaranes_cliente
integer x = 1307
integer height = 96
integer taborder = 90
string text = ""
...
type sle_texto from wt_consultas_padre`sle_texto within wtc_consulta_albaranes_cliente
integer x = 1312
integer y = 132
integer height = 96
integer taborder = 40
...
type lb_lista from wt_consultas_padre`lb_lista within wtc_consulta_albaranes_cliente
integer x = 1312
integer y = 132
integer width = 462
integer height = 252
