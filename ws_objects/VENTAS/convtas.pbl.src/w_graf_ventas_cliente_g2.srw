$PBExportHeader$w_graf_ventas_cliente_g2.srw
forward
global type w_graf_ventas_cliente_g2 from w_int_con_empresa
end type
type pb_1 from upb_salir within w_graf_ventas_cliente_g2
end type
type pb_2 from upb_imprimir within w_graf_ventas_cliente_g2
end type
type cb_1 from commandbutton within w_graf_ventas_cliente_g2
end type
type gb_1 from groupbox within w_graf_ventas_cliente_g2
end type
type gb_6 from groupbox within w_graf_ventas_cliente_g2
end type
type em_fdesde from u_em_campo within w_graf_ventas_cliente_g2
end type
type em_fhasta from u_em_campo within w_graf_ventas_cliente_g2
end type
type rb_grafica from radiobutton within w_graf_ventas_cliente_g2
end type
type rb_datos from radiobutton within w_graf_ventas_cliente_g2
end type
type gb_2 from groupbox within w_graf_ventas_cliente_g2
end type
type sle_mes1 from singlelineedit within w_graf_ventas_cliente_g2
end type
type sle_mes2 from singlelineedit within w_graf_ventas_cliente_g2
end type
type sle_anyo1 from singlelineedit within w_graf_ventas_cliente_g2
end type
type sle_anyo2 from singlelineedit within w_graf_ventas_cliente_g2
end type
type gb_3 from groupbox within w_graf_ventas_cliente_g2
end type
type gb_5 from groupbox within w_graf_ventas_cliente_g2
end type
type uo_cliente from u_em_campo_2 within w_graf_ventas_cliente_g2
end type
type gb_4 from groupbox within w_graf_ventas_cliente_g2
end type
type uo_agente from u_em_campo_2 within w_graf_ventas_cliente_g2
end type
type gb_7 from groupbox within w_graf_ventas_cliente_g2
end type
type rb_detalle from radiobutton within w_graf_ventas_cliente_g2
end type
type dw_datos from datawindow within w_graf_ventas_cliente_g2
end type
type dw_informe from datawindow within w_graf_ventas_cliente_g2
end type
type dw_detalle from datawindow within w_graf_ventas_cliente_g2
end type
end forward
...
global w_graf_ventas_cliente_g2 w_graf_ventas_cliente_g2
...
istr_parametros.s_titulo_ventana="Gráfico de Ventas por Cliente entre Períodos y G2"
...
on w_graf_ventas_cliente_g2.create
int iCurrent
call super::create
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_graf_ventas_cliente_g2
integer y = 612
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_graf_ventas_cliente_g2
end type

type st_empresa from w_int_con_empresa`st_empresa within w_graf_ventas_cliente_g2
integer y = 8
integer width = 4142
integer height = 96
end type
...
integer taborder = 70
string title = "none"
string dataobject = "dw_con_ventas_g2"
...
integer width = 4389
integer height = 2120
string dataobject = "dw_graf_ventas_cliente_g2"
...
integer taborder = 80
string title = "none"
string dataobject = "dw_con_ventas_cliente_g2"
boolean vscrollbar = true
boolean livescroll = true
end type
