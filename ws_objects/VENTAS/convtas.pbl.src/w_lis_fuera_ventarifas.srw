$PBExportHeader$w_lis_fuera_ventarifas.srw
forward
global type w_lis_fuera_ventarifas from w_int_con_empresa
end type
type pb_1 from upb_salir within w_lis_fuera_ventarifas
end type
type st_2 from statictext within w_lis_fuera_ventarifas
end type
type em_tarifa from u_em_campo within w_lis_fuera_ventarifas
end type
type sle_fecha from u_em_campo within w_lis_fuera_ventarifas
end type
type st_nombre_tarifa from statictext within w_lis_fuera_ventarifas
end type
type dw_fechas from datawindow within w_lis_fuera_ventarifas
end type
type st_1 from statictext within w_lis_fuera_ventarifas
end type
type st_moneda_tarifa from statictext within w_lis_fuera_ventarifas
end type
type st_pagina from statictext within w_lis_fuera_ventarifas
end type
type pb_imprimir_preli from picturebutton within w_lis_fuera_ventarifas
end type
type dw_preliminar from datawindow within w_lis_fuera_ventarifas
end type
type uo_manejo from u_manejo_datawindow within w_lis_fuera_ventarifas
end type
end forward
...
global w_lis_fuera_ventarifas w_lis_fuera_ventarifas
...
dw_preliminar.Retrieve(codigo_empresa,em_tarifa.text,fecha,"%")
f_pagina()
...
on w_lis_fuera_ventarifas.create
int iCurrent
call super::create
...
on w_lis_fuera_ventarifas.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_lis_fuera_ventarifas
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_lis_fuera_ventarifas
end type

type st_empresa from w_int_con_empresa`st_empresa within w_lis_fuera_ventarifas
integer x = 27
integer y = 8
integer width = 3141
end type
