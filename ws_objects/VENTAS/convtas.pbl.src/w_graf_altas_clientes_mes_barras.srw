$PBExportHeader$w_graf_altas_clientes_mes_barras.srw
forward
global type w_graf_altas_clientes_mes_barras from w_int_con_empresa
end type
type pb_1 from upb_salir within w_graf_altas_clientes_mes_barras
end type
type pb_2 from upb_imprimir within w_graf_altas_clientes_mes_barras
end type
type cb_1 from commandbutton within w_graf_altas_clientes_mes_barras
end type
type gb_1 from groupbox within w_graf_altas_clientes_mes_barras
end type
type gb_6 from groupbox within w_graf_altas_clientes_mes_barras
end type
type dw_informe from datawindow within w_graf_altas_clientes_mes_barras
end type
type em_fdesde from u_em_campo within w_graf_altas_clientes_mes_barras
end type
type em_fhasta from u_em_campo within w_graf_altas_clientes_mes_barras
end type
end forward
...
global w_graf_altas_clientes_mes_barras w_graf_altas_clientes_mes_barras
...
istr_parametros.s_titulo_ventana="Gráfico de Altas por Cliente entre Fechas (Líneas)"
...
on w_graf_altas_clientes_mes_barras.create
int iCurrent
call super::create
...
on w_graf_altas_clientes_mes_barras.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_graf_altas_clientes_mes_barras
integer y = 612
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_graf_altas_clientes_mes_barras
end type

type st_empresa from w_int_con_empresa`st_empresa within w_graf_altas_clientes_mes_barras
integer x = 9
integer y = 8
integer width = 3237
integer height = 112
...
integer height = 1728
boolean bringtotop = true
string dataobject = "dw_graf_altas_clientes_mes_barras"
