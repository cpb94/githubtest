$PBExportHeader$w_graf_altas_g2_cliente.srw
forward
global type w_graf_altas_g2_cliente from w_int_con_empresa
end type
type pb_1 from upb_salir within w_graf_altas_g2_cliente
end type
type pb_2 from upb_imprimir within w_graf_altas_g2_cliente
end type
type cb_1 from commandbutton within w_graf_altas_g2_cliente
end type
type gb_6 from groupbox within w_graf_altas_g2_cliente
end type
type em_fdesde from u_em_campo within w_graf_altas_g2_cliente
end type
type em_fhasta from u_em_campo within w_graf_altas_g2_cliente
end type
type uo_cliente from u_em_campo_2 within w_graf_altas_g2_cliente
end type
type gb_4 from groupbox within w_graf_altas_g2_cliente
end type
type rb_grafica from radiobutton within w_graf_altas_g2_cliente
end type
type rb_datos from radiobutton within w_graf_altas_g2_cliente
end type
type gb_2 from groupbox within w_graf_altas_g2_cliente
end type
type sle_mes1 from singlelineedit within w_graf_altas_g2_cliente
end type
type sle_mes2 from singlelineedit within w_graf_altas_g2_cliente
end type
type sle_anyo1 from singlelineedit within w_graf_altas_g2_cliente
end type
type gb_3 from groupbox within w_graf_altas_g2_cliente
end type
type gb_5 from groupbox within w_graf_altas_g2_cliente
end type
type sle_anyo2 from singlelineedit within w_graf_altas_g2_cliente
end type
type uo_agente from u_em_campo_2 within w_graf_altas_g2_cliente
end type
type gb_7 from groupbox within w_graf_altas_g2_cliente
end type
type rb_detalle from radiobutton within w_graf_altas_g2_cliente
end type
type dw_altas_g2 from datawindow within w_graf_altas_g2_cliente
end type
type dw_datos from datawindow within w_graf_altas_g2_cliente
end type
type dw_informe from datawindow within w_graf_altas_g2_cliente
end type
end forward
...
dw_altas_g2 dw_altas_g2
dw_datos dw_datos
dw_informe dw_informe
end type
global w_graf_altas_g2_cliente w_graf_altas_g2_cliente
...
istr_parametros.s_titulo_ventana="Gráfico de Altas por Cliente entre Fechas y G2"
...
on w_graf_altas_g2_cliente.create
int iCurrent
call super::create
...
this.dw_altas_g2=create dw_altas_g2
...
this.Control[iCurrent+9]=this.rb_grafica
this.Control[iCurrent+10]=this.rb_datos
this.Control[iCurrent+11]=this.gb_2
this.Control[iCurrent+12]=this.sle_mes1
this.Control[iCurrent+13]=this.sle_mes2
this.Control[iCurrent+14]=this.sle_anyo1
this.Control[iCurrent+15]=this.gb_3
this.Control[iCurrent+16]=this.gb_5
this.Control[iCurrent+17]=this.sle_anyo2
this.Control[iCurrent+18]=this.uo_agente
this.Control[iCurrent+19]=this.gb_7
this.Control[iCurrent+20]=this.rb_detalle
this.Control[iCurrent+21]=this.dw_altas_g2
this.Control[iCurrent+22]=this.dw_datos
this.Control[iCurrent+23]=this.dw_informe
end on

on w_graf_altas_g2_cliente.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_graf_altas_g2_cliente
integer y = 612
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_graf_altas_g2_cliente
end type

type st_empresa from w_int_con_empresa`st_empresa within w_graf_altas_g2_cliente
integer y = 8
integer width = 4142
integer height = 96
end type
...
if rb_datos.checked then
	f_imprimir_datawindow(dw_altas_g2)
end if
...
event clicked;if rb_grafica.checked then
	...
	dw_altas_g2.visible = false
	f_control(dw_informe)
end if
if rb_datos.checked then
	dw_informe.visible = false
	dw_datos.visible = false
	dw_altas_g2.visible = true

 	f_control(dw_altas_g2)
end if
if rb_detalle.checked then
	dw_informe.visible = false
...
string title = "none"
string dataobject = "dw_con_altas_g2"
...
integer taborder = 90
string title = "none"
string dataobject = "dw_con_altas_g2_cliente"
boolean vscrollbar = true
boolean livescroll = true
end type
...
integer width = 4389
integer height = 2140
string dataobject = "dw_graf_altas_g2_cliente"
