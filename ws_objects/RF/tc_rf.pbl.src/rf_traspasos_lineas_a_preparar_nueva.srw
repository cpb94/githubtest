$PBExportHeader$rf_traspasos_lineas_a_preparar_nueva.srw
forward
global type rf_traspasos_lineas_a_preparar_nueva from window
end type
type pb_reset_piezas from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_menos_piezas from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_menos_cajas from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_menos_pallet from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_mas_piezas from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_mas_cajas from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_mas_pallet from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type em_piezas from editmask within rf_traspasos_lineas_a_preparar_nueva
end type
type em_cajas from editmask within rf_traspasos_lineas_a_preparar_nueva
end type
type em_pallets from editmask within rf_traspasos_lineas_a_preparar_nueva
end type
type st_piezas from statictext within rf_traspasos_lineas_a_preparar_nueva
end type
type st_cajas from statictext within rf_traspasos_lineas_a_preparar_nueva
end type
type st_pallets from statictext within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_salir from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type st_paso3 from statictext within rf_traspasos_lineas_a_preparar_nueva
end type
type st_paso2 from statictext within rf_traspasos_lineas_a_preparar_nueva
end type
type st_paso1 from statictext within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_atras from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type pb_aceptar from picturebutton within rf_traspasos_lineas_a_preparar_nueva
end type
type uo_lectura_destino from u_sle_codbar within rf_traspasos_lineas_a_preparar_nueva
end type
type uo_lectura_origen from u_sle_codbar within rf_traspasos_lineas_a_preparar_nueva
end type
end forward
...
string title = "Traspaso de lineas a Preparar (Promoción)"
...
global rf_traspasos_lineas_a_preparar_nueva rf_traspasos_lineas_a_preparar_nueva
...
long    il_id_ubicacion_destino_fija = 0//162213 6-YY-1-1
end variables

on rf_traspasos_lineas_a_preparar_nueva.create
...
on rf_traspasos_lineas_a_preparar_nueva.destroy
			...
			if uo_lectura_origen.ii_anyo_orden_carga = uo_lectura_destino.ii_anyo_orden_carga and uo_lectura_origen.is_orden_carga = uo_lectura_destino.is_orden_carga then
				...
				if f_movimiento_almacen(lstr_movimiento_almacen) then
					...
					if uo_lectura_destino.il_id_ubicacion > 0 then
						...
						//lstr_movimiento_almacen.id_ubicacion    = uo_lectura_origen.il_id_ubicacion
						lstr_movimiento_almacen.id_ubicacion    = f_usuarios_id_ubicacion_preparacion(nombre_usuario)
					end if
...
event modified;call super::modified;if il_id_bulto = 0 then
	...
	if il_id_bulto = uo_lectura_origen.il_id_bulto then
		...
		if il_id_ubicacion = 0 and f_usuarios_id_ubicacion_preparacion(nombre_usuario) = 0 then
			f_reset()
			...
			if il_id_ubicacion = 0 then
				if not f_asignar_nueva_ubicacion(f_usuarios_id_ubicacion_preparacion(nombre_usuario)) then
