$PBExportHeader$rf_traspasos_lineas_ubicar_promocion.srw
forward
global type rf_traspasos_lineas_ubicar_promocion from window
end type
type pb_reset_piezas from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type pb_menos_piezas from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type pb_menos_cajas from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type pb_menos_pallet from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type pb_mas_piezas from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type pb_mas_cajas from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type pb_mas_pallet from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type em_piezas from editmask within rf_traspasos_lineas_ubicar_promocion
end type
type em_cajas from editmask within rf_traspasos_lineas_ubicar_promocion
end type
type em_pallets from editmask within rf_traspasos_lineas_ubicar_promocion
end type
type st_piezas from statictext within rf_traspasos_lineas_ubicar_promocion
end type
type st_cajas from statictext within rf_traspasos_lineas_ubicar_promocion
end type
type st_pallets from statictext within rf_traspasos_lineas_ubicar_promocion
end type
type pb_salir from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type st_paso3 from statictext within rf_traspasos_lineas_ubicar_promocion
end type
type st_paso2 from statictext within rf_traspasos_lineas_ubicar_promocion
end type
type st_paso1 from statictext within rf_traspasos_lineas_ubicar_promocion
end type
type pb_atras from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type pb_aceptar from picturebutton within rf_traspasos_lineas_ubicar_promocion
end type
type uo_lectura_destino from u_sle_codbar within rf_traspasos_lineas_ubicar_promocion
end type
type uo_lectura_origen from u_sle_codbar within rf_traspasos_lineas_ubicar_promocion
end type
end forward
...
global rf_traspasos_lineas_ubicar_promocion rf_traspasos_lineas_ubicar_promocion
...
boolean ib_ubicacion_origen_fija  = true
long    il_id_ubicacion_origen_fija = 162008
boolean ib_ubicacion_destino_fija = false
long    il_id_ubicacion_destino_fija = 0
end variables

on rf_traspasos_lineas_ubicar_promocion.create
...
on rf_traspasos_lineas_ubicar_promocion.destroy
