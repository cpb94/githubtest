$PBExportHeader$u_sle_codbar_sin_lectura_caja_bulto.sru
forward
global type u_sle_codbar_sin_lectura_caja_bulto from userobject
end type
type pb_teclado from picturebutton within u_sle_codbar_sin_lectura_caja_bulto
end type
type dw_detalle_bultos from datawindow within u_sle_codbar_sin_lectura_caja_bulto
end type
type pb_ver_detalle_bulto from picturebutton within u_sle_codbar_sin_lectura_caja_bulto
end type
type st_descripcion from statictext within u_sle_codbar_sin_lectura_caja_bulto
end type
type sle_codbar from singlelineedit within u_sle_codbar_sin_lectura_caja_bulto
end type
type st_texto from statictext within u_sle_codbar_sin_lectura_caja_bulto
end type
type p_codbar from picture within u_sle_codbar_sin_lectura_caja_bulto
end type
end forward
...
global u_sle_codbar_sin_lectura_caja_bulto u_sle_codbar_sin_lectura_caja_bulto
...
on u_sle_codbar_sin_lectura_caja_bulto.create
...
on u_sle_codbar_sin_lectura_caja_bulto.destroy
