$PBExportHeader$rf_entradas_regularizacion.srw
forward
global type rf_entradas_regularizacion from window
end type
type pb_1 from picturebutton within rf_entradas_regularizacion
end type
type pb_atras from picturebutton within rf_entradas_regularizacion
end type
type st_paso1 from statictext within rf_entradas_regularizacion
end type
type st_paso2 from statictext within rf_entradas_regularizacion
end type
type pb_aceptar from picturebutton within rf_entradas_regularizacion
end type
type pb_menos_piezas from picturebutton within rf_entradas_regularizacion
end type
type pb_menos_cajas from picturebutton within rf_entradas_regularizacion
end type
type pb_menos_pallet from picturebutton within rf_entradas_regularizacion
end type
type pb_mas_piezas from picturebutton within rf_entradas_regularizacion
end type
type pb_mas_cajas from picturebutton within rf_entradas_regularizacion
end type
type pb_mas_pallet from picturebutton within rf_entradas_regularizacion
end type
type em_piezas from editmask within rf_entradas_regularizacion
end type
type em_cajas from editmask within rf_entradas_regularizacion
end type
type em_pallets from editmask within rf_entradas_regularizacion
end type
type st_piezas from statictext within rf_entradas_regularizacion
end type
type st_cajas from statictext within rf_entradas_regularizacion
end type
type st_pallets from statictext within rf_entradas_regularizacion
end type
type st_paso3 from statictext within rf_entradas_regularizacion
end type
type uo_lectura_caja from u_sle_codbar within rf_entradas_regularizacion
end type
type uo_lectura_pallet from u_sle_codbar within rf_entradas_regularizacion
end type
end forward
...
string title = "Entrada Regularización"
...
global rf_entradas_regularizacion rf_entradas_regularizacion

type variables
string is_tipo_movimiento = '7'
string is_almacen = '8'
string is_zona = 'A'
int    ii_fila = 1
int    ii_altura = 1
...
on rf_entradas_regularizacion.create
...
on rf_entradas_regularizacion.destroy
destroy(this.pb_1)
...
if dec(em_piezas.text) > 0 then
	...
	if uo_lectura_pallet.il_id_ubicacion = 0 then
	...
	lstr_movimiento_almacen.id_ubicacion       = uo_lectura_pallet.il_id_ubicacion
...
em_pallets.text  = string(0,em_pallets.mask)
...
boolean ib_pedir_ubicacion_si_el_bulto_no_la_tiene = true
end type
