$PBExportHeader$rf_entradas_bases_clientes.srw
forward
global type rf_entradas_bases_clientes from window
end type
type pb_1 from picturebutton within rf_entradas_bases_clientes
end type
type pb_atras from picturebutton within rf_entradas_bases_clientes
end type
type st_paso1 from statictext within rf_entradas_bases_clientes
end type
type st_paso2 from statictext within rf_entradas_bases_clientes
end type
type pb_aceptar from picturebutton within rf_entradas_bases_clientes
end type
type pb_menos_piezas from picturebutton within rf_entradas_bases_clientes
end type
type pb_menos_cajas from picturebutton within rf_entradas_bases_clientes
end type
type pb_menos_pallet from picturebutton within rf_entradas_bases_clientes
end type
type pb_mas_piezas from picturebutton within rf_entradas_bases_clientes
end type
type pb_mas_cajas from picturebutton within rf_entradas_bases_clientes
end type
type pb_mas_pallet from picturebutton within rf_entradas_bases_clientes
end type
type em_piezas from editmask within rf_entradas_bases_clientes
end type
type em_cajas from editmask within rf_entradas_bases_clientes
end type
type em_pallets from editmask within rf_entradas_bases_clientes
end type
type st_piezas from statictext within rf_entradas_bases_clientes
end type
type st_cajas from statictext within rf_entradas_bases_clientes
end type
type st_pallets from statictext within rf_entradas_bases_clientes
end type
type st_paso3 from statictext within rf_entradas_bases_clientes
end type
type uo_lectura_caja from u_sle_codbar within rf_entradas_bases_clientes
end type
type uo_lectura_pallet from u_sle_codbar within rf_entradas_bases_clientes
end type
end forward
...
string title = "MONTAR BULTO BASE CLIENTE"
...
global rf_entradas_bases_clientes rf_entradas_bases_clientes

type variables
string is_tipo_movimiento = '217'
string is_almacen = '8'
string is_zona = 'A'
int    ii_fila = 1
int    ii_altura = 1
...
on rf_entradas_bases_clientes.create
...
on rf_entradas_bases_clientes.destroy
destroy(this.pb_1)
