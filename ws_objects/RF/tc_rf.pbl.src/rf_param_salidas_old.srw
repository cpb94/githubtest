$PBExportHeader$rf_param_salidas_old.srw
forward
global type rf_param_salidas_old from window
end type
type p_ayuda_ventana from picture within rf_param_salidas_old
end type
type st_piezas_disponibles from statictext within rf_param_salidas_old
end type
type em_piezas_disponibles from editmask within rf_param_salidas_old
end type
type st_piezas_reservadas from statictext within rf_param_salidas_old
end type
type em_piezas_reservadas from editmask within rf_param_salidas_old
end type
type st_piezas_disponibles_totales from statictext within rf_param_salidas_old
end type
type em_piezas_disponibles_totales from editmask within rf_param_salidas_old
end type
type st_pallets from statictext within rf_param_salidas_old
end type
type st_cajas from statictext within rf_param_salidas_old
end type
type st_piezas from statictext within rf_param_salidas_old
end type
type em_pallets from editmask within rf_param_salidas_old
end type
type em_cajas from editmask within rf_param_salidas_old
end type
type em_piezas from editmask within rf_param_salidas_old
end type
type pb_mas_pallet from picturebutton within rf_param_salidas_old
end type
type pb_mas_cajas from picturebutton within rf_param_salidas_old
end type
type pb_mas_piezas from picturebutton within rf_param_salidas_old
end type
type pb_menos_pallet from picturebutton within rf_param_salidas_old
end type
type pb_menos_cajas from picturebutton within rf_param_salidas_old
end type
type pb_menos_piezas from picturebutton within rf_param_salidas_old
end type
type pb_atras from picturebutton within rf_param_salidas_old
end type
type st_paso3 from statictext within rf_param_salidas_old
end type
type st_paso1 from statictext within rf_param_salidas_old
end type
type pb_1 from picturebutton within rf_param_salidas_old
end type
type pb_aceptar from picturebutton within rf_param_salidas_old
end type
type uo_lectura_origen from u_sle_codbar within rf_param_salidas_old
end type
type st_paso2 from statictext within rf_param_salidas_old
end type
end forward
...
global rf_param_salidas_old rf_param_salidas_old
...
on rf_param_salidas_old.create
...
on rf_param_salidas_old.destroy
...
//			uo_lectura_pallet.ib_mostrar_desplegado = true
//		else	
//			uo_lectura_pallet.ib_mostrar_desplegado = false
//		end if
//		
//		uo_lectura_pallet.event constructor()	
