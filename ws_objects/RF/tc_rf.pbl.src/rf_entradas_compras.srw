$PBExportHeader$rf_entradas_compras.srw
forward
global type rf_entradas_compras from window
end type
type pb_1 from picturebutton within rf_entradas_compras
end type
type pb_atras from picturebutton within rf_entradas_compras
end type
type st_paso1 from statictext within rf_entradas_compras
end type
type st_paso2 from statictext within rf_entradas_compras
end type
type pb_aceptar from picturebutton within rf_entradas_compras
end type
type pb_menos_piezas from picturebutton within rf_entradas_compras
end type
type pb_menos_cajas from picturebutton within rf_entradas_compras
end type
type pb_menos_pallet from picturebutton within rf_entradas_compras
end type
type pb_mas_piezas from picturebutton within rf_entradas_compras
end type
type pb_mas_cajas from picturebutton within rf_entradas_compras
end type
type pb_mas_pallet from picturebutton within rf_entradas_compras
end type
type em_piezas from editmask within rf_entradas_compras
end type
type em_cajas from editmask within rf_entradas_compras
end type
type em_pallets from editmask within rf_entradas_compras
end type
type st_piezas from statictext within rf_entradas_compras
end type
type st_cajas from statictext within rf_entradas_compras
end type
type st_pallets from statictext within rf_entradas_compras
end type
type st_paso3 from statictext within rf_entradas_compras
end type
type uo_lectura_caja from u_sle_codbar within rf_entradas_compras
end type
type uo_lectura_pallet from u_sle_codbar within rf_entradas_compras
end type
end forward
...
string title = "MONTAR BULTO COMPRAS"
...
global rf_entradas_compras rf_entradas_compras

type variables
string is_tipo_movimiento = '3'
string is_almacen = '8'
string is_zona = 'A'
int    ii_fila = 1
int    ii_altura = 1
...
on rf_entradas_compras.destroy
destroy(this.pb_1)
...
if dec(em_piezas.text) > 0 then
	...
	if exito then
		...
		fallo = f_actualizar_coste_lote_entradas(lstr_movimiento_almacen.empresa, lstr_movimiento_almacen.articulo , sqlca, lstr_movimiento_almacen.tono , '1' , tipo_operacion, 'compras')
