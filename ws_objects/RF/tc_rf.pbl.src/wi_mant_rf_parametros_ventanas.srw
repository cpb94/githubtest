$PBExportHeader$wi_mant_rf_parametros_ventanas.srw
forward
global type wi_mant_rf_parametros_ventanas from wi_mant_ventanas
end type
type pb_calculadora from u_calculadora within wi_mant_rf_parametros_ventanas
end type
type p_1 from picture within wi_mant_rf_parametros_ventanas
end type
type cb_prueba from commandbutton within wi_mant_rf_parametros_ventanas
end type
end forward
...
global wi_mant_rf_parametros_ventanas wi_mant_rf_parametros_ventanas
...
on wi_mant_rf_parametros_ventanas.create
int iCurrent
call super::create
this.pb_calculadora=create pb_calculadora
this.p_1=create p_1
this.cb_prueba=create cb_prueba
iCurrent=UpperBound(this.Control)
this.Control[iCurrent+1]=this.pb_calculadora
this.Control[iCurrent+2]=this.p_1
this.Control[iCurrent+3]=this.cb_prueba
end on

on wi_mant_rf_parametros_ventanas.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.pb_calculadora)
destroy(this.p_1)
destroy(this.cb_prueba)
end on
...
type dw_1 from wi_mant_ventanas`dw_1 within wi_mant_rf_parametros_ventanas
integer x = 32
integer y = 132
integer width = 3387
integer height = 3148
string title = "Cabecera Orden"
string dataobject = "dw_mant_rf_parametros_ventanas"
...
str_rf_parametros_ventanas lstr_rf_parametros_ventanas
...
CHOOSE CASE dwo.name
	CASE "copiar_de"
		...
		if ll_copiar_de <> 0 and ll_copiar_de <> ll_id then
			if f_cargar_str_rf_parametros_ventanas(ll_copiar_de,lstr_rf_parametros_ventanas) then		
				f_inicializar_str_rf_parametros_ventanas(lstr_rf_parametros_ventanas)
				/*
				this.object.id[row]                              = lstr_rf_parametros_ventanas.id
				this.object.empresa[row]                         = lstr_rf_parametros_ventanas.empresa
				*/
				if this.object.descripcion[row] = "" or isnull(this.object.descripcion[row]) then
					this.object.descripcion[row]                  = lstr_rf_parametros_ventanas.descripcion
				end if
				this.object.texto_ventana[row]                   = lstr_rf_parametros_ventanas.texto_ventana
				this.object.tipo_ventana[row]                    = lstr_rf_parametros_ventanas.tipo_ventana
				this.object.ayuda_ventana[row]                   = lstr_rf_parametros_ventanas.ayuda_ventana
				this.object.texto_paso1[row]                     = lstr_rf_parametros_ventanas.texto_paso1
				this.object.texto_paso2[row]                     = lstr_rf_parametros_ventanas.texto_paso2
				this.object.texto_paso3[row]                     = lstr_rf_parametros_ventanas.texto_paso3
				this.object.ayuda_paso1[row]                     = lstr_rf_parametros_ventanas.ayuda_paso1
				this.object.ayuda_paso2[row]                     = lstr_rf_parametros_ventanas.ayuda_paso2
				this.object.ayuda_paso3[row]                     = lstr_rf_parametros_ventanas.ayuda_paso3
				this.object.tipo_movimiento_entrada[row]         = lstr_rf_parametros_ventanas.tipo_movimiento_entrada
				this.object.sugerir_ubicacion_entrada[row]       = lstr_rf_parametros_ventanas.sugerir_ubicacion_entrada
				this.object.entrada_ubicacion_fija[row]          = lstr_rf_parametros_ventanas.entrada_ubicacion_fija
				this.object.almacen_entrada[row]                 = lstr_rf_parametros_ventanas.almacen_entrada
				this.object.zona_entrada[row]                    = lstr_rf_parametros_ventanas.zona_entrada
				this.object.fila_entrada[row]                    = lstr_rf_parametros_ventanas.fila_entrada
				this.object.altura_entrada[row]                  = lstr_rf_parametros_ventanas.altura_entrada
				this.object.tipo_movimiento_salida[row]          = lstr_rf_parametros_ventanas.tipo_movimiento_salida
				this.object.salida_ubicacion_fija[row]           = lstr_rf_parametros_ventanas.salida_ubicacion_fija
				this.object.almacen_salida[row]                  = lstr_rf_parametros_ventanas.almacen_salida
				this.object.zona_salida[row]                     = lstr_rf_parametros_ventanas.zona_salida
				this.object.fila_salida[row]                     = lstr_rf_parametros_ventanas.fila_salida
				this.object.altura_salida[row]                   = lstr_rf_parametros_ventanas.altura_salida
				this.object.permitir_en_bulto_con_lineas[row]    = lstr_rf_parametros_ventanas.permitir_en_bulto_con_lineas
				this.object.tipologia_articulo[row]              = lstr_rf_parametros_ventanas.tipologia_articulo
				this.object.permitir_en_bulto_de_ubicacion[row]  = lstr_rf_parametros_ventanas.permitir_en_bulto_de_ubicacion
				this.object.mostrar_contenido_bulto_entrada[row] = lstr_rf_parametros_ventanas.mostrar_contenido_bulto_entrada
				this.object.entrada_consume_cajas[row]           = lstr_rf_parametros_ventanas.entrada_consume_cajas
			else
				return 2
			end if
		else
...
CHOOSE CASE bus_campo
	CASE "copiar_de"
		...
		bus_datawindow = "dw_ayuda_rf_parametros_ventanas"
		bus_filtro     =  ""
	CASE "tipo_movimiento_entrada"	
...
type st_1 from wi_mant_ventanas`st_1 within wi_mant_rf_parametros_ventanas
integer x = 23
integer y = 24
integer width = 123
string text = "ID"
...
type cb_insertar from wi_mant_ventanas`cb_insertar within wi_mant_rf_parametros_ventanas
integer x = 2080
integer y = 20
end type
...
type cb_borrar from wi_mant_ventanas`cb_borrar within wi_mant_rf_parametros_ventanas
integer x = 2482
integer y = 20
end type
...
type sle_valor from wi_mant_ventanas`sle_valor within wi_mant_rf_parametros_ventanas
integer x = 146
integer y = 20
end type

event sle_valor::getfocus;call super::getfocus;ue_titulo         = "AYUDA SELECCION PARAMETROS RF"
ue_datawindow     = "dw_ayuda_rf_parametros_ventanas"
ue_filtro         =  ""
valor_empresa     = true
isle_campo        = This
...
type cb_salir from wi_mant_ventanas`cb_salir within wi_mant_rf_parametros_ventanas
integer x = 2885
integer y = 20
end type

type control_tabulador from wi_mant_ventanas`control_tabulador within wi_mant_rf_parametros_ventanas
end type
...
string text = "Prueba Ventana"
end type

event clicked;string ls_ventana
window lw_ventana 
str_parametros lstr_param 

if dw_1.rowcount() = 1 then
	lstr_param.i_nargumentos   = 2
	lstr_param.s_argumentos[2] = string(dw_1.object.id[1])
	
	ls_ventana = dw_1.object.tipo_ventana[1]

	OpenWithParm(lw_ventana, lstr_param , ls_ventana)
