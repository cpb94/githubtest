$PBExportHeader$rf_traspasos.srw
forward
global type rf_traspasos from window
end type
type pb_aceptar from picturebutton within rf_traspasos
end type
type uo_lectura_destino from u_sle_codbar within rf_traspasos
end type
type uo_lectura_origen from u_sle_codbar within rf_traspasos
end type
end forward
...
global rf_traspasos rf_traspasos
