$PBExportHeader$w_inicio_rf_global.srw
forward
global type w_inicio_rf_global from w_ventana_padre_inicio
end type
type cb_1 from commandbutton within w_inicio_rf_global
end type
type cb_3 from commandbutton within w_inicio_rf_global
end type
type cb_5 from commandbutton within w_inicio_rf_global
end type
type cb_7 from commandbutton within w_inicio_rf_global
end type
type cb_9 from commandbutton within w_inicio_rf_global
end type
type cb_10 from commandbutton within w_inicio_rf_global
end type
type cb_2 from commandbutton within w_inicio_rf_global
end type
type st_empresa from statictext within w_inicio_rf_global
end type
type cb_6 from commandbutton within w_inicio_rf_global
end type
type cb_11 from commandbutton within w_inicio_rf_global
end type
type cb_4 from commandbutton within w_inicio_rf_global
end type
type cb_8 from commandbutton within w_inicio_rf_global
end type
type cb_12 from commandbutton within w_inicio_rf_global
end type
type cb_13 from commandbutton within w_inicio_rf_global
end type
type cb_14 from commandbutton within w_inicio_rf_global
end type
type cb_15 from commandbutton within w_inicio_rf_global
end type
type cb_16 from commandbutton within w_inicio_rf_global
end type
type st_1 from statictext within w_inicio_rf_global
end type
type st_2 from statictext within w_inicio_rf_global
end type
type st_3 from statictext within w_inicio_rf_global
end type
type cb_17 from commandbutton within w_inicio_rf_global
end type
type cb_18 from commandbutton within w_inicio_rf_global
end type
type r_1 from rectangle within w_inicio_rf_global
end type
type r_2 from rectangle within w_inicio_rf_global
end type
type r_3 from rectangle within w_inicio_rf_global
end type
end forward
...
global w_inicio_rf_global w_inicio_rf_global

type variables
boolean ib_nueva_gestion_activa = true
end variables
...
type pb_salir from w_ventana_padre_inicio`pb_salir within w_inicio_rf_global
integer x = 4037
integer y = 2152
integer width = 608
integer height = 504
...
if nombre_usuario = 'PRF' or nombre_usuario = 'T02' or nombre_usuario = 'T03' or ib_nueva_gestion_activa then
