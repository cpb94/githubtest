$PBExportHeader$rf_salidas_consumo_produccion.srw
forward
global type rf_salidas_consumo_produccion from window
end type
type em_piezas_disponibles_totales from editmask within rf_salidas_consumo_produccion
end type
type st_piezas_disponibles_totales from statictext within rf_salidas_consumo_produccion
end type
type em_piezas_reservadas from editmask within rf_salidas_consumo_produccion
end type
type st_piezas_reservadas from statictext within rf_salidas_consumo_produccion
end type
type em_piezas_disponibles from editmask within rf_salidas_consumo_produccion
end type
type st_piezas_disponibles from statictext within rf_salidas_consumo_produccion
end type
type st_pallets from statictext within rf_salidas_consumo_produccion
end type
type st_cajas from statictext within rf_salidas_consumo_produccion
end type
type st_piezas from statictext within rf_salidas_consumo_produccion
end type
type em_pallets from editmask within rf_salidas_consumo_produccion
end type
type em_cajas from editmask within rf_salidas_consumo_produccion
end type
type em_piezas from editmask within rf_salidas_consumo_produccion
end type
type pb_mas_pallet from picturebutton within rf_salidas_consumo_produccion
end type
type pb_mas_cajas from picturebutton within rf_salidas_consumo_produccion
end type
type pb_mas_piezas from picturebutton within rf_salidas_consumo_produccion
end type
type pb_menos_pallet from picturebutton within rf_salidas_consumo_produccion
end type
type pb_menos_cajas from picturebutton within rf_salidas_consumo_produccion
end type
type pb_menos_piezas from picturebutton within rf_salidas_consumo_produccion
end type
type pb_atras from picturebutton within rf_salidas_consumo_produccion
end type
type st_paso3 from statictext within rf_salidas_consumo_produccion
end type
type st_paso1 from statictext within rf_salidas_consumo_produccion
end type
type pb_1 from picturebutton within rf_salidas_consumo_produccion
end type
type pb_aceptar from picturebutton within rf_salidas_consumo_produccion
end type
type uo_lectura_origen from u_sle_codbar within rf_salidas_consumo_produccion
end type
type st_paso2 from statictext within rf_salidas_consumo_produccion
end type
end forward
...
string title = "Salidas Consumo Producción"
...
global rf_salidas_consumo_produccion rf_salidas_consumo_produccion

type variables
string is_tipo_movimiento_salida  = '209'
string is_tipo_movimiento_entrada = ''
long   il_color_fondo_activo,il_color_fondo_inactivo
int    ii_paso_actual = 1
end variables

on rf_salidas_consumo_produccion.create
...
on rf_salidas_consumo_produccion.destroy
