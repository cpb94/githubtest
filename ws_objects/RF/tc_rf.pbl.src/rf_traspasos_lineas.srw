$PBExportHeader$rf_traspasos_lineas.srw
forward
global type rf_traspasos_lineas from window
end type
type pb_menos_piezas from picturebutton within rf_traspasos_lineas
end type
type pb_menos_cajas from picturebutton within rf_traspasos_lineas
end type
type pb_menos_pallet from picturebutton within rf_traspasos_lineas
end type
type pb_mas_piezas from picturebutton within rf_traspasos_lineas
end type
type pb_mas_cajas from picturebutton within rf_traspasos_lineas
end type
type pb_mas_pallet from picturebutton within rf_traspasos_lineas
end type
type em_piezas from editmask within rf_traspasos_lineas
end type
type em_cajas from editmask within rf_traspasos_lineas
end type
type em_pallets from editmask within rf_traspasos_lineas
end type
type st_piezas from statictext within rf_traspasos_lineas
end type
type st_cajas from statictext within rf_traspasos_lineas
end type
type st_pallets from statictext within rf_traspasos_lineas
end type
type pb_salir from picturebutton within rf_traspasos_lineas
end type
type st_paso3 from statictext within rf_traspasos_lineas
end type
type st_paso2 from statictext within rf_traspasos_lineas
end type
type st_paso1 from statictext within rf_traspasos_lineas
end type
type pb_atras from picturebutton within rf_traspasos_lineas
end type
type pb_aceptar from picturebutton within rf_traspasos_lineas
end type
type uo_lectura_destino from u_sle_codbar within rf_traspasos_lineas
end type
type uo_lectura_origen from u_sle_codbar within rf_traspasos_lineas
end type
end forward
...
global rf_traspasos_lineas rf_traspasos_lineas
...
this.Control[]={this.pb_menos_piezas,&
this.pb_menos_cajas,&
...
on rf_traspasos_lineas.destroy
