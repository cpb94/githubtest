$PBExportHeader$rf_devoluciones_de_articulos.srw
forward
global type rf_devoluciones_de_articulos from window
end type
type pb_1 from picturebutton within rf_devoluciones_de_articulos
end type
type pb_atras from picturebutton within rf_devoluciones_de_articulos
end type
type st_paso1 from statictext within rf_devoluciones_de_articulos
end type
type st_paso2 from statictext within rf_devoluciones_de_articulos
end type
type pb_aceptar from picturebutton within rf_devoluciones_de_articulos
end type
type pb_menos_piezas from picturebutton within rf_devoluciones_de_articulos
end type
type pb_menos_cajas from picturebutton within rf_devoluciones_de_articulos
end type
type pb_menos_pallet from picturebutton within rf_devoluciones_de_articulos
end type
type pb_mas_piezas from picturebutton within rf_devoluciones_de_articulos
end type
type pb_mas_cajas from picturebutton within rf_devoluciones_de_articulos
end type
type pb_mas_pallet from picturebutton within rf_devoluciones_de_articulos
end type
type em_piezas from editmask within rf_devoluciones_de_articulos
end type
type em_cajas from editmask within rf_devoluciones_de_articulos
end type
type em_pallets from editmask within rf_devoluciones_de_articulos
end type
type st_piezas from statictext within rf_devoluciones_de_articulos
end type
type st_cajas from statictext within rf_devoluciones_de_articulos
end type
type st_pallets from statictext within rf_devoluciones_de_articulos
end type
type st_paso3 from statictext within rf_devoluciones_de_articulos
end type
type uo_lectura_caja from u_sle_codbar within rf_devoluciones_de_articulos
end type
type uo_lectura_pallet from u_sle_codbar within rf_devoluciones_de_articulos
end type
end forward
...
global rf_devoluciones_de_articulos rf_devoluciones_de_articulos
...
on rf_devoluciones_de_articulos.create
...
on rf_devoluciones_de_articulos.destroy
destroy(this.pb_1)
