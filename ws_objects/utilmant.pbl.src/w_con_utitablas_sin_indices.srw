$PBExportHeader$w_con_utitablas_sin_indices.srw
forward
global type w_con_utitablas_sin_indices from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_utitablas_sin_indices
end type
type dw_consulta from datawindow within w_con_utitablas_sin_indices
end type
type dw_listado from datawindow within w_con_utitablas_sin_indices
end type
type pb_2 from upb_imprimir within w_con_utitablas_sin_indices
end type
type dw_consulta2 from datawindow within w_con_utitablas_sin_indices
end type
type em_tabla from u_em_campo within w_con_utitablas_sin_indices
end type
type st_1 from statictext within w_con_utitablas_sin_indices
end type
type dw_consulta3 from datawindow within w_con_utitablas_sin_indices
end type
type cb_1 from u_boton within w_con_utitablas_sin_indices
end type
type dw_consulta4 from datawindow within w_con_utitablas_sin_indices
end type
end forward
...
global w_con_utitablas_sin_indices w_con_utitablas_sin_indices
...
on w_con_utitablas_sin_indices.create
int iCurrent
call super::create
...
on w_con_utitablas_sin_indices.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_utitablas_sin_indices
integer taborder = 20
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_utitablas_sin_indices
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_utitablas_sin_indices
integer x = 27
integer y = 8
integer width = 2427
end type
...
string dataobject = "dw_con_utitablas_sin_indices"
...
integer height = 700
boolean bringtotop = true
string dataobject = "dw_con_utitcolumnas_sin_indices"
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = styleraised!
end type
...
integer height = 416
boolean bringtotop = true
string dataobject = "dw_con_utitindices_sin_indices"
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = styleraised!
end type
