$PBExportHeader$w_utilidad_arbol.srw
forward
global type w_utilidad_arbol from window
end type
type st_titulo from statictext within w_utilidad_arbol
end type
type tv_menu from treeview within w_utilidad_arbol
end type
end forward
...
global w_utilidad_arbol w_utilidad_arbol

event open;string titulo

f_cargar_menu_arbol (w_utilidad, tv_menu, titulo)
st_titulo.text = 'Utilidades'



end event

on w_utilidad_arbol.create
