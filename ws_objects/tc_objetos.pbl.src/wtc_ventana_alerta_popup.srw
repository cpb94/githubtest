$PBExportHeader$wtc_ventana_alerta_popup.srw
forward
global type wtc_ventana_alerta_popup from window
end type
type st_subtitulo from statictext within wtc_ventana_alerta_popup
end type
type cb_3 from commandbutton within wtc_ventana_alerta_popup
end type
type cb_2 from commandbutton within wtc_ventana_alerta_popup
end type
type cb_1 from commandbutton within wtc_ventana_alerta_popup
end type
type st_texto from statictext within wtc_ventana_alerta_popup
end type
type p_3 from picture within wtc_ventana_alerta_popup
end type
type p_2 from picture within wtc_ventana_alerta_popup
end type
type p_1 from picture within wtc_ventana_alerta_popup
end type
end forward
...
global wtc_ventana_alerta_popup wtc_ventana_alerta_popup

on wtc_ventana_alerta_popup.create
...
on wtc_ventana_alerta_popup.destroy
...
elseif parametros.tipo = 3 then
	...
	st_texto.textcolor = rgb(0,0,0)
	st_subtitulo.textcolor = rgb(0,0,0)
end if
