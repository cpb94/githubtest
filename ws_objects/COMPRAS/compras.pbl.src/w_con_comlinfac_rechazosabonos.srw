$PBExportHeader$w_con_comlinfac_rechazosabonos.srw
forward
global type w_con_comlinfac_rechazosabonos from w_int_con_empresa
end type
type uo_proveedor from u_em_campo_2 within w_con_comlinfac_rechazosabonos
end type
type uo_manejo from u_manejo_datawindow within w_con_comlinfac_rechazosabonos
end type
type gb_1 from groupbox within w_con_comlinfac_rechazosabonos
end type
type cb_3 from commandbutton within w_con_comlinfac_rechazosabonos
end type
type dw_1 from u_datawindow within w_con_comlinfac_rechazosabonos
end type
type em_desde from u_em_campo within w_con_comlinfac_rechazosabonos
end type
type em_hasta from u_em_campo within w_con_comlinfac_rechazosabonos
end type
type gb_3 from groupbox within w_con_comlinfac_rechazosabonos
end type
type pb_1 from upb_salir within w_con_comlinfac_rechazosabonos
end type
type dw_listado from u_datawindow within w_con_comlinfac_rechazosabonos
end type
type gb_5 from groupbox within w_con_comlinfac_rechazosabonos
end type
end forward
...
global w_con_comlinfac_rechazosabonos w_con_comlinfac_rechazosabonos

type variables
string estado
end variables

event open;call super::open;istr_parametros.s_titulo_ventana="Líneas Rechazadas + Abonos"
...
on w_con_comlinfac_rechazosabonos.create
int iCurrent
call super::create
...
on w_con_comlinfac_rechazosabonos.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_comlinfac_rechazosabonos
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_comlinfac_rechazosabonos
end type

event sle_opcion_orden::getfocus;call super::getfocus;f_activar_campo(uo_proveedor.em_campo)
end event

type st_empresa from w_int_con_empresa`st_empresa within w_con_comlinfac_rechazosabonos
integer x = 41
integer y = 12
integer width = 2679
end type
...
integer height = 1288
integer taborder = 60
string dataobject = "dw_con_comlinfac_rechazosabonos"
