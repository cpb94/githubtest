$PBExportHeader$w_pedir_ubicaciones.srw
$PBExportComments$Ventana de peticion ubicaciones en Confirmacion albaranes
forward
global type w_pedir_ubicaciones from w_int_con_empresa
end type
type dw_1 from datawindow within w_pedir_ubicaciones
end type
type st_8 from statictext within w_pedir_ubicaciones
end type
type gb_5 from groupbox within w_pedir_ubicaciones
end type
type gb_4 from groupbox within w_pedir_ubicaciones
end type
type gb_3 from groupbox within w_pedir_ubicaciones
end type
type gb_2 from groupbox within w_pedir_ubicaciones
end type
type cb_1 from commandbutton within w_pedir_ubicaciones
end type
type cb_2 from commandbutton within w_pedir_ubicaciones
end type
type gb_1 from groupbox within w_pedir_ubicaciones
end type
type st_cli from statictext within w_pedir_ubicaciones
end type
type st_fecha from statictext within w_pedir_ubicaciones
end type
type st_anyo from statictext within w_pedir_ubicaciones
end type
type st_alb from statictext within w_pedir_ubicaciones
end type
type st_1 from statictext within w_pedir_ubicaciones
end type
type gb_6 from groupbox within w_pedir_ubicaciones
end type
type p_1 from picture within w_pedir_ubicaciones
end type
end forward
...
global w_pedir_ubicaciones w_pedir_ubicaciones
...
on w_pedir_ubicaciones.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_pedir_ubicaciones
integer taborder = 90
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_pedir_ubicaciones
end type

type st_empresa from w_int_con_empresa`st_empresa within w_pedir_ubicaciones
integer x = 37
integer y = 28
integer width = 2432
end type
