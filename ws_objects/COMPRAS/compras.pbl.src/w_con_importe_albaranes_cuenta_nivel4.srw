$PBExportHeader$w_con_importe_albaranes_cuenta_nivel4.srw
forward
global type w_con_importe_albaranes_cuenta_nivel4 from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_importe_albaranes_cuenta_nivel4
end type
type cb_consulta from u_boton within w_con_importe_albaranes_cuenta_nivel4
end type
type pb_imprimir_preli from picturebutton within w_con_importe_albaranes_cuenta_nivel4
end type
type dw_listado from datawindow within w_con_importe_albaranes_cuenta_nivel4
end type
type dw_1 from datawindow within w_con_importe_albaranes_cuenta_nivel4
end type
type gb_1 from groupbox within w_con_importe_albaranes_cuenta_nivel4
end type
type gb_vto from groupbox within w_con_importe_albaranes_cuenta_nivel4
end type
type st_4 from statictext within w_con_importe_albaranes_cuenta_nivel4
end type
type em_fhasta from editmask within w_con_importe_albaranes_cuenta_nivel4
end type
type em_fdesde from editmask within w_con_importe_albaranes_cuenta_nivel4
end type
type st_6 from statictext within w_con_importe_albaranes_cuenta_nivel4
end type
type ddlb_1 from dropdownlistbox within w_con_importe_albaranes_cuenta_nivel4
end type
type st_1 from statictext within w_con_importe_albaranes_cuenta_nivel4
end type
type cbx_resumido from checkbox within w_con_importe_albaranes_cuenta_nivel4
end type
end forward
...
global w_con_importe_albaranes_cuenta_nivel4 w_con_importe_albaranes_cuenta_nivel4
...
This.title = "Albaranes Pendientes por Cuenta"
...
on w_con_importe_albaranes_cuenta_nivel4.create
int iCurrent
call super::create
...
on w_con_importe_albaranes_cuenta_nivel4.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_importe_albaranes_cuenta_nivel4
integer x = 594
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_importe_albaranes_cuenta_nivel4
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_importe_albaranes_cuenta_nivel4
integer x = 64
integer y = 8
integer height = 96
end type
...
integer width = 3195
integer height = 2760
string dataobject = "dw_con_importe_albaranes_cuenta_nivel4"
