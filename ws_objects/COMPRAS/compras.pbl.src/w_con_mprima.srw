$PBExportHeader$w_con_mprima.srw
$PBExportComments$Consulta/Listado Materias
forward
global type w_con_mprima from w_int_con_empresa
end type
type pb_1 from upb_salir within w_con_mprima
end type
type st_fpedido1 from statictext within w_con_mprima
end type
type uo_manejo from u_manejo_datawindow within w_con_mprima
end type
type dw_listado_mprima from datawindow within w_con_mprima
end type
type pb_imprimir from upb_imprimir within w_con_mprima
end type
type em_fpedido1 from u_em_campo within w_con_mprima
end type
type st_fpedido2 from statictext within w_con_mprima
end type
type em_fpedido2 from u_em_campo within w_con_mprima
end type
type dw_mprima from datawindow within w_con_mprima
end type
type gb_2 from groupbox within w_con_mprima
end type
type gb_1 from groupbox within w_con_mprima
end type
type cb_1 from commandbutton within w_con_mprima
end type
type st_prodd from statictext within w_con_mprima
end type
type st_prodh from statictext within w_con_mprima
end type
end forward
...
global w_con_mprima w_con_mprima

type variables
string filtro
end variables

event open;call super::open;istr_parametros.s_titulo_ventana="Consulta de Artículos"
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_mprima
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_mprima
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_mprima
integer y = 8
integer width = 2679
end type
...
integer height = 140
boolean bringtotop = true
string dataobject = "report_venmprima"
...
event modificado;call super::modificado;st_prodh.text = f_nombre_tipo_materia(codigo_empresa, Trim(em_fpedido2.text))
end event
...
integer height = 960
boolean bringtotop = true
string dataobject = "dw_con_mprima"
