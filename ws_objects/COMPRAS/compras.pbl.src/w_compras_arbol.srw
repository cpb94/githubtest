$PBExportHeader$w_compras_arbol.srw
forward
global type w_compras_arbol from window
end type
type st_titulo from statictext within w_compras_arbol
end type
type tv_menu from treeview within w_compras_arbol
end type
end forward
...
global w_compras_arbol w_compras_arbol

event open;string titulo

f_cargar_menu_arbol (w_compras, tv_menu, titulo)
st_titulo.text = 'Compras'



end event

on w_compras_arbol.create
