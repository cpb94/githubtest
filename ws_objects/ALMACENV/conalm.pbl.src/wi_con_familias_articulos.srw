$PBExportHeader$wi_con_familias_articulos.srw
forward
global type wi_con_familias_articulos from w_int_con_empresa
end type
type st_1 from statictext within wi_con_familias_articulos
end type
type uo_1 from u_em_campo_2 within wi_con_familias_articulos
end type
type dw_1 from datawindow within wi_con_familias_articulos
end type
type dw_listado from datawindow within wi_con_familias_articulos
end type
type pb_imprimir from upb_imprimir within wi_con_familias_articulos
end type
type uo_manejo from u_manejo_datawindow within wi_con_familias_articulos
end type
type pb_2 from upb_carpeta within wi_con_familias_articulos
end type
type pb_1 from upb_salir within wi_con_familias_articulos
end type
end forward
...
global wi_con_familias_articulos wi_con_familias_articulos

on wi_con_familias_articulos.create
int iCurrent
call super::create
...
on wi_con_familias_articulos.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within wi_con_familias_articulos
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within wi_con_familias_articulos
integer taborder = 30
end type
...
type st_empresa from w_int_con_empresa`st_empresa within wi_con_familias_articulos
end type
...
integer height = 1112
boolean bringtotop = true
string dataobject = "dw_con_familias_articulos"
