$PBExportHeader$w_con_movimientos_tipo_falbaran.srw
forward
global type w_con_movimientos_tipo_falbaran from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_movimientos_tipo_falbaran
end type
type uo_tipo from u_marca_lista within w_con_movimientos_tipo_falbaran
end type
type dw_proceso from datawindow within w_con_movimientos_tipo_falbaran
end type
type uo_1 from u_manejo_datawindow within w_con_movimientos_tipo_falbaran
end type
type pb_imprimir_preli from picturebutton within w_con_movimientos_tipo_falbaran
end type
type dw_1 from datawindow within w_con_movimientos_tipo_falbaran
end type
type st_8 from statictext within w_con_movimientos_tipo_falbaran
end type
type em_fechadesde from u_em_campo within w_con_movimientos_tipo_falbaran
end type
type st_9 from statictext within w_con_movimientos_tipo_falbaran
end type
type gb_1 from groupbox within w_con_movimientos_tipo_falbaran
end type
type em_fechahasta from u_em_campo within w_con_movimientos_tipo_falbaran
end type
type cb_1 from u_boton within w_con_movimientos_tipo_falbaran
end type
type cb_consulta from u_boton within w_con_movimientos_tipo_falbaran
end type
type gb_2 from groupbox within w_con_movimientos_tipo_falbaran
end type
type dw_almlinubicahis from datawindow within w_con_movimientos_tipo_falbaran
end type
type dw_listado from datawindow within w_con_movimientos_tipo_falbaran
end type
type agrupar from checkbox within w_con_movimientos_tipo_falbaran
end type
end forward
...
integer width = 2953
integer height = 2152
string title = "Consulta movimientos de ventas entre fechas de albaran"
pb_2 pb_2
uo_tipo uo_tipo
...
global w_con_movimientos_tipo_falbaran w_con_movimientos_tipo_falbaran
...
This.title = "Consulta movimientos de ventas entre fechas de albaran"
...
on w_con_movimientos_tipo_falbaran.create
int iCurrent
call super::create
...
on w_con_movimientos_tipo_falbaran.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_movimientos_tipo_falbaran
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_movimientos_tipo_falbaran
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_movimientos_tipo_falbaran
integer x = 27
integer y = 20
integer width = 2642
end type
...
integer height = 1624
integer taborder = 70
string dataobject = "dw_con_movimientos_tipo_falbaran"
...
event clicked;if agrupar.checked then
	if not v_agrupar then
		v_agrupar = true
		dw_1.dataobject ="dw_con_movimientos_tipo_falbaran2"
		dw_1.settransobject(sqlca)
	end if
else
	if v_agrupar then
		v_agrupar = false
		dw_1.dataobject ="dw_con_movimientos_tipo_falbaran"
		dw_1.settransobject(sqlca)
	end if
end if
