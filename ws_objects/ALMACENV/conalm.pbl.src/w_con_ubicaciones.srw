$PBExportHeader$w_con_ubicaciones.srw
$PBExportComments$Material por ubicación
forward
global type w_con_ubicaciones from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_ubicaciones
end type
type dw_proceso from datawindow within w_con_ubicaciones
end type
type dw_listado from datawindow within w_con_ubicaciones
end type
type pb_imprimir_preli from picturebutton within w_con_ubicaciones
end type
type dw_1 from datawindow within w_con_ubicaciones
end type
type uo_1 from u_manejo_datawindow within w_con_ubicaciones
end type
type dw_almacenes from datawindow within w_con_ubicaciones
end type
type dw_zonas from datawindow within w_con_ubicaciones
end type
type etiqueta1 from statictext within w_con_ubicaciones
end type
type etiqueta2 from statictext within w_con_ubicaciones
end type
type etiqueta3 from statictext within w_con_ubicaciones
end type
type em_pallets from u_em_campo within w_con_ubicaciones
end type
type em_cajas from u_em_campo within w_con_ubicaciones
end type
type em_total_cajas from u_em_campo within w_con_ubicaciones
end type
type etiqueta4 from statictext within w_con_ubicaciones
end type
type em_cantidad from u_em_campo within w_con_ubicaciones
end type
end forward
...
global w_con_ubicaciones w_con_ubicaciones
...
event activate;call super::activate;w_con_ubicaciones = ventanas_activas[id_ventana_activa].ventana
end event

type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_ubicaciones
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_ubicaciones
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_ubicaciones
integer x = 27
integer y = 20
integer width = 4334
end type
