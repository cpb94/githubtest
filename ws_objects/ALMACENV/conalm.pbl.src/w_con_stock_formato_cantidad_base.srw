$PBExportHeader$w_con_stock_formato_cantidad_base.srw
$PBExportComments$Stock de Base
forward
global type w_con_stock_formato_cantidad_base from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_stock_formato_cantidad_base
end type
type dw_1 from u_datawindow_consultas within w_con_stock_formato_cantidad_base
end type
type cb_2 from commandbutton within w_con_stock_formato_cantidad_base
end type
type pb_imprimir_preli from upb_imprimir within w_con_stock_formato_cantidad_base
end type
type dw_2 from datawindow within w_con_stock_formato_cantidad_base
end type
type gb_2 from groupbox within w_con_stock_formato_cantidad_base
end type
type uo_1 from u_em_campo_2 within w_con_stock_formato_cantidad_base
end type
type em_cuanto from u_em_campo within w_con_stock_formato_cantidad_base
end type
type ddlb_1 from dropdownlistbox within w_con_stock_formato_cantidad_base
end type
type gb_3 from groupbox within w_con_stock_formato_cantidad_base
end type
end forward
...
global w_con_stock_formato_cantidad_base w_con_stock_formato_cantidad_base
...
This.title = " CONSULTA STOCK POR FORMATO BASE"
ddlb_1.text =">"
end event

on w_con_stock_formato_cantidad_base.create
int iCurrent
call super::create
...
on w_con_stock_formato_cantidad_base.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_stock_formato_cantidad_base
integer taborder = 70
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_stock_formato_cantidad_base
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_stock_formato_cantidad_base
integer y = 20
integer width = 2587
integer height = 92
end type
...
integer height = 1104
integer taborder = 80
string dataobject = "dw_con_stock_iniciales_base"
...
integer taborder = 50
boolean bringtotop = true
string dataobject = "report_con_stock_formato_cantidad_base"
