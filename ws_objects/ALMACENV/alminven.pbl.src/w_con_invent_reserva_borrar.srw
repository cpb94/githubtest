$PBExportHeader$w_con_invent_reserva_borrar.srw
forward
global type w_con_invent_reserva_borrar from w_int_con_empresa
end type
type st_2 from statictext within w_con_invent_reserva_borrar
end type
type dw_1 from datawindow within w_con_invent_reserva_borrar
end type
type pb_1 from upb_salir within w_con_invent_reserva_borrar
end type
type cb_2 from u_boton within w_con_invent_reserva_borrar
end type
type cb_3 from u_boton within w_con_invent_reserva_borrar
end type
type report_alminvent from datawindow within w_con_invent_reserva_borrar
end type
type dw_proceso from datawindow within w_con_invent_reserva_borrar
end type
type em_periodo from u_em_campo within w_con_invent_reserva_borrar
end type
type dw_inv from u_datawindow within w_con_invent_reserva_borrar
end type
end forward
...
global w_con_invent_reserva_borrar w_con_invent_reserva_borrar
...
on w_con_invent_reserva_borrar.create
int iCurrent
call super::create
...
on w_con_invent_reserva_borrar.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_invent_reserva_borrar
integer taborder = 20
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_invent_reserva_borrar
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_invent_reserva_borrar
integer y = 16
integer width = 2601
end type
