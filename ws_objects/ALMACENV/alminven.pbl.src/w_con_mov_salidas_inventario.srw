$PBExportHeader$w_con_mov_salidas_inventario.srw
forward
global type w_con_mov_salidas_inventario from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_mov_salidas_inventario
end type
type uo_1 from u_manejo_datawindow within w_con_mov_salidas_inventario
end type
type pb_imprimir_preli from picturebutton within w_con_mov_salidas_inventario
end type
type dw_1 from datawindow within w_con_mov_salidas_inventario
end type
type em_fechadesde from u_em_campo within w_con_mov_salidas_inventario
end type
type dw_listado from datawindow within w_con_mov_salidas_inventario
end type
type cb_consulta from u_boton within w_con_mov_salidas_inventario
end type
type gb_2 from groupbox within w_con_mov_salidas_inventario
end type
type st_3 from statictext within w_con_mov_salidas_inventario
end type
type uo_articulo from u_em_campo_2 within w_con_mov_salidas_inventario
end type
type st_6 from statictext within w_con_mov_salidas_inventario
end type
type uo_calidad from u_em_campo_2 within w_con_mov_salidas_inventario
end type
type st_5 from statictext within w_con_mov_salidas_inventario
end type
type em_tono from u_em_campo within w_con_mov_salidas_inventario
end type
type st_9 from statictext within w_con_mov_salidas_inventario
end type
type em_calibre from u_em_campo within w_con_mov_salidas_inventario
end type
type st_4 from statictext within w_con_mov_salidas_inventario
end type
type uo_tipopallet from u_em_campo_2 within w_con_mov_salidas_inventario
end type
type st_f3 from statictext within w_con_mov_salidas_inventario
end type
end forward
...
integer width = 2953
integer height = 2200
string title = "Consulta de movimientos - Salidas Inventario"
pb_2 pb_2
uo_1 uo_1
...
global w_con_mov_salidas_inventario w_con_mov_salidas_inventario
...
This.title = "Consulta de movimientos - Salidas Inventario"
...
on w_con_mov_salidas_inventario.create
int iCurrent
call super::create
...
on w_con_mov_salidas_inventario.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_mov_salidas_inventario
integer taborder = 50
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_mov_salidas_inventario
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_mov_salidas_inventario
integer x = 27
integer y = 20
integer width = 2642
end type
...
integer height = 1668
integer taborder = 70
string dataobject = "dw_con_mov_salidas_inventario"
...
integer width = 41
integer height = 40
string dataobject = "report_con_mov_salidas_inventario"
boolean livescroll = true
end type
