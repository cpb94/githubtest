$PBExportHeader$w_con_alminvent.srw
$PBExportComments$Consulta inventarios.
forward
global type w_con_alminvent from w_int_con_empresa
end type
type st_2 from statictext within w_con_alminvent
end type
type em_periodo from u_em_campo within w_con_alminvent
end type
type dw_1 from datawindow within w_con_alminvent
end type
type pb_1 from upb_salir within w_con_alminvent
end type
type dw_inv from datawindow within w_con_alminvent
end type
type cb_2 from u_boton within w_con_alminvent
end type
type cb_3 from u_boton within w_con_alminvent
end type
type dw_listado from datawindow within w_con_alminvent
end type
type dw_zonas from datawindow within w_con_alminvent
end type
type zonas from radiobutton within w_con_alminvent
end type
type gb_1 from groupbox within w_con_alminvent
end type
end forward
...
global w_con_alminvent w_con_alminvent
...
istr_parametros.s_titulo_ventana="Consulta inventarios"
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_alminvent
integer taborder = 20
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_alminvent
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_alminvent
integer y = 12
integer width = 2638
end type
...
integer width = 2793
integer height = 884
string dataobject = "dw_con_alminvent2"
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = styleraised!
end type
...
integer taborder = 70
boolean bringtotop = true
string dataobject = "report_alminvent"
boolean livescroll = true
end type
