$PBExportHeader$w_int_etiquetas_doble_ean.srw
$PBExportComments$Etiquetas Doble EAN
forward
global type w_int_etiquetas_doble_ean from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_etiquetas_doble_ean
end type
type pb_imprimir_etiquetas from upb_imprimir within w_int_etiquetas_doble_ean
end type
type st_texto from statictext within w_int_etiquetas_doble_ean
end type
type gb_2 from groupbox within w_int_etiquetas_doble_ean
end type
type gb_1 from groupbox within w_int_etiquetas_doble_ean
end type
type st_666 from statictext within w_int_etiquetas_doble_ean
end type
type uo_articulo from u_em_campo_2 within w_int_etiquetas_doble_ean
end type
type uo_texto1 from u_em_campo_2 within w_int_etiquetas_doble_ean
end type
type st_66 from statictext within w_int_etiquetas_doble_ean
end type
type dw_1 from u_datawindow_consultas within w_int_etiquetas_doble_ean
end type
type sle_tc from singlelineedit within w_int_etiquetas_doble_ean
end type
type st_1 from statictext within w_int_etiquetas_doble_ean
end type
type sle_texto_cliente from singlelineedit within w_int_etiquetas_doble_ean
end type
type st_3 from statictext within w_int_etiquetas_doble_ean
end type
type mle_observaciones from multilineedit within w_int_etiquetas_doble_ean
end type
type dw_informe from datawindow within w_int_etiquetas_doble_ean
end type
type cb_1 from commandbutton within w_int_etiquetas_doble_ean
end type
end forward
...
integer width = 1952
integer height = 1436
string title = "Impresión de etiquetas Anchas"
pb_1 pb_1
...
global w_int_etiquetas_doble_ean w_int_etiquetas_doble_ean
...
event open;call super::open;istr_parametros.s_titulo_ventana="Impresión de Etiquetas Anchas"
...
on w_int_etiquetas_doble_ean.create
int iCurrent
call super::create
...
on w_int_etiquetas_doble_ean.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_etiquetas_doble_ean
integer x = 27
integer y = 1216
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_etiquetas_doble_ean
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_etiquetas_doble_ean
integer x = 32
integer y = 28
integer width = 1687
integer height = 84
...
if f_cambia_impresora_predeterminada (impresora) then
	...
	if v_ean13 = "" then
		...
		dw_1.Modify("almartcajas_piezascaja.X=3201")
		dw_1.Modify("t_pzs.X=4736")
		dw_1.Modify("tono.X=3201")
		dw_1.Modify("articulos_cod_cliente.X=3201")
	end if
...
integer height = 408
integer taborder = 30
string dataobject = "report_etiquetas_ean_cliente"
