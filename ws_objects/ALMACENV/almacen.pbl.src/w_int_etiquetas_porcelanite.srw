$PBExportHeader$w_int_etiquetas_porcelanite.srw
$PBExportComments$Etiquetas Normales
forward
global type w_int_etiquetas_porcelanite from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_etiquetas_porcelanite
end type
type pb_imprimir_etiquetas from upb_imprimir within w_int_etiquetas_porcelanite
end type
type st_texto from statictext within w_int_etiquetas_porcelanite
end type
type gb_2 from groupbox within w_int_etiquetas_porcelanite
end type
type gb_1 from groupbox within w_int_etiquetas_porcelanite
end type
type uo_cliente from u_em_campo_2 within w_int_etiquetas_porcelanite
end type
type st_6 from statictext within w_int_etiquetas_porcelanite
end type
type st_666 from statictext within w_int_etiquetas_porcelanite
end type
type uo_articulo from u_em_campo_2 within w_int_etiquetas_porcelanite
end type
type uo_texto1 from u_em_campo_2 within w_int_etiquetas_porcelanite
end type
type st_66 from statictext within w_int_etiquetas_porcelanite
end type
type dw_1 from u_datawindow_consultas within w_int_etiquetas_porcelanite
end type
type cbx_codigobarras from checkbox within w_int_etiquetas_porcelanite
end type
type sle_tc from singlelineedit within w_int_etiquetas_porcelanite
end type
type st_1 from statictext within w_int_etiquetas_porcelanite
end type
type cbx_made from checkbox within w_int_etiquetas_porcelanite
end type
end forward
...
global w_int_etiquetas_porcelanite w_int_etiquetas_porcelanite
...
event open;call super::open;istr_parametros.s_titulo_ventana="Listado Etiquetas Normales Porcelanite"
...
on w_int_etiquetas_porcelanite.create
int iCurrent
call super::create
...
on w_int_etiquetas_porcelanite.destroy
call super::destroy
destroy(this.pb_1)
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_etiquetas_porcelanite
integer x = 37
integer y = 736
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_etiquetas_porcelanite
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_etiquetas_porcelanite
integer x = 32
integer y = 28
integer width = 1687
integer height = 84
...
event clicked;string articulo, v_ean13
...
integer height = 408
integer taborder = 20
string dataobject = "report_etiquetas_sin_ean_porcelanite"
