$PBExportHeader$w_int_eti_porcelanite_libre.srw
$PBExportComments$Etiquetas Texto Libre
forward
global type w_int_eti_porcelanite_libre from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_eti_porcelanite_libre
end type
type st_6 from statictext within w_int_eti_porcelanite_libre
end type
type em_texto1 from u_em_campo within w_int_eti_porcelanite_libre
end type
type em_texto3 from u_em_campo within w_int_eti_porcelanite_libre
end type
type em_texto4 from u_em_campo within w_int_eti_porcelanite_libre
end type
type em_texto2 from u_em_campo within w_int_eti_porcelanite_libre
end type
type gb_1 from groupbox within w_int_eti_porcelanite_libre
end type
type pb_imprimir_etiquetas from upb_imprimir within w_int_eti_porcelanite_libre
end type
type em_texto5 from u_em_campo within w_int_eti_porcelanite_libre
end type
type cbx_ean from checkbox within w_int_eti_porcelanite_libre
end type
type dw_etiqueta from datawindow within w_int_eti_porcelanite_libre
end type
type gb_2 from groupbox within w_int_eti_porcelanite_libre
end type
end forward
...
global w_int_eti_porcelanite_libre w_int_eti_porcelanite_libre
...
on w_int_eti_porcelanite_libre.create
int iCurrent
call super::create
...
on w_int_eti_porcelanite_libre.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_eti_porcelanite_libre
integer x = 59
integer y = 616
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_eti_porcelanite_libre
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_eti_porcelanite_libre
integer y = 24
integer width = 1778
integer height = 80
end type
...
if f_cambia_impresora_predeterminada (impresora) then
	if cbx_ean.checked then
		dw_etiqueta.DataObject = "report_eti_porcelanite_libre_ean"
	else
		dw_etiqueta.DataObject = "report_eti_porcelanite_libre"
	end if
