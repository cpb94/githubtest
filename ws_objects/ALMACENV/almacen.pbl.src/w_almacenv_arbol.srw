$PBExportHeader$w_almacenv_arbol.srw
forward
global type w_almacenv_arbol from window
end type
type st_titulo from statictext within w_almacenv_arbol
end type
type tv_menu from treeview within w_almacenv_arbol
end type
end forward
...
global w_almacenv_arbol w_almacenv_arbol

event open;string titulo

f_cargar_menu_arbol (w_almacenv, tv_menu, titulo)
st_titulo.text = 'Almacén'



end event

on w_almacenv_arbol.create
