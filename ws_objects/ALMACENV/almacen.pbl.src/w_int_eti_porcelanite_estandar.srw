$PBExportHeader$w_int_eti_porcelanite_estandar.srw
$PBExportComments$Etiquetas Normales
forward
global type w_int_eti_porcelanite_estandar from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_eti_porcelanite_estandar
end type
type pb_imprimir_etiquetas from upb_imprimir within w_int_eti_porcelanite_estandar
end type
type st_texto from statictext within w_int_eti_porcelanite_estandar
end type
type gb_2 from groupbox within w_int_eti_porcelanite_estandar
end type
type gb_1 from groupbox within w_int_eti_porcelanite_estandar
end type
type st_666 from statictext within w_int_eti_porcelanite_estandar
end type
type uo_articulo from u_em_campo_2 within w_int_eti_porcelanite_estandar
end type
type uo_texto1 from u_em_campo_2 within w_int_eti_porcelanite_estandar
end type
type st_66 from statictext within w_int_eti_porcelanite_estandar
end type
type dw_1 from u_datawindow_consultas within w_int_eti_porcelanite_estandar
end type
type sle_tc from singlelineedit within w_int_eti_porcelanite_estandar
end type
type st_1 from statictext within w_int_eti_porcelanite_estandar
end type
type sle_texto_cliente from singlelineedit within w_int_eti_porcelanite_estandar
end type
type st_3 from statictext within w_int_eti_porcelanite_estandar
end type
type mle_observaciones from multilineedit within w_int_eti_porcelanite_estandar
end type
type dw_informe from datawindow within w_int_eti_porcelanite_estandar
end type
type cb_1 from commandbutton within w_int_eti_porcelanite_estandar
end type
end forward
...
global w_int_eti_porcelanite_estandar w_int_eti_porcelanite_estandar
...
on w_int_eti_porcelanite_estandar.create
int iCurrent
call super::create
...
on w_int_eti_porcelanite_estandar.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_eti_porcelanite_estandar
integer x = 27
integer y = 1216
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_eti_porcelanite_estandar
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_eti_porcelanite_estandar
integer x = 32
integer y = 28
integer width = 1687
integer height = 84
...
integer height = 408
integer taborder = 30
string dataobject = "report_eti_porcelanite_estandar"
