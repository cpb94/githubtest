$PBExportHeader$wtc_consulta_almacen_movimientos.srw
forward
global type wtc_consulta_almacen_movimientos from wt_consultas_padre
end type
end forward
...
global wtc_consulta_almacen_movimientos wtc_consulta_almacen_movimientos
...
on wtc_consulta_almacen_movimientos.create
call super::create
end on

on wtc_consulta_almacen_movimientos.destroy
call super::destroy
...
"CONVERT(float, almacenmovimientos.cantidade) as entrada, "+& 
"CONVERT(float, almacenmovimientos.cantidads) as salida, "+&
...
type st_registros_padre from wt_consultas_padre`st_registros_padre within wtc_consulta_almacen_movimientos
end type

type st_total_padre from wt_consultas_padre`st_total_padre within wtc_consulta_almacen_movimientos
end type

type pb_imprimir from wt_consultas_padre`pb_imprimir within wtc_consulta_almacen_movimientos
integer x = 4690
integer y = 112
integer taborder = 0
end type
...
type pb_borrar from wt_consultas_padre`pb_borrar within wtc_consulta_almacen_movimientos
integer x = 4846
integer y = 112
integer taborder = 0
end type

type dw_montaje_filtro from wt_consultas_padre`dw_montaje_filtro within wtc_consulta_almacen_movimientos
integer width = 5253
integer height = 224
integer taborder = 30
end type

type pb_1 from wt_consultas_padre`pb_1 within wtc_consulta_almacen_movimientos
integer x = 3150
integer y = 108
integer taborder = 0
end type
...
type pb_reset from wt_consultas_padre`pb_reset within wtc_consulta_almacen_movimientos
integer x = 5001
integer y = 112
integer taborder = 0
end type

type pb_anyadir1 from wt_consultas_padre`pb_anyadir1 within wtc_consulta_almacen_movimientos
integer x = 2999
integer y = 108
integer taborder = 0
end type
...
if ddlb_campo.text <> "" or dw_montaje_filtro.rowcount() = 0 then
	...
	choose case ddlb_campo.text
		...
		case "Lote"
			if cadena_or = '' then
				descripcion_extra = ""
				cadena_or = " almacenmovimientos.tono "+ddlb_operador.text+" '"+sle_valor1.text+"' "
				cadena_or_visible = " Lote "+ddlb_operador.text+" '"+sle_valor1.text+" "+descripcion_extra+"' "
			end if	
	end choose
...
type ddlb_operador from wt_consultas_padre`ddlb_operador within wtc_consulta_almacen_movimientos
integer x = 951
integer taborder = 0
integer weight = 700
...
type ddlb_campo from wt_consultas_padre`ddlb_campo within wtc_consulta_almacen_movimientos
integer width = 878
integer height = 1308
integer taborder = 0
integer weight = 700
...
boolean sorted = false
string item[] = {"Fecha Movimiento","Fecha Introducción","Tipo Movimiento","Articulo (Descripción)","Artículo (Código)","Cantidad Entrada","Cantidad Salida","Almacen","Zona","Fila","Ubicado en Muelle","Uso","Formato","Familia","Lote"}
end type
...
CHOOSE CASE ddlb_campo.text
	...
	CASE "Zona", "Fila", "Altura", "Artículo (Código)","Lote"
		dw_filtro.visible = false
		pb_buscar.visible = false
		sle_texto.visible = false
		em_fecha1.visible = false
...
type dw_datos from wt_consultas_padre`dw_datos within wtc_consulta_almacen_movimientos
integer y = 512
integer width = 5257
integer height = 2192
integer taborder = 40
string dataobject = "dwtc_consulta_almacen_movimientos"
end type
...
type pb_salir from wt_consultas_padre`pb_salir within wtc_consulta_almacen_movimientos
integer x = 5157
integer y = 112
integer taborder = 0
end type

type st_titulo from wt_consultas_padre`st_titulo within wtc_consulta_almacen_movimientos
end type

type p_logo from wt_consultas_padre`p_logo within wtc_consulta_almacen_movimientos
integer x = 4786
integer y = 4
end type

type dw_filtro from wt_consultas_padre`dw_filtro within wtc_consulta_almacen_movimientos
integer x = 1317
integer y = 252
integer width = 3968
integer height = 260
...
type pb_buscar from wt_consultas_padre`pb_buscar within wtc_consulta_almacen_movimientos
integer x = 2871
integer y = 132
integer taborder = 70
end type

type sle_valor1 from wt_consultas_padre`sle_valor1 within wtc_consulta_almacen_movimientos
integer x = 1312
integer width = 398
integer height = 96
integer taborder = 10
...
type em_fecha1 from wt_consultas_padre`em_fecha1 within wtc_consulta_almacen_movimientos
integer x = 1307
integer height = 96
integer taborder = 80
string text = ""
...
type sle_texto from wt_consultas_padre`sle_texto within wtc_consulta_almacen_movimientos
integer x = 1312
integer y = 132
integer height = 96
integer taborder = 20
...
type lb_lista from wt_consultas_padre`lb_lista within wtc_consulta_almacen_movimientos
integer x = 1312
integer y = 132
integer width = 462
integer height = 356
