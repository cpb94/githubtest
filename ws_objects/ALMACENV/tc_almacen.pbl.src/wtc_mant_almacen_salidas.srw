$PBExportHeader$wtc_mant_almacen_salidas.srw
forward
global type wtc_mant_almacen_salidas from wt_ventana_padre
end type
type dw_salidas from datawindow within wtc_mant_almacen_salidas
end type
type dw_mover from u_dw within wtc_mant_almacen_salidas
end type
type pb_busqueda_codigo from picturebutton within wtc_mant_almacen_salidas
end type
end forward
...
global wtc_mant_almacen_salidas wtc_mant_almacen_salidas
...
protected subroutine f_calcular_pallets_caja (integer pallets_introducidos, integer cajas_introducidas, decimal piezas_introducidas)
end prototypes
...
protected subroutine f_calcular_pallets_caja (integer pallets_introducidos, integer cajas_introducidas, decimal piezas_introducidas);if dw_1.getrow() <= 0 then
...
on wtc_mant_almacen_salidas.create
int iCurrent
call super::create
...
on wtc_mant_almacen_salidas.destroy
call super::destroy
...
type pb_imprimir from wt_ventana_padre`pb_imprimir within wtc_mant_almacen_salidas
...
type p_logo from wt_ventana_padre`p_logo within wtc_mant_almacen_salidas
integer x = 4741
integer y = 12
end type

type dw_1 from wt_ventana_padre`dw_1 within wtc_mant_almacen_salidas
integer width = 5257
integer height = 848
string title = "Mantenimeinto de Colecciones"
string dataobject = "dwtc_almacen_salidas"
...
type pb_borrar from wt_ventana_padre`pb_borrar within wtc_mant_almacen_salidas
boolean visible = false
integer x = 3063
integer y = 52
boolean enabled = false
...
type pb_salir from wt_ventana_padre`pb_salir within wtc_mant_almacen_salidas
integer x = 5097
integer y = 128
end type

type pb_grabar from wt_ventana_padre`pb_grabar within wtc_mant_almacen_salidas
boolean visible = false
integer x = 2734
integer y = 52
boolean enabled = false
...
type st_titulo from wt_ventana_padre`st_titulo within wtc_mant_almacen_salidas
end type

type pb_nuevo from wt_ventana_padre`pb_nuevo within wtc_mant_almacen_salidas
boolean visible = false
integer x = 2894
integer y = 52
boolean enabled = false
...
type pb_cancelar from wt_ventana_padre`pb_cancelar within wtc_mant_almacen_salidas
boolean visible = false
integer x = 3218
integer y = 52
boolean enabled = false
...
type pb_buscar from wt_ventana_padre`pb_buscar within wtc_mant_almacen_salidas
integer x = 37
...
string title = "none"
string dataobject = "dwtc_almacen_salidas_dia"
boolean vscrollbar = true
boolean border = false
