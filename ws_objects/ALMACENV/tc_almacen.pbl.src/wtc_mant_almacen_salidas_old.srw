$PBExportHeader$wtc_mant_almacen_salidas_old.srw
forward
global type wtc_mant_almacen_salidas_old from wt_ventana_padre
end type
type dw_salidas from datawindow within wtc_mant_almacen_salidas_old
end type
type dw_mover from u_dw within wtc_mant_almacen_salidas_old
end type
type pb_busqueda_codigo from picturebutton within wtc_mant_almacen_salidas_old
end type
end forward
...
global wtc_mant_almacen_salidas_old wtc_mant_almacen_salidas_old
...
on wtc_mant_almacen_salidas_old.create
int iCurrent
call super::create
...
on wtc_mant_almacen_salidas_old.destroy
call super::destroy
...
type pb_imprimir from wt_ventana_padre`pb_imprimir within wtc_mant_almacen_salidas_old
...
type p_logo from wt_ventana_padre`p_logo within wtc_mant_almacen_salidas_old
integer x = 4741
integer y = 12
end type

type dw_1 from wt_ventana_padre`dw_1 within wtc_mant_almacen_salidas_old
integer width = 5257
integer height = 848
...
type pb_borrar from wt_ventana_padre`pb_borrar within wtc_mant_almacen_salidas_old
boolean visible = false
integer x = 3063
integer y = 52
boolean enabled = false
...
type pb_salir from wt_ventana_padre`pb_salir within wtc_mant_almacen_salidas_old
integer x = 5097
integer y = 128
end type

type pb_grabar from wt_ventana_padre`pb_grabar within wtc_mant_almacen_salidas_old
boolean visible = false
integer x = 2734
integer y = 52
boolean enabled = false
...
type st_titulo from wt_ventana_padre`st_titulo within wtc_mant_almacen_salidas_old
end type

type pb_nuevo from wt_ventana_padre`pb_nuevo within wtc_mant_almacen_salidas_old
boolean visible = false
integer x = 2894
integer y = 52
boolean enabled = false
...
type pb_cancelar from wt_ventana_padre`pb_cancelar within wtc_mant_almacen_salidas_old
boolean visible = false
integer x = 3218
integer y = 52
boolean enabled = false
...
type pb_buscar from wt_ventana_padre`pb_buscar within wtc_mant_almacen_salidas_old
integer x = 37
...
elseif dwo.name = "b_salida" then 
	...
	ld_disponible = f_disponible_art_cal_to_ca_tp_c_pzs( dw_1.object.almacenmovimientos_empresa[dw_1.getrow()] , &
