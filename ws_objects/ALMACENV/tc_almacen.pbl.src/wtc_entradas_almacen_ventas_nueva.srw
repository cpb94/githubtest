$PBExportHeader$wtc_entradas_almacen_ventas_nueva.srw
forward
global type wtc_entradas_almacen_ventas_nueva from window
end type
type dw_stock from datawindow within wtc_entradas_almacen_ventas_nueva
end type
type dw_pedidos from datawindow within wtc_entradas_almacen_ventas_nueva
end type
type dw_observaciones from datawindow within wtc_entradas_almacen_ventas_nueva
end type
type pb_nuevo from picturebutton within wtc_entradas_almacen_ventas_nueva
end type
type dw_comlinubica from datawindow within wtc_entradas_almacen_ventas_nueva
end type
type dw_detalle from datawindow within wtc_entradas_almacen_ventas_nueva
end type
type dw_movimientos from u_dw within wtc_entradas_almacen_ventas_nueva
end type
type pb_grabar from picturebutton within wtc_entradas_almacen_ventas_nueva
end type
type pb_salir from picturebutton within wtc_entradas_almacen_ventas_nueva
end type
type dp_fecha from datepicker within wtc_entradas_almacen_ventas_nueva
end type
type st_1 from statictext within wtc_entradas_almacen_ventas_nueva
end type
type st_2 from statictext within wtc_entradas_almacen_ventas_nueva
end type
end forward
...
global wtc_entradas_almacen_ventas_nueva wtc_entradas_almacen_ventas_nueva
...
IF rtn = 1 THEN
	...
	//Ya no se asigna automaticamente
	if ld_disponible > 0 and 0 = 1 then
...
public subroutine f_calcular_pallets_caja (integer pallets_intro, integer cajas_intro, integer piezas_intro);long pallets, cajas
...
on wtc_entradas_almacen_ventas_nueva.create
...
on wtc_entradas_almacen_ventas_nueva.destroy
...
datetime value = DateTime(Date("2020-01-07"), Time("13:57:08.000000"))
integer textsize = -10
fontcharset fontcharset = ansi!
fontpitch fontpitch = variable!
fontfamily fontfamily = swiss!
