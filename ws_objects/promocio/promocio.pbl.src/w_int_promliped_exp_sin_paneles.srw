$PBExportHeader$w_int_promliped_exp_sin_paneles.srw
forward
global type w_int_promliped_exp_sin_paneles from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_promliped_exp_sin_paneles
end type
type st_2 from statictext within w_int_promliped_exp_sin_paneles
end type
type em_pedido from u_em_campo within w_int_promliped_exp_sin_paneles
end type
type st_3 from statictext within w_int_promliped_exp_sin_paneles
end type
type st_texto_cantidad from statictext within w_int_promliped_exp_sin_paneles
end type
type st_22 from statictext within w_int_promliped_exp_sin_paneles
end type
type em_cliente from u_em_campo within w_int_promliped_exp_sin_paneles
end type
type st_nombre_cliente from statictext within w_int_promliped_exp_sin_paneles
end type
type em_anyo from u_em_campo within w_int_promliped_exp_sin_paneles
end type
type gb_1 from groupbox within w_int_promliped_exp_sin_paneles
end type
type gb_2 from groupbox within w_int_promliped_exp_sin_paneles
end type
type gb_3 from groupbox within w_int_promliped_exp_sin_paneles
end type
type em_situacion from u_em_campo within w_int_promliped_exp_sin_paneles
end type
type st_texto_cantidad2 from statictext within w_int_promliped_exp_sin_paneles
end type
type st_articulo from statictext within w_int_promliped_exp_sin_paneles
end type
type em_cantidad_articulo from u_em_campo within w_int_promliped_exp_sin_paneles
end type
type st_panel from statictext within w_int_promliped_exp_sin_paneles
end type
type em_cantidad_panel from u_em_campo within w_int_promliped_exp_sin_paneles
end type
type uo_articulo from u_em_campo_2 within w_int_promliped_exp_sin_paneles
end type
type dw_proceso2 from datawindow within w_int_promliped_exp_sin_paneles
end type
type cb_grabar_articulo from u_boton within w_int_promliped_exp_sin_paneles
end type
type cb_borrar_articulo from u_boton within w_int_promliped_exp_sin_paneles
end type
type cb_preparar_panel from u_boton within w_int_promliped_exp_sin_paneles
end type
type cb_borrar_panel from u_boton within w_int_promliped_exp_sin_paneles
end type
type cb_insertar_panel from u_boton within w_int_promliped_exp_sin_paneles
end type
type cb_preparar_paneles from u_boton within w_int_promliped_exp_sin_paneles
end type
type cb_grabar_panel from u_boton within w_int_promliped_exp_sin_paneles
end type
type cb_seleccion_panel from u_boton within w_int_promliped_exp_sin_paneles
end type
type gb_6 from groupbox within w_int_promliped_exp_sin_paneles
end type
type st_clase_panel from statictext within w_int_promliped_exp_sin_paneles
end type
type uo_clase_panel from u_em_campo_2 within w_int_promliped_exp_sin_paneles
end type
type cb_reponer from u_boton within w_int_promliped_exp_sin_paneles
end type
type cb_insertar_articulo from u_boton within w_int_promliped_exp_sin_paneles
end type
type gb_5 from groupbox within w_int_promliped_exp_sin_paneles
end type
type gb_7 from groupbox within w_int_promliped_exp_sin_paneles
end type
type volcado from u_boton within w_int_promliped_exp_sin_paneles
end type
type uo_panel from u_em_campo_2 within w_int_promliped_exp_sin_paneles
end type
type dw_detalle from datawindow within w_int_promliped_exp_sin_paneles
end type
type dw_mapa from datawindow within w_int_promliped_exp_sin_paneles
end type
type gb_4 from groupbox within w_int_promliped_exp_sin_paneles
end type
type dw_articulo from datawindow within w_int_promliped_exp_sin_paneles
end type
type dw_control from datawindow within w_int_promliped_exp_sin_paneles
end type
end forward
...
global w_int_promliped_exp_sin_paneles w_int_promliped_exp_sin_paneles
...
on w_int_promliped_exp_sin_paneles.create
int iCurrent
call super::create
...
this.Control[iCurrent+23]=this.cb_preparar_panel
this.Control[iCurrent+24]=this.cb_borrar_panel
this.Control[iCurrent+25]=this.cb_insertar_panel
this.Control[iCurrent+26]=this.cb_preparar_paneles
this.Control[iCurrent+27]=this.cb_grabar_panel
this.Control[iCurrent+28]=this.cb_seleccion_panel
this.Control[iCurrent+29]=this.gb_6
this.Control[iCurrent+30]=this.st_clase_panel
this.Control[iCurrent+31]=this.uo_clase_panel
this.Control[iCurrent+32]=this.cb_reponer
this.Control[iCurrent+33]=this.cb_insertar_articulo
this.Control[iCurrent+34]=this.gb_5
this.Control[iCurrent+35]=this.gb_7
this.Control[iCurrent+36]=this.volcado
this.Control[iCurrent+37]=this.uo_panel
this.Control[iCurrent+38]=this.dw_detalle
this.Control[iCurrent+39]=this.dw_mapa
this.Control[iCurrent+40]=this.gb_4
this.Control[iCurrent+41]=this.dw_articulo
this.Control[iCurrent+42]=this.dw_control
end on

on w_int_promliped_exp_sin_paneles.destroy
call super::destroy
...
event activate;call super::activate;w_int_promliped_exp_sin_paneles = ventanas_activas[id_ventana_activa].ventana
end event

type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_promliped_exp_sin_paneles
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_promliped_exp_sin_paneles
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_promliped_exp_sin_paneles
integer x = 32
integer y = 8
integer width = 2176
integer height = 112
...
event clicked;f_activar_campo(uo_panel.em_campo)
str_parametros lstr_param
lstr_param.i_nargumentos    = 2
lstr_param.s_argumentos[1]  = "w_in_promliped"
 lstr_param.i_nargumentos    = 3
 ...
 OpenWithParm(w_int_prompedreposicion_sin_paneles,lstr_param)
 IF Message.StringParm	= "1" Then
	dw_control.Retrieve(codigo_empresa,var_anyo,var_pedido,linped.tipo_expositor,reposicion)
 END IF
...
integer height = 804
boolean bringtotop = true
string dataobject = "dw_int_promlinped2_sin_paneles"
boolean vscrollbar = true
boolean livescroll = true
borderstyle borderstyle = styleraised!
end type
