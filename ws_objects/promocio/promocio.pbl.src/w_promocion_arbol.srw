$PBExportHeader$w_promocion_arbol.srw
forward
global type w_promocion_arbol from window
end type
type st_titulo from statictext within w_promocion_arbol
end type
type tv_menu from treeview within w_promocion_arbol
end type
end forward
...
global w_promocion_arbol w_promocion_arbol

event open;string titulo

f_cargar_menu_arbol (w_promocion, tv_menu, titulo)
st_titulo.text = 'Promoción'



end event

on w_promocion_arbol.create
