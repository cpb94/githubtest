$PBExportHeader$w_recalcular_promalb.srw
forward
global type w_recalcular_promalb from w_int_con_empresa
end type
type pb_1 from upb_salir within w_recalcular_promalb
end type
type st_1 from statictext within w_recalcular_promalb
end type
type cb_1 from u_boton within w_recalcular_promalb
end type
type dw_proceso1 from datawindow within w_recalcular_promalb
end type
type cliente from statictext within w_recalcular_promalb
end type
type st_1a from statictext within w_recalcular_promalb
end type
type descripcion_articulo from statictext within w_recalcular_promalb
end type
type dw_proceso2 from datawindow within w_recalcular_promalb
end type
type dw_proceso from datawindow within w_recalcular_promalb
end type
type st_1b from statictext within w_recalcular_promalb
end type
type descripcion_panel from statictext within w_recalcular_promalb
end type
type st_1c from statictext within w_recalcular_promalb
end type
type st_1d from statictext within w_recalcular_promalb
end type
type st_1e from statictext within w_recalcular_promalb
end type
type st_1f from statictext within w_recalcular_promalb
end type
type st_2c from statictext within w_recalcular_promalb
end type
type st_2d from statictext within w_recalcular_promalb
end type
type st_2e from statictext within w_recalcular_promalb
end type
type gb_1 from groupbox within w_recalcular_promalb
end type
type st_3c from statictext within w_recalcular_promalb
end type
type st_3d from statictext within w_recalcular_promalb
end type
type st_3e from statictext within w_recalcular_promalb
end type
type st_4c from statictext within w_recalcular_promalb
end type
type st_4d from statictext within w_recalcular_promalb
end type
type st_4e from statictext within w_recalcular_promalb
end type
type st_5c from statictext within w_recalcular_promalb
end type
type st_5d from statictext within w_recalcular_promalb
end type
type st_5e from statictext within w_recalcular_promalb
end type
type st_31 from statictext within w_recalcular_promalb
end type
type st_33 from statictext within w_recalcular_promalb
end type
type st_34 from statictext within w_recalcular_promalb
end type
type albaran from statictext within w_recalcular_promalb
end type
type pesot from statictext within w_recalcular_promalb
end type
type costet from statictext within w_recalcular_promalb
end type
type ventat from statictext within w_recalcular_promalb
end type
type pesotm from statictext within w_recalcular_promalb
end type
type costetm from statictext within w_recalcular_promalb
end type
type ventatm from statictext within w_recalcular_promalb
end type
type ventatp from statictext within w_recalcular_promalb
end type
type costetp from statictext within w_recalcular_promalb
end type
type pesotp from statictext within w_recalcular_promalb
end type
type pesop from statictext within w_recalcular_promalb
end type
type costep from statictext within w_recalcular_promalb
end type
type ventap from statictext within w_recalcular_promalb
end type
type coste_manipulacion from statictext within w_recalcular_promalb
end type
type pesom from statictext within w_recalcular_promalb
end type
type costem from statictext within w_recalcular_promalb
end type
type ventam from statictext within w_recalcular_promalb
end type
end forward
...
global w_recalcular_promalb w_recalcular_promalb

type variables
Dec var_anyo,var_albaran,var_linea,var_orden


end variables

forward prototypes
public subroutine f_calculo_promlindetallalb ()
public subroutine f_calculo_promlinalb ()
public subroutine f_calculo_promalb ()
end prototypes
...
Dec{0} venta,coste,piezas
  ...
  SELECT promlindetallalb.articulo,promlindetallalb.calidad,promlindetallalb.piezas  
    INTO :articulo,:calidad,:piezas  
    FROM promlindetallalb  
   WHERE promlindetallalb.empresa = :codigo_empresa 
	AND   promlindetallalb.anyo    = :var_anyo 
	AND   promlindetallalb.albaran  = :var_albaran
	AND   promlindetallalb.linea   = :var_linea 
	AND   promlindetallalb.orden   = :var_orden;
...
public subroutine f_calculo_promlinalb ();String codpanel,clase_panel,var_medidas,var_expositor,var_panel,var_tipo_panel
Dec{0} var_piezas
Dec    peso_panel,coste_panel,venta_panel,v_coste_manipulacion,&
       peso_material ,coste_material ,venta_material 
Select promlinalb.panel,promlinalb.clase_panel,promlinalb.cantidad,
       promlinalb.tipo,       promlinalb.tipo_panel
Into   :codpanel,:clase_panel,:var_piezas,:var_panel,:var_tipo_panel
From   promlinalb
Where  promlinalb.empresa = :codigo_empresa
And    promlinalb.anyo    = :var_anyo
And    promlinalb.albaran  = :var_albaran
And    promlinalb.linea   = :var_linea;
...
Select  Sum(promlindetallalb.peso),Sum(promlindetallalb.coste),Sum(promlindetallalb.venta) 
...
public subroutine f_calculo_promalb ();String v_cliente,var_tipo,var_reposicion,var_tipo_expositor
...
Select  promalb.cliente,promalb.tipo ,promalb.reposicion,promalb.tipo_expositor
Into :v_cliente,:var_tipo,:var_reposicion,:var_tipo_expositor From promalb
...
Select  Sum(promlinalb.cantidad * promlinalb.peso_panel),
        Sum(promlinalb.cantidad * promlinalb.coste_panel),
		  Sum(promlinalb.cantidad * promlinalb.venta_panel),
		  Sum(promlinalb.cantidad * promlinalb.peso_material),
        Sum(promlinalb.cantidad * promlinalb.coste_material),
		  Sum(promlinalb.cantidad * promlinalb.venta_material), 
  		  Sum(promlinalb.cantidad * promlinalb.coste_manipulacion)
...
ventatp.text  = STring(venta_panel,f_mascara_decimales(0))
  UPDATE promalb  
     SET peso_material   = :peso_material,   
         ...
         coste_manipulacion = :v_coste_manipulacion  
   WHERE ( promalb.empresa = :codigo_empresa ) AND  
         ( promalb.anyo = :var_anyo ) AND  
         ( promalb.albaran = :var_albaran );
			IF SQLCA.SQLCODE <> 0 Then f_mensaje("Error",sqlca.sqlerrtext)
		COMMIT;
...
event open;call super::open;istr_parametros.s_titulo_ventana="Recalculo datos albaranes promocion"
...
on w_recalcular_promalb.create
int iCurrent
call super::create
...
this.Control[iCurrent+32]=this.albaran
...
on w_recalcular_promalb.destroy
call super::destroy
...
event activate;call super::activate;w_recalcular_promalb = ventanas_activas[id_ventana_activa].ventana
end event

type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_recalcular_promalb
integer taborder = 20
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_recalcular_promalb
end type

type st_empresa from w_int_con_empresa`st_empresa within w_recalcular_promalb
integer x = 27
integer y = 8
integer width = 2427
end type
...
For r = 1 To r1
	...
	var_albaran = dw_proceso.GetItemNumber(r,"albaran")
	albaran.text = String(var_albaran,f_mascara_decimales(0))
	e1 = dw_proceso1.Retrieve(codigo_empresa,var_anyo,var_albaran)
	IF e1 <> 0 Then
		For e = 1 To e1
			var_linea = dw_proceso1.GetItemNumber(e,"linea")
			w1 = dw_proceso2.Retrieve(codigo_empresa,var_anyo,var_albaran,var_linea)
				IF w1 <> 0 Then
				For w = 1 To w1
					var_orden = dw_proceso2.GetItemNumber(w,"orden")
					f_calculo_promlindetallalb()
				Next
				f_calculo_promlinalb()
				END IF
		Next
		f_calculo_promalb()
	End If
...
integer taborder = 10
boolean bringtotop = true
string dataobject = "dw_proceso_promalb"
boolean livescroll = true
end type
