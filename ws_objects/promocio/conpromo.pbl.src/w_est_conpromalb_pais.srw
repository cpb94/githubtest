$PBExportHeader$w_est_conpromalb_pais.srw
forward
global type w_est_conpromalb_pais from w_int_con_empresa
end type
type uo_conpromalb2 from u_em_campo_2 within w_est_conpromalb_pais
end type
type pb_1 from upb_salir within w_est_conpromalb_pais
end type
type pb_imprimir from upb_imprimir within w_est_conpromalb_pais
end type
type dw_listado_conpromalb2 from datawindow within w_est_conpromalb_pais
end type
type uo_manejo from u_manejo_datawindow within w_est_conpromalb_pais
end type
type dw_conpromalb2 from datawindow within w_est_conpromalb_pais
end type
type gb_boton from groupbox within w_est_conpromalb_pais
end type
type gb_cliente from groupbox within w_est_conpromalb_pais
end type
type gb_fecha from groupbox within w_est_conpromalb_pais
end type
type em_fechadesde from u_em_campo within w_est_conpromalb_pais
end type
type em_fechahasta from u_em_campo within w_est_conpromalb_pais
end type
type st_1 from statictext within w_est_conpromalb_pais
end type
type cb_1 from commandbutton within w_est_conpromalb_pais
end type
type cb_2 from commandbutton within w_est_conpromalb_pais
end type
end forward
...
global w_est_conpromalb_pais w_est_conpromalb_pais

on w_est_conpromalb_pais.create
int iCurrent
call super::create
...
on w_est_conpromalb_pais.destroy
call super::destroy
...
event open;call super::open;istr_parametros.s_titulo_ventana =   "Informe Promoción por País"
istr_parametros.s_listado        =   "report_est_conpromalb_pais"
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_est_conpromalb_pais
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_est_conpromalb_pais
integer taborder = 40
end type
...
type st_empresa from w_int_con_empresa`st_empresa within w_est_conpromalb_pais
integer x = 18
end type
...
event modificado;call super::modificado;uo_conpromalb2.em_campo.text=f_nombre_pais(uo_conpromalb2.em_codigo.text)
...
string dataobject = "report_est_conpromalb_pais"
...
integer height = 1620
boolean bringtotop = true
string dataobject = "dw_est_conpromalb_pais"
