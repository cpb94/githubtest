$PBExportHeader$w_con_conpromped4.srw
$PBExportComments$Consulta por representante.
forward
global type w_con_conpromped4 from w_int_con_empresa
end type
type st_conpromped2 from statictext within w_con_conpromped4
end type
type uo_conpromped2 from u_em_campo_2 within w_con_conpromped4
end type
type pb_1 from upb_salir within w_con_conpromped4
end type
type pb_imprimir from upb_imprimir within w_con_conpromped4
end type
type dw_listado2 from datawindow within w_con_conpromped4
end type
type uo_manejo from u_manejo_datawindow within w_con_conpromped4
end type
type dw_conpromped2 from datawindow within w_con_conpromped4
end type
type ddlb_opcion from dropdownlistbox within w_con_conpromped4
end type
end forward
...
global w_con_conpromped4 w_con_conpromped4

type variables
String situ
end variables

on w_con_conpromped4.create
int iCurrent
call super::create
...
event open;call super::open;istr_parametros.s_titulo_ventana =   "Consulta de Pedidos por Representantes"
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_conpromped4
integer taborder = 10
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_conpromped4
integer taborder = 30
end type
...
type st_empresa from w_int_con_empresa`st_empresa within w_con_conpromped4
integer y = 44
integer width = 2139
end type
...
integer taborder = 40
boolean bringtotop = true
string dataobject = "report_conpromped4"
...
integer height = 1568
boolean bringtotop = true
string dataobject = "dw_con_conpromped4"
