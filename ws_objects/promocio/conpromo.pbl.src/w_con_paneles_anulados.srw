$PBExportHeader$w_con_paneles_anulados.srw
forward
global type w_con_paneles_anulados from w_int_con_empresa
end type
type st_prommedidas from statictext within w_con_paneles_anulados
end type
type pb_1 from upb_salir within w_con_paneles_anulados
end type
type pb_imprimir from upb_imprimir within w_con_paneles_anulados
end type
type dw_listado from datawindow within w_con_paneles_anulados
end type
type uo_manejo from u_manejo_datawindow within w_con_paneles_anulados
end type
type dw_detalle from datawindow within w_con_paneles_anulados
end type
type cb_1 from commandbutton within w_con_paneles_anulados
end type
type em_busqueda from u_em_campo within w_con_paneles_anulados
end type
type dw_detalle1 from datawindow within w_con_paneles_anulados
end type
end forward
...
global w_con_paneles_anulados w_con_paneles_anulados
...
on w_con_paneles_anulados.create
int iCurrent
call super::create
...
on w_con_paneles_anulados.destroy
call super::destroy
...
event open;call super::open;istr_parametros.s_titulo_ventana =   "Consulta de Paneles anulados"
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_paneles_anulados
integer x = 722
integer y = 828
integer taborder = 20
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_paneles_anulados
integer taborder = 40
end type
...
type st_empresa from w_int_con_empresa`st_empresa within w_con_paneles_anulados
integer x = 18
integer y = 44
integer width = 2139
end type
...
integer taborder = 50
boolean bringtotop = true
string dataobject = "report_con_paneles_anulados"
...
integer height = 1488
boolean bringtotop = true
string dataobject = "dw_con_paneles_anulados"
