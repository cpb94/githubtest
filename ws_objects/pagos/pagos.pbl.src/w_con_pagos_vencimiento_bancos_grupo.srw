$PBExportHeader$w_con_pagos_vencimiento_bancos_grupo.srw
forward
global type w_con_pagos_vencimiento_bancos_grupo from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_pagos_vencimiento_bancos_grupo
end type
type uo_1 from u_manejo_datawindow within w_con_pagos_vencimiento_bancos_grupo
end type
type cb_consulta from u_boton within w_con_pagos_vencimiento_bancos_grupo
end type
type pb_imprimir_preli from picturebutton within w_con_pagos_vencimiento_bancos_grupo
end type
type dw_listado from datawindow within w_con_pagos_vencimiento_bancos_grupo
end type
type cb_2 from u_boton within w_con_pagos_vencimiento_bancos_grupo
end type
type gb_cuenta from groupbox within w_con_pagos_vencimiento_bancos_grupo
end type
type st_1 from statictext within w_con_pagos_vencimiento_bancos_grupo
end type
type dw_1 from datawindow within w_con_pagos_vencimiento_bancos_grupo
end type
type em_hasta from u_em_campo within w_con_pagos_vencimiento_bancos_grupo
end type
type ddlb_1 from dropdownlistbox within w_con_pagos_vencimiento_bancos_grupo
end type
type uo_tipo2 from u_marca_lista within w_con_pagos_vencimiento_bancos_grupo
end type
type em_desde from u_em_campo within w_con_pagos_vencimiento_bancos_grupo
end type
type st_2 from statictext within w_con_pagos_vencimiento_bancos_grupo
end type
end forward
...
global w_con_pagos_vencimiento_bancos_grupo w_con_pagos_vencimiento_bancos_grupo
...
on w_con_pagos_vencimiento_bancos_grupo.create
int iCurrent
call super::create
...
on w_con_pagos_vencimiento_bancos_grupo.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_pagos_vencimiento_bancos_grupo
integer x = 594
integer y = 792
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_pagos_vencimiento_bancos_grupo
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_pagos_vencimiento_bancos_grupo
integer x = 59
integer width = 2642
end type
...
integer width = 379
integer height = 112
string dataobject = "report_con_pagos_vencimiento2"
...
integer width = 3616
integer height = 1624
string dataobject = "dw_con_pagos_vencimiento2"
