$PBExportHeader$w_con_pagos_proveedor_sin_asignar.srw
forward
global type w_con_pagos_proveedor_sin_asignar from w_int_con_empresa
end type
type pb_2 from upb_salir within w_con_pagos_proveedor_sin_asignar
end type
type uo_1 from u_manejo_datawindow within w_con_pagos_proveedor_sin_asignar
end type
type cb_consulta from u_boton within w_con_pagos_proveedor_sin_asignar
end type
type pb_imprimir_preli from picturebutton within w_con_pagos_proveedor_sin_asignar
end type
type dw_listado from datawindow within w_con_pagos_proveedor_sin_asignar
end type
type uo_tipo2 from u_marca_lista within w_con_pagos_proveedor_sin_asignar
end type
type gb_2 from groupbox within w_con_pagos_proveedor_sin_asignar
end type
type uo_proveedor from u_em_campo_2 within w_con_pagos_proveedor_sin_asignar
end type
type cb_2 from u_boton within w_con_pagos_proveedor_sin_asignar
end type
type gb_cuenta from groupbox within w_con_pagos_proveedor_sin_asignar
end type
type st_1 from statictext within w_con_pagos_proveedor_sin_asignar
end type
type pendiente from radiobutton within w_con_pagos_proveedor_sin_asignar
end type
type cobrado from radiobutton within w_con_pagos_proveedor_sin_asignar
end type
type dw_1 from datawindow within w_con_pagos_proveedor_sin_asignar
end type
end forward
...
global w_con_pagos_proveedor_sin_asignar w_con_pagos_proveedor_sin_asignar
...
on w_con_pagos_proveedor_sin_asignar.create
int iCurrent
call super::create
...
on w_con_pagos_proveedor_sin_asignar.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_con_pagos_proveedor_sin_asignar
integer taborder = 0
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_con_pagos_proveedor_sin_asignar
integer x = 55
end type

type st_empresa from w_int_con_empresa`st_empresa within w_con_pagos_proveedor_sin_asignar
integer x = 59
integer y = 12
integer width = 2642
end type
