$PBExportHeader$w_facturas_ventas_fobs.srw
forward
global type w_facturas_ventas_fobs from w_int_con_empresa
end type
type pb_1 from upb_salir within w_facturas_ventas_fobs
end type
type em_fdesde from u_em_campo within w_facturas_ventas_fobs
end type
type st_1 from statictext within w_facturas_ventas_fobs
end type
type uo_cliente from u_em_campo_2 within w_facturas_ventas_fobs
end type
type dw_1 from u_datawindow_consultas within w_facturas_ventas_fobs
end type
type cb_consultar from u_boton within w_facturas_ventas_fobs
end type
type cb_cancelar from u_boton within w_facturas_ventas_fobs
end type
type cb_procesar from u_boton within w_facturas_ventas_fobs
end type
type gb_6 from groupbox within w_facturas_ventas_fobs
end type
type gb_5 from groupbox within w_facturas_ventas_fobs
end type
type gb_4 from groupbox within w_facturas_ventas_fobs
end type
type gb_2 from groupbox within w_facturas_ventas_fobs
end type
type gb_1 from groupbox within w_facturas_ventas_fobs
end type
type st_2 from statictext within w_facturas_ventas_fobs
end type
type gb_3 from groupbox within w_facturas_ventas_fobs
end type
type st_importe from editmask within w_facturas_ventas_fobs
end type
type st_importe_ant from editmask within w_facturas_ventas_fobs
end type
type em_fletes from editmask within w_facturas_ventas_fobs
end type
end forward
...
global w_facturas_ventas_fobs w_facturas_ventas_fobs

type variables
dec importe_fobs,importe_fletes
end variables

on w_facturas_ventas_fobs.create
int iCurrent
call super::create
...
on w_facturas_ventas_fobs.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_facturas_ventas_fobs
integer taborder = 100
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_facturas_ventas_fobs
end type

type st_empresa from w_int_con_empresa`st_empresa within w_facturas_ventas_fobs
end type
