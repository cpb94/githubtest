$PBExportHeader$w_int_etiquetas_clientes.srw
$PBExportComments$Impresión etiquetas clientes.
forward
global type w_int_etiquetas_clientes from w_int_con_empresa
end type
type pb_1 from upb_salir within w_int_etiquetas_clientes
end type
type rb_si from radiobutton within w_int_etiquetas_clientes
end type
type rb_todos from radiobutton within w_int_etiquetas_clientes
end type
type report_etiquetas from datawindow within w_int_etiquetas_clientes
end type
type report_cartas from datawindow within w_int_etiquetas_clientes
end type
type em_carta from u_em_campo within w_int_etiquetas_clientes
end type
type st_1 from statictext within w_int_etiquetas_clientes
end type
type st_nombre_carta from statictext within w_int_etiquetas_clientes
end type
type dw_proceso from datawindow within w_int_etiquetas_clientes
end type
type rb_no from radiobutton within w_int_etiquetas_clientes
end type
type dw_proceso_paises from datawindow within w_int_etiquetas_clientes
end type
type rb1_si from radiobutton within w_int_etiquetas_clientes
end type
type rb1_todos from radiobutton within w_int_etiquetas_clientes
end type
type rb1_no from radiobutton within w_int_etiquetas_clientes
end type
type gb1_1 from groupbox within w_int_etiquetas_clientes
end type
type rb2_si from radiobutton within w_int_etiquetas_clientes
end type
type rb2_todos from radiobutton within w_int_etiquetas_clientes
end type
type rb2_no from radiobutton within w_int_etiquetas_clientes
end type
type gb2_1 from groupbox within w_int_etiquetas_clientes
end type
type pb_imprimir_etiquetas from upb_imprimir within w_int_etiquetas_clientes
end type
type pb_imprimir_cartas from upb_imprimir within w_int_etiquetas_clientes
end type
type pb_preliminar_etiquetas from upb_preliminar within w_int_etiquetas_clientes
end type
type pb_preliminar_cartas from upb_preliminar within w_int_etiquetas_clientes
end type
type st_2 from statictext within w_int_etiquetas_clientes
end type
type st_3 from statictext within w_int_etiquetas_clientes
end type
type st_pagina from statictext within w_int_etiquetas_clientes
end type
type pb_imprimir_preli from picturebutton within w_int_etiquetas_clientes
end type
type st_texto from statictext within w_int_etiquetas_clientes
end type
type gb1_2 from groupbox within w_int_etiquetas_clientes
end type
type pb_ultimo from picturebutton within w_int_etiquetas_clientes
end type
type pb_siguiente from picturebutton within w_int_etiquetas_clientes
end type
type pb_anterior from picturebutton within w_int_etiquetas_clientes
end type
type pb_primero from picturebutton within w_int_etiquetas_clientes
end type
type uo_idiomas from u_marca_lista within w_int_etiquetas_clientes
end type
type uo_paises from u_marca_lista within w_int_etiquetas_clientes
end type
type dw_preliminar from datawindow within w_int_etiquetas_clientes
end type
type gb_1 from groupbox within w_int_etiquetas_clientes
end type
end forward
...
global w_int_etiquetas_clientes w_int_etiquetas_clientes
...
on ue_listar;Integer registros
  ...
  dw_report.SetFilter(filtro)
  dw_report.Filter()
  IF opcion="ETIQUETAS" THEN dw_report.retrieve(codigo_empresa)
...
on w_int_etiquetas_clientes.create
int iCurrent
call super::create
...
on w_int_etiquetas_clientes.destroy
call super::destroy
...
type ole_cont_pro from w_int_con_empresa`ole_cont_pro within w_int_etiquetas_clientes
end type

type sle_opcion_orden from w_int_con_empresa`sle_opcion_orden within w_int_etiquetas_clientes
end type

type st_empresa from w_int_con_empresa`st_empresa within w_int_etiquetas_clientes
integer x = 18
integer y = 24
integer width = 2683
integer height = 108
...
event clicked;call super::clicked;dw_report = report_etiquetas
opcion="ETIQUETAS"
...
event clicked;dw_preliminar.DataObject    = "report_etiquetas_clientes"
filtro = ""
...
on clicked;call upb_preliminar::clicked;IF Trim(em_carta.text)="" or IsNull(em_carta.text) Then
    MessageBox("Campo obligatorio","Introduzca la carta",Exclamation!, OK!,1)
    em_carta.SetFocus()
    RETURN
END IF
