$PBExportHeader$w_inicio_recepcion.srw
forward
global type w_inicio_recepcion from w_ventana_padre_inicio
end type
type pb_u from picturebutton within w_inicio_recepcion
end type
type st_u from statictext within w_inicio_recepcion
end type
type pb_2 from picturebutton within w_inicio_recepcion
end type
type st_1 from statictext within w_inicio_recepcion
end type
type pb_generales from picturebutton within w_inicio_recepcion
end type
type st_generales from statictext within w_inicio_recepcion
end type
type gb_58 from groupbox within w_inicio_recepcion
end type
type gb_12 from groupbox within w_inicio_recepcion
end type
type gb_14 from groupbox within w_inicio_recepcion
end type
type pb_4 from picturebutton within w_inicio_recepcion
end type
type pb_almacen from picturebutton within w_inicio_recepcion
end type
type st_2 from statictext within w_inicio_recepcion
end type
type st_almacenv from statictext within w_inicio_recepcion
end type
type pb_d from picturebutton within w_inicio_recepcion
end type
type st_d from statictext within w_inicio_recepcion
end type
type pb_19 from picturebutton within w_inicio_recepcion
end type
type st_19 from statictext within w_inicio_recepcion
end type
type pb_10 from picturebutton within w_inicio_recepcion
end type
type st_10 from statictext within w_inicio_recepcion
end type
type pb_pagos from picturebutton within w_inicio_recepcion
end type
type st_cartera from statictext within w_inicio_recepcion
end type
type pb_20 from picturebutton within w_inicio_recepcion
end type
type st_20 from statictext within w_inicio_recepcion
end type
type pb_disenyo from picturebutton within w_inicio_recepcion
end type
type st_disenyo from statictext within w_inicio_recepcion
end type
type gb_6 from groupbox within w_inicio_recepcion
end type
type gb_10 from groupbox within w_inicio_recepcion
end type
type pb_1 from picturebutton within w_inicio_recepcion
end type
type st_contabilidad from statictext within w_inicio_recepcion
end type
type st_pagos from statictext within w_inicio_recepcion
end type
type pb_cartera from picturebutton within w_inicio_recepcion
end type
type st_3 from statictext within w_inicio_recepcion
end type
type gb_1 from groupbox within w_inicio_recepcion
end type
end forward
...
global w_inicio_recepcion w_inicio_recepcion

on w_inicio_recepcion.create
int iCurrent
call super::create
...
this.Control[iCurrent+20]=this.pb_pagos
this.Control[iCurrent+21]=this.st_cartera
this.Control[iCurrent+22]=this.pb_20
this.Control[iCurrent+23]=this.st_20
this.Control[iCurrent+24]=this.pb_disenyo
this.Control[iCurrent+25]=this.st_disenyo
this.Control[iCurrent+26]=this.gb_6
this.Control[iCurrent+27]=this.gb_10
this.Control[iCurrent+28]=this.pb_1
this.Control[iCurrent+29]=this.st_contabilidad
this.Control[iCurrent+30]=this.st_pagos
this.Control[iCurrent+31]=this.pb_cartera
this.Control[iCurrent+32]=this.st_3
this.Control[iCurrent+33]=this.gb_1
end on

on w_inicio_recepcion.destroy
call super::destroy
destroy(this.pb_u)
destroy(this.st_u)
destroy(this.pb_2)
...
type pb_salir from w_ventana_padre_inicio`pb_salir within w_inicio_recepcion
integer x = 1266
integer y = 1496
integer width = 183
integer height = 160
